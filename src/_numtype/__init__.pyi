...
@type_check_only
class _CanArray2_1nd(Protocol[_ScalarT_co, _ShapeT_co]):
    def __len__(self, /) -> int: ...
...
Array_0d = TypeAliasType("Array_0d", np.ndarray[tuple[()], np.dtype[_ScalarT0]], type_params=(_ScalarT0,))
...
MArray_1d = TypeAliasType("MArray_1d", np.ma.MaskedArray[tuple[int], np.dtype[_ScalarT0]], type_params=(_ScalarT0,))
MArray_2d = TypeAliasType("MArray_2d", np.ma.MaskedArray[tuple[int, int], np.dtype[_ScalarT0]], type_params=(_ScalarT0,))
MArray_3d = TypeAliasType("MArray_3d", np.ma.MaskedArray[tuple[int, int, int], np.dtype[_ScalarT0]], type_params=(_ScalarT0,))
...
ComplexFloating64: TypeAlias = np.complexfloating[_64Bit]  # accepts `complex128` and `cdouble`
...
Inexact32: TypeAlias = np.inexact[_32Bit]  # accepts `Floating64` and `ComplexFloating64`
Inexact64: TypeAlias = np.inexact[_64Bit]  # accepts `Floating64` and `ComplexFloating64`
InexactLD: TypeAlias = np.inexact[_NBitLongDouble]  # accepts `Floating64` and `ComplexFloating64`
...
_ToArray1_nd: TypeAlias = _CanArray_nd[_ScalarT] | Sequence_1nd[_CanArray_nd[_ScalarT]]
_ToArray_0d: TypeAlias = _ToArray1_0d[_ScalarT] | _ToT
...
_ToArray1_1d: TypeAlias = _CanArray_1nd[_ScalarT] | Sequence[_ToArray1_0d[_ScalarT]]
_ToArray1_2d: TypeAlias = _CanArray_1nd[_ScalarT] | Sequence[_ToArray1_1d[_ScalarT]]
_ToArray1_3d: TypeAlias = _CanArray_1nd[_ScalarT] | Sequence[_ToArray1_2d[_ScalarT]]
_ToArray_1d: TypeAlias = _CanArray_1nd[_ScalarT] | Sequence[_ToArray_0d[_ScalarT, _ToT]]
_ToArray_2d: TypeAlias = _CanArray_1nd[_ScalarT] | Sequence[_ToArray_1d[_ScalarT, _ToT]]
_ToArray_3d: TypeAlias = _CanArray_1nd[_ScalarT] | Sequence[_ToArray_2d[_ScalarT, _ToT]]

# requires ndarray to be shape-types (the `s` suffix stands for "strict")
_ToArray1_1ds: TypeAlias = _CanArray_1d[_ScalarT] | Sequence[_ToArray1_0d[_ScalarT]]
_ToArray1_2ds: TypeAlias = _CanArray_2d[_ScalarT] | Sequence[_ToArray1_1ds[_ScalarT]]
_ToArray1_3ds: TypeAlias = _CanArray_3d[_ScalarT] | Sequence[_ToArray1_2ds[_ScalarT]]
_ToArray_1ds: TypeAlias = _CanArray_1d[_ScalarT] | Sequence[_ToArray_0d[_ScalarT, _ToT]]
_ToArray_2ds: TypeAlias = _CanArray_2d[_ScalarT] | Sequence[_ToArray_1ds[_ScalarT, _ToT]]
_ToArray_3ds: TypeAlias = _CanArray_3d[_ScalarT] | Sequence[_ToArray_2ds[_ScalarT, _ToT]]

# requires a lower bound on dimensionality, e.g. `_2nd` denotes `ndin` within `[2, n]`
_ToArray1_1nd: TypeAlias = _CanArray_1nd[_ScalarT] | Sequence_1nd[_CanArray_nd[_ScalarT]]
_ToArray1_2nd: TypeAlias = _CanArray2_1nd[_ScalarT, AtLeast2D] | Sequence[_ToArray1_1nd[_ScalarT]]
_ToArray1_3nd: TypeAlias = _CanArray2_1nd[_ScalarT, AtLeast3D] | Sequence[_ToArray1_2nd[_ScalarT]]
_ToArray_1nd: TypeAlias = _CanArray_1nd[_ScalarT] | Sequence_1nd[_ToT | _CanArray_nd[_ScalarT]]
_ToArray_2nd: TypeAlias = _CanArray2_1nd[_ScalarT, AtLeast2D] | Sequence[_ToArray_1nd[_ScalarT, _ToT]]
_ToArray_3nd: TypeAlias = _CanArray2_1nd[_ScalarT, AtLeast3D] | Sequence[_ToArray_2nd[_ScalarT, _ToT]]
...
# unsigned integers
ToUInt8_nd = TypeAliasType("ToUInt8_nd", _ToArray1_nd[np.uint8])
ToUInt8_0d = TypeAliasType("ToUInt8_0d", _ToArray1_0d[np.uint8])
ToUInt8_1d = TypeAliasType("ToUInt8_1d", _ToArray1_1d[np.uint8])
ToUInt8_2d = TypeAliasType("ToUInt8_2d", _ToArray1_2d[np.uint8])
ToUInt8_3d = TypeAliasType("ToUInt8_3d", _ToArray1_3d[np.uint8])
ToUInt8_1ds = TypeAliasType("ToUInt8_1ds", _ToArray1_1ds[np.uint8])
ToUInt8_2ds = TypeAliasType("ToUInt8_2ds", _ToArray1_2ds[np.uint8])
ToUInt8_3ds = TypeAliasType("ToUInt8_3ds", _ToArray1_3ds[np.uint8])
ToUInt8_1nd = TypeAliasType("ToUInt8_1nd", _ToArray1_1nd[np.uint8])
ToUInt8_2nd = TypeAliasType("ToUInt8_2nd", _ToArray1_2nd[np.uint8])
ToUInt8_3nd = TypeAliasType("ToUInt8_3nd", _ToArray1_3nd[np.uint8])

ToUInt16_nd = TypeAliasType("ToUInt16_nd", _ToArray1_nd[np.uint16])
ToUInt16_0d = TypeAliasType("ToUInt16_0d", _ToArray1_0d[np.uint16])
ToUInt16_1d = TypeAliasType("ToUInt16_1d", _ToArray1_1d[np.uint16])
ToUInt16_2d = TypeAliasType("ToUInt16_2d", _ToArray1_2d[np.uint16])
ToUInt16_3d = TypeAliasType("ToUInt16_3d", _ToArray1_3d[np.uint16])
ToUInt16_1ds = TypeAliasType("ToUInt16_1ds", _ToArray1_1ds[np.uint16])
ToUInt16_2ds = TypeAliasType("ToUInt16_2ds", _ToArray1_2ds[np.uint16])
ToUInt16_3ds = TypeAliasType("ToUInt16_3ds", _ToArray1_3ds[np.uint16])
ToUInt16_1nd = TypeAliasType("ToUInt16_1nd", _ToArray1_1nd[np.uint16])
ToUInt16_2nd = TypeAliasType("ToUInt16_2nd", _ToArray1_2nd[np.uint16])
ToUInt16_3nd = TypeAliasType("ToUInt16_3nd", _ToArray1_3nd[np.uint16])

ToUInt32_nd = TypeAliasType("ToUInt32_nd", _ToArray1_nd[np.uint32])
ToUInt32_0d = TypeAliasType("ToUInt32_0d", _ToArray1_0d[np.uint32])
ToUInt32_1d = TypeAliasType("ToUInt32_1d", _ToArray1_1d[np.uint32])
ToUInt32_2d = TypeAliasType("ToUInt32_2d", _ToArray1_2d[np.uint32])
ToUInt32_3d = TypeAliasType("ToUInt32_3d", _ToArray1_3d[np.uint32])
ToUInt32_1ds = TypeAliasType("ToUInt32_1ds", _ToArray1_1ds[np.uint32])
ToUInt32_2ds = TypeAliasType("ToUInt32_2ds", _ToArray1_2ds[np.uint32])
ToUInt32_3ds = TypeAliasType("ToUInt32_3ds", _ToArray1_3ds[np.uint32])
ToUInt32_1nd = TypeAliasType("ToUInt32_1nd", _ToArray1_1nd[np.uint32])
ToUInt32_2nd = TypeAliasType("ToUInt32_2nd", _ToArray1_2nd[np.uint32])
ToUInt32_3nd = TypeAliasType("ToUInt32_3nd", _ToArray1_3nd[np.uint32])

ToUInt64_nd = TypeAliasType("ToUInt64_nd", _ToArray1_nd[np.uint64])
ToUInt64_0d = TypeAliasType("ToUInt64_0d", _ToArray1_0d[np.uint64])
ToUInt64_1d = TypeAliasType("ToUInt64_1d", _ToArray1_1d[np.uint64])
ToUInt64_2d = TypeAliasType("ToUInt64_2d", _ToArray1_2d[np.uint64])
ToUInt64_3d = TypeAliasType("ToUInt64_3d", _ToArray1_3d[np.uint64])
ToUInt64_1ds = TypeAliasType("ToUInt64_1ds", _ToArray1_1ds[np.uint64])
ToUInt64_2ds = TypeAliasType("ToUInt64_2ds", _ToArray1_2ds[np.uint64])
ToUInt64_3ds = TypeAliasType("ToUInt64_3ds", _ToArray1_3ds[np.uint64])
ToUInt64_1nd = TypeAliasType("ToUInt64_1nd", _ToArray1_1nd[np.uint64])
ToUInt64_2nd = TypeAliasType("ToUInt64_2nd", _ToArray1_2nd[np.uint64])
ToUInt64_3nd = TypeAliasType("ToUInt64_3nd", _ToArray1_3nd[np.uint64])

ToULong_nd = TypeAliasType("ToULong_nd", _ToArray1_nd[np.ulong])
ToULong_0d = TypeAliasType("ToULong_0d", _ToArray1_0d[np.ulong])
ToULong_1d = TypeAliasType("ToULong_1d", _ToArray1_1d[np.ulong])
ToULong_2d = TypeAliasType("ToULong_2d", _ToArray1_2d[np.ulong])
ToULong_3d = TypeAliasType("ToULong_3d", _ToArray1_3d[np.ulong])
ToULong_1ds = TypeAliasType("ToULong_1ds", _ToArray1_1ds[np.ulong])
ToULong_2ds = TypeAliasType("ToULong_2ds", _ToArray1_2ds[np.ulong])
ToULong_3ds = TypeAliasType("ToULong_3ds", _ToArray1_3ds[np.ulong])
ToULong_1nd = TypeAliasType("ToULong_1nd", _ToArray1_1nd[np.ulong])
ToULong_2nd = TypeAliasType("ToULong_2nd", _ToArray1_2nd[np.ulong])
ToULong_3nd = TypeAliasType("ToULong_3nd", _ToArray1_3nd[np.ulong])

ToUIntP_nd = TypeAliasType("ToUIntP_nd", _ToArray1_nd[np.uintp])
...
ToUIntP_2ds = TypeAliasType("ToUIntP_2ds", _ToArray1_2ds[np.uintp])
...
ToUIntP_3nd = TypeAliasType("ToUIntP_3nd", _ToArray1_3nd[np.uintp])

ToULongLong_nd = TypeAliasType("ToULongLong_nd", _ToArray1_nd[np.ulonglong])
ToULongLong_0d = TypeAliasType("ToULongLong_0d", _ToArray1_0d[np.ulonglong])
ToULongLong_1d = TypeAliasType("ToULongLong_1d", _ToArray1_1d[np.ulonglong])
ToULongLong_2d = TypeAliasType("ToULongLong_2d", _ToArray1_2d[np.ulonglong])
ToULongLong_3d = TypeAliasType("ToULongLong_3d", _ToArray1_3d[np.ulonglong])
ToULongLong_1ds = TypeAliasType("ToULongLong_1ds", _ToArray1_1ds[np.ulonglong])
ToULongLong_2ds = TypeAliasType("ToULongLong_2ds", _ToArray1_2ds[np.ulonglong])
ToULongLong_3ds = TypeAliasType("ToULongLong_3ds", _ToArray1_3ds[np.ulonglong])
ToULongLong_1nd = TypeAliasType("ToULongLong_1nd", _ToArray1_1nd[np.ulonglong])
ToULongLong_2nd = TypeAliasType("ToULongLong_2nd", _ToArray1_2nd[np.ulonglong])
ToULongLong_3nd = TypeAliasType("ToULongLong_3nd", _ToArray1_3nd[np.ulonglong])

ToUInteger_nd = TypeAliasType("ToUInteger_nd", _ToArray1_nd[np.unsignedinteger])
ToUInteger_0d = TypeAliasType("ToUInteger_0d", _ToArray1_0d[np.unsignedinteger])
ToUInteger_1d = TypeAliasType("ToUInteger_1d", _ToArray1_1d[np.unsignedinteger])
ToUInteger_2d = TypeAliasType("ToUInteger_2d", _ToArray1_2d[np.unsignedinteger])
ToUInteger_3d = TypeAliasType("ToUInteger_3d", _ToArray1_3d[np.unsignedinteger])
ToUInteger_1ds = TypeAliasType("ToUInteger_1ds", _ToArray1_1ds[np.unsignedinteger])
ToUInteger_2ds = TypeAliasType("ToUInteger_2ds", _ToArray1_2ds[np.unsignedinteger])
ToUInteger_3ds = TypeAliasType("ToUInteger_3ds", _ToArray1_3ds[np.unsignedinteger])
ToUInteger_1nd = TypeAliasType("ToUInteger_1nd", _ToArray1_1nd[np.unsignedinteger])
ToUInteger_2nd = TypeAliasType("ToUInteger_2nd", _ToArray1_2nd[np.unsignedinteger])
ToUInteger_3nd = TypeAliasType("ToUInteger_3nd", _ToArray1_3nd[np.unsignedinteger])

# signed integers
ToInt8_nd = TypeAliasType("ToInt8_nd", _ToArray1_nd[np.int8])
ToInt8_0d = TypeAliasType("ToInt8_0d", _ToArray1_0d[np.int8])
ToInt8_1d = TypeAliasType("ToInt8_1d", _ToArray1_1d[np.int8])
ToInt8_2d = TypeAliasType("ToInt8_2d", _ToArray1_2d[np.int8])
ToInt8_3d = TypeAliasType("ToInt8_3d", _ToArray1_3d[np.int8])
ToInt8_1ds = TypeAliasType("ToInt8_1ds", _ToArray1_1ds[np.int8])
ToInt8_2ds = TypeAliasType("ToInt8_2ds", _ToArray1_2ds[np.int8])
ToInt8_3ds = TypeAliasType("ToInt8_3ds", _ToArray1_3ds[np.int8])
ToInt8_1nd = TypeAliasType("ToInt8_1nd", _ToArray1_1nd[np.int8])
ToInt8_2nd = TypeAliasType("ToInt8_2nd", _ToArray1_2nd[np.int8])
ToInt8_3nd = TypeAliasType("ToInt8_3nd", _ToArray1_3nd[np.int8])

ToInt16_nd = TypeAliasType("ToInt16_nd", _ToArray1_nd[np.int16])
ToInt16_0d = TypeAliasType("ToInt16_0d", _ToArray1_0d[np.int16])
ToInt16_1d = TypeAliasType("ToInt16_1d", _ToArray1_1d[np.int16])
ToInt16_2d = TypeAliasType("ToInt16_2d", _ToArray1_2d[np.int16])
ToInt16_3d = TypeAliasType("ToInt16_3d", _ToArray1_3d[np.int16])
ToInt16_1ds = TypeAliasType("ToInt16_1ds", _ToArray1_1ds[np.int16])
ToInt16_2ds = TypeAliasType("ToInt16_2ds", _ToArray1_2ds[np.int16])
ToInt16_3ds = TypeAliasType("ToInt16_3ds", _ToArray1_3ds[np.int16])
ToInt16_1nd = TypeAliasType("ToInt16_1nd", _ToArray1_1nd[np.int16])
ToInt16_2nd = TypeAliasType("ToInt16_2nd", _ToArray1_2nd[np.int16])
ToInt16_3nd = TypeAliasType("ToInt16_3nd", _ToArray1_3nd[np.int16])

ToInt32_nd = TypeAliasType("ToInt32_nd", _ToArray1_nd[np.int32])
ToInt32_0d = TypeAliasType("ToInt32_0d", _ToArray1_0d[np.int32])
ToInt32_1d = TypeAliasType("ToInt32_1d", _ToArray1_1d[np.int32])
ToInt32_2d = TypeAliasType("ToInt32_2d", _ToArray1_2d[np.int32])
ToInt32_3d = TypeAliasType("ToInt32_3d", _ToArray1_3d[np.int32])
ToInt32_1ds = TypeAliasType("ToInt32_1ds", _ToArray1_1ds[np.int32])
ToInt32_2ds = TypeAliasType("ToInt32_2ds", _ToArray1_2ds[np.int32])
ToInt32_3ds = TypeAliasType("ToInt32_3ds", _ToArray1_3ds[np.int32])
ToInt32_1nd = TypeAliasType("ToInt32_1nd", _ToArray1_1nd[np.int32])
ToInt32_2nd = TypeAliasType("ToInt32_2nd", _ToArray1_2nd[np.int32])
ToInt32_3nd = TypeAliasType("ToInt32_3nd", _ToArray1_3nd[np.int32])

ToInt64_nd = TypeAliasType("ToInt64_nd", _ToArray1_nd[np.int64])
ToInt64_0d = TypeAliasType("ToInt64_0d", _ToArray1_0d[np.int64])
ToInt64_1d = TypeAliasType("ToInt64_1d", _ToArray1_1d[np.int64])
ToInt64_2d = TypeAliasType("ToInt64_2d", _ToArray1_2d[np.int64])
ToInt64_3d = TypeAliasType("ToInt64_3d", _ToArray1_3d[np.int64])
ToInt64_1ds = TypeAliasType("ToInt64_1ds", _ToArray1_1ds[np.int64])
ToInt64_2ds = TypeAliasType("ToInt64_2ds", _ToArray1_2ds[np.int64])
ToInt64_3ds = TypeAliasType("ToInt64_3ds", _ToArray1_3ds[np.int64])
ToInt64_1nd = TypeAliasType("ToInt64_1nd", _ToArray1_1nd[np.int64])
ToInt64_2nd = TypeAliasType("ToInt64_2nd", _ToArray1_2nd[np.int64])
ToInt64_3nd = TypeAliasType("ToInt64_3nd", _ToArray1_3nd[np.int64])

ToLong_nd = TypeAliasType("ToLong_nd", _ToArray1_nd[np.long])
ToLong_0d = TypeAliasType("ToLong_0d", _ToArray1_0d[np.long])
ToLong_1d = TypeAliasType("ToLong_1d", _ToArray1_1d[np.long])
ToLong_2d = TypeAliasType("ToLong_2d", _ToArray1_2d[np.long])
ToLong_3d = TypeAliasType("ToLong_3d", _ToArray1_3d[np.long])
ToLong_1ds = TypeAliasType("ToLong_1ds", _ToArray1_1ds[np.long])
ToLong_2ds = TypeAliasType("ToLong_2ds", _ToArray1_2ds[np.long])
ToLong_3ds = TypeAliasType("ToLong_3ds", _ToArray1_3ds[np.long])
ToLong_1nd = TypeAliasType("ToLong_1nd", _ToArray1_1nd[np.long])
ToLong_2nd = TypeAliasType("ToLong_2nd", _ToArray1_2nd[np.long])
ToLong_3nd = TypeAliasType("ToLong_3nd", _ToArray1_3nd[np.long])

ToIntP_nd = TypeAliasType("ToIntP_nd", _ToArray_nd[np.intp, Is[int]])
ToIntP_0d = TypeAliasType("ToIntP_0d", _ToArray_0d[np.intp, Is[int]])
ToIntP_1d = TypeAliasType("ToIntP_1d", _ToArray_1d[np.intp, Is[int]])
ToIntP_2d = TypeAliasType("ToIntP_2d", _ToArray_2d[np.intp, Is[int]])
ToIntP_3d = TypeAliasType("ToIntP_3d", _ToArray_3d[np.intp, Is[int]])
ToIntP_1ds = TypeAliasType("ToIntP_1ds", _ToArray_1ds[np.intp, Is[int]])
ToIntP_2ds = TypeAliasType("ToIntP_2ds", _ToArray_2ds[np.intp, Is[int]])
ToIntP_3ds = TypeAliasType("ToIntP_3ds", _ToArray_3ds[np.intp, Is[int]])
ToIntP_1nd = TypeAliasType("ToIntP_1nd", _ToArray_1nd[np.intp, Is[int]])
ToIntP_2nd = TypeAliasType("ToIntP_2nd", _ToArray_2nd[np.intp, Is[int]])
ToIntP_3nd = TypeAliasType("ToIntP_3nd", _ToArray_3nd[np.intp, Is[int]])

ToLongLong_nd = TypeAliasType("ToLongLong_nd", _ToArray1_nd[np.longlong])
ToLongLong_0d = TypeAliasType("ToLongLong_0d", _ToArray1_0d[np.longlong])
ToLongLong_1d = TypeAliasType("ToLongLong_1d", _ToArray1_1d[np.longlong])
ToLongLong_2d = TypeAliasType("ToLongLong_2d", _ToArray1_2d[np.longlong])
ToLongLong_3d = TypeAliasType("ToLongLong_3d", _ToArray1_3d[np.longlong])
ToLongLong_1ds = TypeAliasType("ToLongLong_1ds", _ToArray1_1ds[np.longlong])
ToLongLong_2ds = TypeAliasType("ToLongLong_2ds", _ToArray1_2ds[np.longlong])
ToLongLong_3ds = TypeAliasType("ToLongLong_3ds", _ToArray1_3ds[np.longlong])
ToLongLong_1nd = TypeAliasType("ToLongLong_1nd", _ToArray1_1nd[np.longlong])
ToLongLong_2nd = TypeAliasType("ToLongLong_2nd", _ToArray1_2nd[np.longlong])
ToLongLong_3nd = TypeAliasType("ToLongLong_3nd", _ToArray1_3nd[np.longlong])

ToSInteger_nd = TypeAliasType("ToSInteger_nd", _ToArray_nd[np.signedinteger, Is[int]])
ToSInteger_0d = TypeAliasType("ToSInteger_0d", _ToArray_0d[np.signedinteger, Is[int]])
ToSInteger_1d = TypeAliasType("ToSInteger_1d", _ToArray_1d[np.signedinteger, Is[int]])
ToSInteger_2d = TypeAliasType("ToSInteger_2d", _ToArray_2d[np.signedinteger, Is[int]])
ToSInteger_3d = TypeAliasType("ToSInteger_3d", _ToArray_3d[np.signedinteger, Is[int]])
ToSInteger_1ds = TypeAliasType("ToSInteger_1ds", _ToArray_1ds[np.signedinteger, Is[int]])
ToSInteger_2ds = TypeAliasType("ToSInteger_2ds", _ToArray_2ds[np.signedinteger, Is[int]])
ToSInteger_3ds = TypeAliasType("ToSInteger_3ds", _ToArray_3ds[np.signedinteger, Is[int]])
ToSInteger_1nd = TypeAliasType("ToSInteger_1nd", _ToArray_1nd[np.signedinteger, Is[int]])
ToSInteger_2nd = TypeAliasType("ToSInteger_2nd", _ToArray_2nd[np.signedinteger, Is[int]])
ToSInteger_3nd = TypeAliasType("ToSInteger_3nd", _ToArray_3nd[np.signedinteger, Is[int]])
...
# real floats
ToFloat16_nd = TypeAliasType("ToFloat16_nd", _ToArray1_nd[np.float16])
ToFloat16_0d = TypeAliasType("ToFloat16_0d", _ToArray1_0d[np.float16])
ToFloat16_1d = TypeAliasType("ToFloat16_1d", _ToArray1_1d[np.float16])
ToFloat16_2d = TypeAliasType("ToFloat16_2d", _ToArray1_2d[np.float16])
ToFloat16_3d = TypeAliasType("ToFloat16_3d", _ToArray1_3d[np.float16])
ToFloat16_1ds = TypeAliasType("ToFloat16_1ds", _ToArray1_1ds[np.float16])
ToFloat16_2ds = TypeAliasType("ToFloat16_2ds", _ToArray1_2ds[np.float16])
ToFloat16_3ds = TypeAliasType("ToFloat16_3ds", _ToArray1_3ds[np.float16])
ToFloat16_1nd = TypeAliasType("ToFloat16_1nd", _ToArray1_1nd[np.float16])
ToFloat16_2nd = TypeAliasType("ToFloat16_2nd", _ToArray1_2nd[np.float16])
ToFloat16_3nd = TypeAliasType("ToFloat16_3nd", _ToArray1_3nd[np.float16])

ToFloat32_nd = TypeAliasType("ToFloat32_nd", _ToArray1_nd[np.float32])
ToFloat32_0d = TypeAliasType("ToFloat32_0d", _ToArray1_0d[np.float32])
ToFloat32_1d = TypeAliasType("ToFloat32_1d", _ToArray1_1d[np.float32])
ToFloat32_2d = TypeAliasType("ToFloat32_2d", _ToArray1_2d[np.float32])
ToFloat32_3d = TypeAliasType("ToFloat32_3d", _ToArray1_3d[np.float32])
ToFloat32_1ds = TypeAliasType("ToFloat32_1ds", _ToArray1_1ds[np.float32])
ToFloat32_2ds = TypeAliasType("ToFloat32_2ds", _ToArray1_2ds[np.float32])
ToFloat32_3ds = TypeAliasType("ToFloat32_3ds", _ToArray1_3ds[np.float32])
ToFloat32_1nd = TypeAliasType("ToFloat32_1nd", _ToArray1_1nd[np.float32])
ToFloat32_2nd = TypeAliasType("ToFloat32_2nd", _ToArray1_2nd[np.float32])
ToFloat32_3nd = TypeAliasType("ToFloat32_3nd", _ToArray1_3nd[np.float32])

ToFloat64_nd = TypeAliasType("ToFloat64_nd", _ToArray_nd[Floating64, Is[float]])
ToFloat64_0d = TypeAliasType("ToFloat64_0d", _ToArray_0d[Floating64, Is[float]])
ToFloat64_1d = TypeAliasType("ToFloat64_1d", _ToArray_1d[Floating64, Is[float]])
ToFloat64_2d = TypeAliasType("ToFloat64_2d", _ToArray_2d[Floating64, Is[float]])
ToFloat64_3d = TypeAliasType("ToFloat64_3d", _ToArray_3d[Floating64, Is[float]])
ToFloat64_1ds = TypeAliasType("ToFloat64_1ds", _ToArray_1ds[Floating64, Is[float]])
ToFloat64_2ds = TypeAliasType("ToFloat64_2ds", _ToArray_2ds[Floating64, Is[float]])
ToFloat64_3ds = TypeAliasType("ToFloat64_3ds", _ToArray_3ds[Floating64, Is[float]])
ToFloat64_1nd = TypeAliasType("ToFloat64_1nd", _ToArray_1nd[Floating64, Is[float]])
ToFloat64_2nd = TypeAliasType("ToFloat64_2nd", _ToArray_2nd[Floating64, Is[float]])
ToFloat64_3nd = TypeAliasType("ToFloat64_3nd", _ToArray_3nd[Floating64, Is[float]])

ToLongDouble_nd = TypeAliasType("ToLongDouble_nd", _ToArray1_nd[np.longdouble])
ToLongDouble_0d = TypeAliasType("ToLongDouble_0d", _ToArray1_0d[np.longdouble])
ToLongDouble_1d = TypeAliasType("ToLongDouble_1d", _ToArray1_1d[np.longdouble])
ToLongDouble_2d = TypeAliasType("ToLongDouble_2d", _ToArray1_2d[np.longdouble])
ToLongDouble_3d = TypeAliasType("ToLongDouble_3d", _ToArray1_3d[np.longdouble])
ToLongDouble_1ds = TypeAliasType("ToLongDouble_1ds", _ToArray1_1ds[np.longdouble])
ToLongDouble_2ds = TypeAliasType("ToLongDouble_2ds", _ToArray1_2ds[np.longdouble])
ToLongDouble_3ds = TypeAliasType("ToLongDouble_3ds", _ToArray1_3ds[np.longdouble])
ToLongDouble_1nd = TypeAliasType("ToLongDouble_1nd", _ToArray1_1nd[np.longdouble])
ToLongDouble_2nd = TypeAliasType("ToLongDouble_2nd", _ToArray1_2nd[np.longdouble])
ToLongDouble_3nd = TypeAliasType("ToLongDouble_3nd", _ToArray1_3nd[np.longdouble])
...
# complex floats
ToComplex64_nd = TypeAliasType("ToComplex64_nd", _ToArray1_nd[np.complex64])
ToComplex64_0d = TypeAliasType("ToComplex64_0d", _ToArray1_0d[np.complex64])
ToComplex64_1d = TypeAliasType("ToComplex64_1d", _ToArray1_1d[np.complex64])
ToComplex64_2d = TypeAliasType("ToComplex64_2d", _ToArray1_2d[np.complex64])
...
ToComplex64_2ds = TypeAliasType("ToComplex64_2ds", _ToArray1_2ds[np.complex64])
ToComplex64_3ds = TypeAliasType("ToComplex64_3ds", _ToArray1_3ds[np.complex64])
ToComplex64_1nd = TypeAliasType("ToComplex64_1nd", _ToArray1_1nd[np.complex64])
ToComplex64_2nd = TypeAliasType("ToComplex64_2nd", _ToArray1_2nd[np.complex64])
ToComplex64_3nd = TypeAliasType("ToComplex64_3nd", _ToArray1_3nd[np.complex64])

ToComplex128_nd = TypeAliasType("ToComplex128_nd", _ToArray_nd[ComplexFloating64, Is[complex]])
ToComplex128_0d = TypeAliasType("ToComplex128_0d", _ToArray_0d[ComplexFloating64, Is[complex]])
ToComplex128_1d = TypeAliasType("ToComplex128_1d", _ToArray_1d[ComplexFloating64, Is[complex]])
ToComplex128_2d = TypeAliasType("ToComplex128_2d", _ToArray_2d[ComplexFloating64, Is[complex]])
ToComplex128_3d = TypeAliasType("ToComplex128_3d", _ToArray_3d[ComplexFloating64, Is[complex]])
ToComplex128_1ds = TypeAliasType("ToComplex128_1ds", _ToArray_1ds[ComplexFloating64, Is[complex]])
ToComplex128_2ds = TypeAliasType("ToComplex128_2ds", _ToArray_2ds[ComplexFloating64, Is[complex]])
ToComplex128_3ds = TypeAliasType("ToComplex128_3ds", _ToArray_3ds[ComplexFloating64, Is[complex]])
ToComplex128_1nd = TypeAliasType("ToComplex128_1nd", _ToArray_1nd[ComplexFloating64, Is[complex]])
ToComplex128_2nd = TypeAliasType("ToComplex128_2nd", _ToArray_2nd[ComplexFloating64, Is[complex]])
ToComplex128_3nd = TypeAliasType("ToComplex128_3nd", _ToArray_3nd[ComplexFloating64, Is[complex]])

ToCLongDouble_nd = TypeAliasType("ToCLongDouble_nd", _ToArray1_nd[np.clongdouble])
ToCLongDouble_0d = TypeAliasType("ToCLongDouble_0d", _ToArray1_0d[np.clongdouble])
ToCLongDouble_1d = TypeAliasType("ToCLongDouble_1d", _ToArray1_1d[np.clongdouble])
ToCLongDouble_2d = TypeAliasType("ToCLongDouble_2d", _ToArray1_2d[np.clongdouble])
ToCLongDouble_3d = TypeAliasType("ToCLongDouble_3d", _ToArray1_3d[np.clongdouble])
ToCLongDouble_1ds = TypeAliasType("ToCLongDouble_1ds", _ToArray1_1ds[np.clongdouble])
ToCLongDouble_2ds = TypeAliasType("ToCLongDouble_2ds", _ToArray1_2ds[np.clongdouble])
ToCLongDouble_3ds = TypeAliasType("ToCLongDouble_3ds", _ToArray1_3ds[np.clongdouble])
ToCLongDouble_1nd = TypeAliasType("ToCLongDouble_1nd", _ToArray1_1nd[np.clongdouble])
ToCLongDouble_2nd = TypeAliasType("ToCLongDouble_2nd", _ToArray1_2nd[np.clongdouble])
ToCLongDouble_3nd = TypeAliasType("ToCLongDouble_3nd", _ToArray1_3nd[np.clongdouble])
...
ToReal_nd = TypeAliasType("ToReal_nd", _ToArray_nd[np.number[Any, float], _PyReal])
ToReal_0d = TypeAliasType("ToReal_0d", _ToArray_0d[np.number[Any, float], _PyReal])
ToReal_1d = TypeAliasType("ToReal_1d", _ToArray_1d[np.number[Any, float], _PyReal])
ToReal_2d = TypeAliasType("ToReal_2d", _ToArray_2d[np.number[Any, float], _PyReal])
ToReal_3d = TypeAliasType("ToReal_3d", _ToArray_3d[np.number[Any, float], _PyReal])
ToReal_1ds = TypeAliasType("ToReal_1ds", _ToArray_1ds[np.number[Any, float], _PyReal])
ToReal_2ds = TypeAliasType("ToReal_2ds", _ToArray_2ds[np.number[Any, float], _PyReal])
ToReal_3ds = TypeAliasType("ToReal_3ds", _ToArray_3ds[np.number[Any, float], _PyReal])
ToReal_1nd = TypeAliasType("ToReal_1nd", _ToArray_1nd[np.number[Any, float], _PyReal])
ToReal_2nd = TypeAliasType("ToReal_2nd", _ToArray_2nd[np.number[Any, float], _PyReal])
ToReal_3nd = TypeAliasType("ToReal_3nd", _ToArray_3nd[np.number[Any, float], _PyReal])
...
ToTimeDelta_nd = TypeAliasType("ToTimeDelta_nd", _ToArray1_nd[_ToTimeDelta])
ToTimeDelta_0d = TypeAliasType("ToTimeDelta_0d", _ToArray1_0d[_ToTimeDelta])
ToTimeDelta_1d = TypeAliasType("ToTimeDelta_1d", _ToArray1_1d[_ToTimeDelta])
ToTimeDelta_2d = TypeAliasType("ToTimeDelta_2d", _ToArray1_2d[_ToTimeDelta])
ToTimeDelta_3d = TypeAliasType("ToTimeDelta_3d", _ToArray1_3d[_ToTimeDelta])
ToTimeDelta_1ds = TypeAliasType("ToTimeDelta_1ds", _ToArray1_1ds[_ToTimeDelta])
ToTimeDelta_2ds = TypeAliasType("ToTimeDelta_2ds", _ToArray1_2ds[_ToTimeDelta])
ToTimeDelta_3ds = TypeAliasType("ToTimeDelta_3ds", _ToArray1_3ds[_ToTimeDelta])
ToTimeDelta_1nd = TypeAliasType("ToTimeDelta_1nd", _ToArray1_1nd[_ToTimeDelta])
ToTimeDelta_2nd = TypeAliasType("ToTimeDelta_2nd", _ToArray1_2nd[_ToTimeDelta])
ToTimeDelta_3nd = TypeAliasType("ToTimeDelta_3nd", _ToArray1_3nd[_ToTimeDelta])

_ToDateTime: TypeAlias = np.datetime64[Any]
ToDateTime_nd = TypeAliasType("ToDateTime_nd", _ToArray1_nd[_ToDateTime])
ToDateTime_0d = TypeAliasType("ToDateTime_0d", _ToArray1_0d[_ToDateTime])
ToDateTime_1d = TypeAliasType("ToDateTime_1d", _ToArray1_1d[_ToDateTime])
ToDateTime_2d = TypeAliasType("ToDateTime_2d", _ToArray1_2d[_ToDateTime])
ToDateTime_3d = TypeAliasType("ToDateTime_3d", _ToArray1_3d[_ToDateTime])
ToDateTime_1ds = TypeAliasType("ToDateTime_1ds", _ToArray1_1ds[_ToDateTime])
ToDateTime_2ds = TypeAliasType("ToDateTime_2ds", _ToArray1_2ds[_ToDateTime])
ToDateTime_3ds = TypeAliasType("ToDateTime_3ds", _ToArray1_3ds[_ToDateTime])
ToDateTime_1nd = TypeAliasType("ToDateTime_1nd", _ToArray1_1nd[_ToDateTime])
ToDateTime_2nd = TypeAliasType("ToDateTime_2nd", _ToArray1_2nd[_ToDateTime])
ToDateTime_3nd = TypeAliasType("ToDateTime_3nd", _ToArray1_3nd[_ToDateTime])
...
ToCharacter_nd = TypeAliasType("ToCharacter_nd", _ToArray_nd[_ToCharacter, _PyCharacter])
ToCharacter_0d = TypeAliasType("ToCharacter_0d", _ToArray_0d[_ToCharacter, _PyCharacter])
ToCharacter_1d = TypeAliasType("ToCharacter_1d", _ToArray_1d[_ToCharacter, _PyCharacter])
ToCharacter_2d = TypeAliasType("ToCharacter_2d", _ToArray_2d[_ToCharacter, _PyCharacter])
ToCharacter_3d = TypeAliasType("ToCharacter_3d", _ToArray_3d[_ToCharacter, _PyCharacter])
ToCharacter_1ds = TypeAliasType("ToCharacter_1ds", _ToArray_1ds[_ToCharacter, _PyCharacter])
ToCharacter_2ds = TypeAliasType("ToCharacter_2ds", _ToArray_2ds[_ToCharacter, _PyCharacter])
ToCharacter_3ds = TypeAliasType("ToCharacter_3ds", _ToArray_3ds[_ToCharacter, _PyCharacter])
ToCharacter_1nd = TypeAliasType("ToCharacter_1nd", _ToArray_1nd[_ToCharacter, _PyCharacter])
ToCharacter_2nd = TypeAliasType("ToCharacter_2nd", _ToArray_2nd[_ToCharacter, _PyCharacter])
ToCharacter_3nd = TypeAliasType("ToCharacter_3nd", _ToArray_3nd[_ToCharacter, _PyCharacter])
...
# any scalar
ToGeneric_nd = TypeAliasType("ToGeneric_nd", _ToArray_nd[np.generic, _PyScalar])
ToGeneric_0d = TypeAliasType("ToGeneric_0d", _ToArray_0d[np.generic, _PyScalar])
ToGeneric_1d = TypeAliasType("ToGeneric_1d", _ToArray_1d[np.generic, _PyScalar])
ToGeneric_2d = TypeAliasType("ToGeneric_2d", _ToArray_2d[np.generic, _PyScalar])
ToGeneric_3d = TypeAliasType("ToGeneric_3d", _ToArray_3d[np.generic, _PyScalar])
ToGeneric_1ds = TypeAliasType("ToGeneric_1ds", _ToArray_1ds[np.generic, _PyScalar])
ToGeneric_2ds = TypeAliasType("ToGeneric_2ds", _ToArray_2ds[np.generic, _PyScalar])
ToGeneric_3ds = TypeAliasType("ToGeneric_3ds", _ToArray_3ds[np.generic, _PyScalar])
ToGeneric_1nd = TypeAliasType("ToGeneric_1nd", _ToArray_1nd[np.generic, _PyScalar])
ToGeneric_2nd = TypeAliasType("ToGeneric_2nd", _ToArray_2nd[np.generic, _PyScalar])
ToGeneric_3nd = TypeAliasType("ToGeneric_3nd", _ToArray_3nd[np.generic, _PyScalar])
...
_CoUInt16: TypeAlias = np.uint16 | np.uint8 | _ToBool
...
_CoUInt32: TypeAlias = np.uint32 | np.uint16 | np.uint8 | _ToBool
...
_CoUInt64: TypeAlias = np.uint64 | np.uint32 | np.uint16 | np.uint8 | _ToBool
...
_CoULong: TypeAlias = np.ulong | np.uint32 | np.uint16 | np.uint8 | _ToBool
...
_CoUIntP: TypeAlias = np.uintp | np.uint32 | np.uint16 | np.uint8 | _ToBool
...
_CoInt16: TypeAlias = np.int16 | Integer8 | _ToBool
...
_CoInt32: TypeAlias = np.int32 | Integer16 | Integer8 | _ToBool
...
_CoInt64: TypeAlias = np.int64 | Integer32 | Integer16 | Integer8 | _ToBool
...
_CoLong: TypeAlias = np.long | np.int32 | Integer16 | Integer8 | _ToBool
...
_CoIntP: TypeAlias = np.intp | np.int32 | Integer16 | Integer8 | _ToBool
...
_CoSInteger: TypeAlias = np.signedinteger | Integer32 | Integer16 | Integer8 | _ToBool
...
_CoFloat16: TypeAlias = np.float16 | Integer8 | _ToBool
...
_CoFloat32: TypeAlias = np.float32 | Number16 | Integer8 | _ToBool
...
_CoFloat64: TypeAlias = Floating64 | np.float32 | Number16 | np.integer | _ToBool
...
# complex floats
_CoComplex64: TypeAlias = Number32 | Number16 | Integer8 | _ToBool
...
_CoComplex128: TypeAlias = Number64 | Number32 | Number16 | np.integer | _ToBool
...
CoDateTime_nd = TypeAliasType("CoDateTime_nd", _ToArray1_nd[_CoDateTime])
CoDateTime_0d = TypeAliasType("CoDateTime_0d", _ToArray1_0d[_CoDateTime])
CoDateTime_1d = TypeAliasType("CoDateTime_1d", _ToArray1_1d[_CoDateTime])
CoDateTime_2d = TypeAliasType("CoDateTime_2d", _ToArray1_2d[_CoDateTime])
CoDateTime_3d = TypeAliasType("CoDateTime_3d", _ToArray1_3d[_CoDateTime])
CoDateTime_1ds = TypeAliasType("CoDateTime_1ds", _ToArray1_1ds[_CoDateTime])
CoDateTime_2ds = TypeAliasType("CoDateTime_2ds", _ToArray1_2ds[_CoDateTime])
CoDateTime_3ds = TypeAliasType("CoDateTime_3ds", _ToArray1_3ds[_CoDateTime])
CoDateTime_1nd = TypeAliasType("CoDateTime_1nd", _ToArray1_1nd[_CoDateTime])
CoDateTime_2nd = TypeAliasType("CoDateTime_2nd", _ToArray1_2nd[_CoDateTime])
CoDateTime_3nd = TypeAliasType("CoDateTime_3nd", _ToArray1_3nd[_CoDateTime])
...
_CoStr: TypeAlias = np.character[Any]
