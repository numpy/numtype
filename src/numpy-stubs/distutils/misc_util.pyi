...
class Configuration:
    ...
    def add_npy_pkg_config(self, template: str, install_dir: Incomplete, subst_dict: Incomplete | None = None) -> None: ...
    ...
    def get_version(self, version_file: Incomplete | None = None, version_variable: Incomplete | None = None) -> Incomplete: ...
