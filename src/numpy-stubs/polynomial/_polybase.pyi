...
class ABCPolyBase(Generic[_NameT_co], metaclass=abc.ABCMeta):
    ...
    @overload
    def __call__(self, /, arg: _NumberLike_co) -> np.float64 | np.complex128: ...
    @overload
    ...
    def __divmod__(self, x: _AnyOther, /) -> _Tuple2[_Self]: ...
    ...
    def __rdivmod__(self, x: _AnyOther, /) -> _Tuple2[_Self]: ...
    ...
    def fit(
        ...
        *,
        ...
        window: _SeriesLikeCoef_co | None = ...,
        symbol: str = ...,
    ) -> tuple[_Self, Sequence[np.inexact | np.int32]]: ...
    @overload
    @classmethod
    def fit(
        cls,
