...
#
@overload
def polyline(off: ToIntP_0d, scl: CoIntP_0d) -> Array_1d[np.intp]: ...
@overload
def polyline(off: CoIntP_0d, scl: ToIntP_0d) -> Array_1d[np.intp]: ...
@overload
def polyline(off: CoInteger_0d, scl: CoInteger_0d) -> Array_1d[np.integer]: ...
@overload
def polyline(off: ToFloat64_0d, scl: CoFloat64_0d) -> Array_1d[np.float64]: ...
@overload
def polyline(off: CoFloat64_0d, scl: ToFloat64_0d) -> Array_1d[np.float64]: ...
@overload
def polyline(off: ToFloating_0d, scl: CoFloating_0d) -> Array_1d[np.floating]: ...
@overload
def polyline(off: CoFloating_0d, scl: ToFloating_0d) -> Array_1d[np.floating]: ...
@overload
def polyline(off: ToComplex128_0d, scl: CoComplex128_0d) -> Array_1d[np.complex128]: ...
@overload
def polyline(off: CoComplex128_0d, scl: ToComplex128_0d) -> Array_1d[np.complex128]: ...
@overload
def polyline(off: ToComplex_0d, scl: CoComplex_0d) -> Array_1d[np.complexfloating]: ...
@overload
def polyline(off: CoComplex_0d, scl: ToComplex_0d) -> Array_1d[np.complexfloating]: ...
@overload
def polyline(off: CoComplex_0d, scl: CoComplex_0d) -> Array_1d[np.number]: ...
@overload
def polyline(off: ToObject_0d, scl: ToObject_0d) -> Array_1d[np.object_]: ...

#
@overload
def polyfromroots(roots: ToFloat64_1d | CoInteger_1d) -> Array_1d[np.float64]: ...
@overload
def polyfromroots(roots: CoFloating_1d) -> Array_1d[np.floating]: ...
@overload
def polyfromroots(roots: ToComplex128_1d) -> Array_1d[np.complex128]: ...
@overload
def polyfromroots(roots: ToComplex_1d) -> Array_1d[np.complexfloating]: ...
@overload
def polyfromroots(roots: CoComplex_1d) -> Array_1d[np.inexact]: ...
@overload
def polyfromroots(roots: ToObject_1d) -> Array_1d[np.object_]: ...

#
@overload
def polyadd(c1: CoInteger_1d, c2: CoInteger_1d) -> Array_1d[np.float64]: ...
@overload
def polyadd(c1: ToFloat64_1d, c2: CoFloat64_1d) -> Array_1d[np.float64]: ...
@overload
def polyadd(c1: CoFloat64_1d, c2: ToFloat64_1d) -> Array_1d[np.float64]: ...
@overload
def polyadd(c1: ToReal_1d, c2: CoFloating_1d) -> Array_1d[np.floating]: ...
@overload
def polyadd(c1: CoFloating_1d, c2: ToReal_1d) -> Array_1d[np.floating]: ...
@overload
def polyadd(c1: ToComplex128_1d, c2: CoComplex128_1d) -> Array_1d[np.complex128]: ...
@overload
def polyadd(c1: CoComplex128_1d, c2: ToComplex128_1d) -> Array_1d[np.complex128]: ...
@overload
def polyadd(c1: ToComplex_1d, c2: CoComplex_1d) -> Array_1d[np.complexfloating]: ...
@overload
def polyadd(c1: CoComplex_1d, c2: ToComplex_1d) -> Array_1d[np.complexfloating]: ...
@overload
def polyadd(c1: ToObject_1d, c2: _ToNumeric_1d) -> Array_1d[np.object_]: ...
@overload
def polyadd(c1: _ToNumeric_1d, c2: ToObject_1d) -> Array_1d[np.object_]: ...

#
@overload
def polysub(c1: CoInteger_1d, c2: CoInteger_1d) -> Array_1d[np.float64]: ...
@overload
def polysub(c1: ToFloat64_1d, c2: CoFloat64_1d) -> Array_1d[np.float64]: ...
@overload
def polysub(c1: CoFloat64_1d, c2: ToFloat64_1d) -> Array_1d[np.float64]: ...
@overload
def polysub(c1: ToReal_1d, c2: CoFloating_1d) -> Array_1d[np.floating]: ...
@overload
def polysub(c1: CoFloating_1d, c2: ToReal_1d) -> Array_1d[np.floating]: ...
@overload
def polysub(c1: ToComplex128_1d, c2: CoComplex128_1d) -> Array_1d[np.complex128]: ...
@overload
def polysub(c1: CoComplex128_1d, c2: ToComplex128_1d) -> Array_1d[np.complex128]: ...
@overload
def polysub(c1: ToComplex_1d, c2: CoComplex_1d) -> Array_1d[np.complexfloating]: ...
@overload
def polysub(c1: CoComplex_1d, c2: ToComplex_1d) -> Array_1d[np.complexfloating]: ...
@overload
def polysub(c1: ToObject_1d, c2: _ToNumeric_1d) -> Array_1d[np.object_]: ...
@overload
def polysub(c1: _ToNumeric_1d, c2: ToObject_1d) -> Array_1d[np.object_]: ...

#
@overload
def polymulx(c: ToFloat64_1d | CoInteger_1d) -> Array_1d[np.float64]: ...
@overload
def polymulx(c: CoFloating_1d) -> Array_1d[np.floating]: ...
@overload
def polymulx(c: ToComplex128_1d) -> Array_1d[np.complex128]: ...
@overload
def polymulx(c: ToComplex_1d) -> Array_1d[np.complexfloating]: ...
@overload
def polymulx(c: CoComplex_1d) -> Array_1d[np.inexact]: ...
@overload
def polymulx(c: ToObject_1d) -> Array_1d[np.object_]: ...

#
@overload
def polymul(c1: CoInteger_1d, c2: CoInteger_1d) -> Array_1d[np.float64]: ...
@overload
def polymul(c1: ToFloat64_1d, c2: CoFloat64_1d) -> Array_1d[np.float64]: ...
@overload
def polymul(c1: CoFloat64_1d, c2: ToFloat64_1d) -> Array_1d[np.float64]: ...
@overload
def polymul(c1: ToReal_1d, c2: CoFloating_1d) -> Array_1d[np.floating]: ...
@overload
def polymul(c1: CoFloating_1d, c2: ToReal_1d) -> Array_1d[np.floating]: ...
@overload
def polymul(c1: ToComplex128_1d, c2: CoComplex128_1d) -> Array_1d[np.complex128]: ...
@overload
def polymul(c1: CoComplex128_1d, c2: ToComplex128_1d) -> Array_1d[np.complex128]: ...
@overload
def polymul(c1: ToComplex_1d, c2: CoComplex_1d) -> Array_1d[np.complexfloating]: ...
@overload
def polymul(c1: CoComplex_1d, c2: ToComplex_1d) -> Array_1d[np.complexfloating]: ...
@overload
def polymul(c1: ToObject_1d, c2: _ToNumeric_1d) -> Array_1d[np.object_]: ...
@overload
def polymul(c1: _ToNumeric_1d, c2: ToObject_1d) -> Array_1d[np.object_]: ...

#
@overload
def polydiv(c1: CoInteger_1d, c2: CoInteger_1d) -> Array_1d[np.float64]: ...
@overload
def polydiv(c1: ToFloat64_1d, c2: CoFloat64_1d) -> Array_1d[np.float64]: ...
@overload
def polydiv(c1: CoFloat64_1d, c2: ToFloat64_1d) -> Array_1d[np.float64]: ...
@overload
def polydiv(c1: ToReal_1d, c2: CoFloating_1d) -> Array_1d[np.floating]: ...
@overload
def polydiv(c1: CoFloating_1d, c2: ToReal_1d) -> Array_1d[np.floating]: ...
@overload
def polydiv(c1: ToComplex128_1d, c2: CoComplex128_1d) -> Array_1d[np.complex128]: ...
@overload
def polydiv(c1: CoComplex128_1d, c2: ToComplex128_1d) -> Array_1d[np.complex128]: ...
@overload
def polydiv(c1: ToComplex_1d, c2: CoComplex_1d) -> Array_1d[np.complexfloating]: ...
@overload
def polydiv(c1: CoComplex_1d, c2: ToComplex_1d) -> Array_1d[np.complexfloating]: ...
@overload
def polydiv(c1: ToObject_1d, c2: _ToNumeric_1d) -> Array_1d[np.object_]: ...
@overload
def polydiv(c1: _ToNumeric_1d, c2: ToObject_1d) -> Array_1d[np.object_]: ...

#
@overload
def polypow(c: ToFloat64_1d | CoInteger_nd, pow: CoInteger_0d, maxpower: CoInteger_0d | None = None) -> Array_1d[np.float64]: ...
@overload
def polypow(c: CoFloating_1d, pow: CoInteger_0d, maxpower: CoInteger_0d | None = None) -> Array_1d[np.floating]: ...
@overload
def polypow(c: ToComplex128_1d, pow: CoInteger_0d, maxpower: CoInteger_0d | None = None) -> Array_1d[np.complex128]: ...
@overload
def polypow(c: ToComplex_1d, pow: CoInteger_0d, maxpower: CoInteger_0d | None = None) -> Array_1d[np.complexfloating]: ...
@overload
def polypow(c: CoComplex_1d, pow: CoInteger_0d, maxpower: CoInteger_0d | None = None) -> Array_1d[np.inexact]: ...
@overload
def polypow(c: ToObject_1d, pow: CoInteger_0d, maxpower: CoInteger_0d | None = None) -> Array_1d[np.object_]: ...
...
#
@overload
def polycompanion(c: CoFloating_1d) -> Array_2d[np.float64]: ...
@overload
def polycompanion(c: ToComplex_1d) -> Array_2d[np.complex128]: ...
@overload
def polycompanion(c: ToObject_1d) -> Array_2d[np.object_]: ...

#
@overload
def polyroots(c: CoFloating_1d) -> Array_1d[np.float64]: ...
@overload
def polyroots(c: ToComplex_1d) -> Array_1d[np.complex128]: ...
@overload
def polyroots(c: ToObject_1d) -> Array_1d[np.object_]: ...
