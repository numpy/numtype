...
@overload
def polyder(c: _nt.ToFloating_nd, m: _Index = 1, scl: _nt.CoFloating_0d = 1, axis: _Index = 0) -> _Float_nd: ...
@overload
...
@overload
def polyvalfromroots(x: _nt.CoFloating_1nd, r: _nt.CoFloating_nd, tensor: bool = True) -> _Float_nd: ...
@overload
def polyvalfromroots(x: _nt.CoFloating_nd, r: _nt.CoFloating_1nd, tensor: bool = True) -> _Float_nd: ...
@overload
