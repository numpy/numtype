...
@overload
def as_series(alist: Iterable[ToComplex_1d | ToComplex_0d], trim: bool = True) -> list[Array_1d[np.complexfloating]]: ...  # type: ignore[overload-overlap]
@overload
...
@overload
def trimcoef(c: ToComplex_1d | ToComplex_0d, tol: _FloatLike_co = 0) -> Array_1d[np.complexfloating]: ...  # type: ignore[overload-overlap]
@overload
...
@overload
def getdomain(x: ToComplex_1d | ToComplex_0d) -> Array_1d[np.complex128]: ...  # type: ignore[overload-overlap]
@overload
...
#
@overload
def mapdomain(x: CoFloating_0d, old: CoFloating_1d, new: CoFloating_1d) -> np.floating: ...  # type: ignore[overload-overlap]
@overload
def mapdomain(x: ToComplex_0d, old: CoComplex_1d, new: CoComplex_1d) -> np.complexfloating: ...  # type: ignore[overload-overlap]
@overload
def mapdomain(x: CoComplex_0d, old: ToComplex_1d, new: CoComplex_1d) -> np.complexfloating: ...  # type: ignore[overload-overlap]
@overload
def mapdomain(x: CoComplex_0d, old: CoComplex_1d, new: ToComplex_1d) -> np.complexfloating: ...  # type: ignore[overload-overlap]
@overload
def mapdomain(x: CoFloating_1d, old: CoFloating_1d, new: CoFloating_1d) -> Array_1d[np.floating]: ...
@overload
def mapdomain(x: ToComplex_1d, old: CoComplex_1d, new: CoComplex_1d) -> Array_1d[np.complexfloating]: ...  # type: ignore[overload-overlap]
@overload
def mapdomain(x: CoComplex_1d, old: ToComplex_1d, new: CoComplex_1d) -> Array_1d[np.complexfloating]: ...  # type: ignore[overload-overlap]
@overload
def mapdomain(x: CoComplex_1d, old: CoComplex_1d, new: ToComplex_1d) -> Array_1d[np.complexfloating]: ...  # type: ignore[overload-overlap]
@overload
