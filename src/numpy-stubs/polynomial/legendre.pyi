...
###
@overload
def poly2leg(pol: ToFloat64_1d | CoInteger_1d) -> Array1D[np.float64]: ...
@overload
def poly2leg(pol: CoFloating_1d) -> Array1D[np.floating]: ...
@overload
def poly2leg(pol: ToComplex128_1d) -> Array1D[np.complex128]: ...
@overload
def poly2leg(pol: ToComplex_1d) -> Array1D[np.complexfloating]: ...
@overload
def poly2leg(pol: CoComplex_1d) -> Array1D[np.inexact]: ...
@overload
def poly2leg(pol: ToObject_1d) -> Array1D[np.object_]: ...

#
@overload
def leg2poly(c: ToFloat64_1d | CoInteger_1d) -> Array1D[np.float64]: ...
@overload
def leg2poly(c: CoFloating_1d) -> Array1D[np.floating]: ...
@overload
def leg2poly(c: ToComplex128_1d) -> Array1D[np.complex128]: ...
@overload
def leg2poly(c: ToComplex_1d) -> Array1D[np.complexfloating]: ...
@overload
def leg2poly(c: CoComplex_1d) -> Array1D[np.inexact]: ...
@overload
def leg2poly(c: ToObject_1d) -> Array1D[np.object_]: ...
...
#
def leggauss(deg: CanIndex) -> tuple[Array1D[np.float64], Array1D[np.float64]]: ...
