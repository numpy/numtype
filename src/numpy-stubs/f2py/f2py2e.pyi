...
def callcrackfortran(files: list[str], options: dict[str, bool]) -> list[dict[str, Incomplete]]: ...
def buildmodules(lst: Iterable[Mapping[str, object]]) -> dict[str, dict[str, Incomplete]]: ...
...
def get_newer_options(iline: Iterable[str]) -> tuple[list[str], Incomplete, list[str]]: ...
