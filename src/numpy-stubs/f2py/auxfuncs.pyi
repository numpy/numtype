...
# .
def getdimension(var: _Var) -> list[Incomplete] | None: ...
...
#
def dictappend(
    rd: Mapping[str, Incomplete],
    ar: Mapping[str, Incomplete] | list[Mapping[str, Incomplete]],
) -> dict[str, Incomplete]: ...
def applyrules(rules: Mapping[str, Incomplete], d: Mapping[str, Incomplete], var: _Var = {}) -> dict[str, Incomplete]: ...
