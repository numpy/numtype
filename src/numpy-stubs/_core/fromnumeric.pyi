...
@overload
def around(a: Just[int], decimals: CanIndex = 0, out: None = None) -> np.intp: ...
@overload
def around(a: Just[float], decimals: CanIndex = 0, out: None = None) -> np.float64: ...
@overload
def around(a: Just[complex], decimals: CanIndex = 0, out: None = None) -> np.complex128: ...
@overload
