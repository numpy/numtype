...
@overload
def matrix_power(a: ToIntP_1nd, n: _PosInt) -> _Array_2nd[np.intp]: ...
@overload
...
@overload
def outer(x1: ToIntP_1d, x2: CoIntP_1d, /) -> Array2D[np.intp]: ...
@overload
...
@overload
def multi_dot(arrays: Iterable[Sequence[Just[int]]], *, out: None = None) -> np.intp: ...
@overload
def multi_dot(arrays: Iterable[Sequence2ND[Just[int]]], *, out: None = None) -> Array[np.intp]: ...
@overload
def multi_dot(arrays: Iterable[Sequence[Just[float]]], *, out: None = None) -> np.float64: ...
@overload
def multi_dot(arrays: Iterable[Sequence2ND[Just[float]]], *, out: None = None) -> Array[np.float64]: ...
@overload
def multi_dot(arrays: Iterable[Sequence[Just[complex]]], *, out: None = None) -> np.complex128: ...
@overload
def multi_dot(arrays: Iterable[Sequence2ND[Just[complex]]], *, out: None = None) -> Array[np.complex128]: ...
@overload
...
@overload
def diagonal(x: Sequence2ND[Just[int]], /, *, offset: CanIndex = 0) -> Array[np.intp]: ...
@overload
def diagonal(x: Sequence2ND[Just[float]], /, *, offset: CanIndex = 0) -> Array[np.float64]: ...
@overload
def diagonal(x: Sequence2ND[Just[complex]], /, *, offset: CanIndex = 0) -> Array[np.complex128]: ...
@overload
def diagonal(x: Sequence2ND[Just[bytes]], /, *, offset: CanIndex = 0) -> Array[np.bytes_]: ...
@overload
def diagonal(x: Sequence2ND[Just[str]], /, *, offset: CanIndex = 0) -> Array[np.str_]: ...
@overload
...
@overload
def trace(x: Sequence2D[Just[int]], /, *, offset: CanIndex = 0, dtype: None = None) -> np.intp: ...
@overload
def trace(x: Sequence3ND[Just[int]], /, *, offset: CanIndex = 0, dtype: None = None) -> Array[np.intp]: ...
@overload
def trace(x: Sequence2D[Just[float]], /, *, offset: CanIndex = 0, dtype: None = None) -> np.float64: ...
@overload
def trace(x: Sequence3ND[Just[float]], /, *, offset: CanIndex = 0, dtype: None = None) -> Array[np.float64]: ...
@overload
def trace(x: Sequence2D[Just[complex]], /, *, offset: CanIndex = 0, dtype: None = None) -> np.complex128: ...
@overload
def trace(x: Sequence3ND[Just[complex]], /, *, offset: CanIndex = 0, dtype: None = None) -> Array[np.complex128]: ...
@overload
