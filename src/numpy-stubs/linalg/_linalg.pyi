...
@overload
def matmul(x1: ToCFloating_1ds, x2: CoNumber_1ds, /) -> np.complexfloating: ...  # type: ignore[overload-overlap]
@overload
def matmul(x1: CoNumber_1ds, x2: ToCFloating_1ds, /) -> np.complexfloating: ...  # type: ignore[overload-overlap]
@overload
...
def norm(x: CoNumber_1nd, ord: _Ord | None = None, axis: None = None, keepdims: _False = False) -> np.floating: ...
@overload  # +number, keepdims=True
def norm(x: CoNumber_1nd, ord: _Ord | None = None, axis: _Ax2 | None = None, *, keepdims: _True) -> _Array_2nd[np.floating]: ...
@overload  # +number, axis=<given> (positional)
def norm(x: CoNumber_1nd, ord: _Ord | None, axis: _Ax2, keepdims: bool = False) -> Array[np.floating]: ...
@overload  # +number, axis=<given> (keyword)
def norm(x: CoNumber_1nd, ord: _Ord | None = None, *, axis: _Ax2, keepdims: bool = False) -> Array[np.floating]: ...
@overload  # +number
def norm(x: CoNumber_1nd, ord: _Ord | None = None, axis: _Ax2 | None = None, keepdims: bool = False) -> Any: ...
...
@overload  # 2d +number
def matrix_norm(x: CoNumber_2ds, /, *, keepdims: bool = False, ord: _Ord = "fro") -> np.floating: ...  # type: ignore[overload-overlap]
@overload  # nd +number, keepdims=True
def matrix_norm(x: CoNumber_1nd, /, *, keepdims: _True, ord: _Ord = "fro") -> _Array_2nd[np.floating]: ...
@overload  # >2d +number
...
@overload  # +number, axis=None, keepdims=False
def vector_norm(x: CoNumber_1nd, /, *, axis: None = None, keepdims: _False = False, ord: float = 2) -> np.floating: ...
@overload  # +number, keepdims=True
def vector_norm(x: CoNumber_1nd, /, *, axis: _Ax2 | None = None, keepdims: _True, ord: float = 2) -> Array[np.floating]: ...
@overload  # +number, axis=<given>
def vector_norm(x: CoNumber_1nd, /, *, axis: _Ax2, keepdims: bool = False, ord: float = 2) -> Array[np.floating]: ...
@overload  # +number
def vector_norm(x: CoNumber_1nd, /, *, axis: _Ax2 | None = None, keepdims: bool = False, ord: float = 2) -> Any: ...
...
@overload
def trace(x: CoNumber_2ds, /, *, offset: CanIndex = 0, dtype: _ToDType[_ScalarT]) -> _ScalarT: ...  # type: ignore[overload-overlap]
@overload
