...
_NativeScalarT = TypeVar(
    "_NativeScalarT", bound=np.bool | np.number | np.flexible | np.datetime64 | np.timedelta64
)  # no object_
...
_ToArray_2nd_ish: TypeAlias = (
    CanLenArrayND[_ScalarT] | Sequence[Sequence1ND[_ScalarT]] | Sequence1ND[CanLenArrayND[_ScalarT]]
)
...
#
@overload
def matrix_power(a: CanLenArray[_NumberT, _Shape2T], n: _PosInt) -> Array[_NumberT, _Shape2T]: ...
@overload
def matrix_power(a: ToBool_1nd, n: _PosInt) -> _Array_2nd[np.bool]: ...
@overload
def matrix_power(a: ToInt_1nd, n: _PosInt) -> _Array_2nd[np.intp]: ...
@overload
...
@overload
def outer(x1: CoFloat64_1d, x2: ToFloat64_1d, /) -> Array2D[np.float64]: ...
@overload
def outer(x1: ToComplex64_1d, x2: ToComplex64_1d, /) -> Array2D[np.complex64]: ...
@overload
def outer(x1: ToComplex128_1d, x2: CoComplex128_1d, /) -> Array2D[np.complex128]: ...
@overload
def outer(x1: CoComplex128_1d, x2: ToComplex128_1d, /) -> Array2D[np.complex128]: ...
@overload
def outer(x1: ToTimeDelta_1d, x2: CoTimeDelta_1d, /) -> Array2D[np.timedelta64]: ...
@overload
def outer(x1: CoTimeDelta_1d, x2: ToTimeDelta_1d, /) -> Array2D[np.timedelta64]: ...
@overload
def outer(x1: ToObject_1d, x2: ToObject_1d, /) -> Array2D[np.object_]: ...
@overload
def outer(x1: ToInteger_1d, x2: CoInteger_1d, /) -> Array2D[np.integer]: ...
@overload
def outer(x1: CoInteger_1d, x2: ToInteger_1d, /) -> Array2D[np.integer]: ...
@overload
def outer(x1: ToNumber_1d, x2: ToNumber_1d, /) -> Array2D[Any]: ...
...
@overload
def multi_dot(arrays: Iterable[Sequence2ND[bool]], *, out: None = None) -> Array[np.bool]: ...
@overload
def multi_dot(arrays: Iterable[Sequence[JustInt]], *, out: None = None) -> np.intp: ...
@overload
def multi_dot(arrays: Iterable[Sequence2ND[JustInt]], *, out: None = None) -> Array[np.intp]: ...
@overload
def multi_dot(arrays: Iterable[Sequence[JustFloat]], *, out: None = None) -> np.float64: ...
@overload
def multi_dot(arrays: Iterable[Sequence2ND[JustFloat]], *, out: None = None) -> Array[np.float64]: ...
@overload
def multi_dot(arrays: Iterable[Sequence[JustComplex]], *, out: None = None) -> np.complex128: ...
@overload
def multi_dot(arrays: Iterable[Sequence2ND[JustComplex]], *, out: None = None) -> Array[np.complex128]: ...
@overload
...
@overload
def cross(x1: ToInt_1nd, x2: CoInt64_1nd, /, *, axis: int = -1) -> Array[np.intp]: ...
@overload
def cross(x1: CoInt64_1nd, x2: ToInt_1nd, /, *, axis: int = -1) -> Array[np.intp]: ...
@overload
...
@overload
def matmul(x1: ToInt_1ds, x2: CoInt64_1ds, /) -> np.intp: ...
@overload
def matmul(x1: CoInt64_1ds, x2: ToInt_1ds, /) -> np.intp: ...
@overload
def matmul(x1: ToInt_2nd, x2: CoInt64_1nd, /) -> Array[np.intp]: ...
@overload
def matmul(x1: CoInt64_1nd, x2: ToInt_2nd, /) -> Array[np.intp]: ...
@overload
...
@overload
def matmul(x1: ToComplex_1ds, x2: CoComplex_1ds, /) -> np.complexfloating: ...
@overload
def matmul(x1: CoComplex_1ds, x2: ToComplex_1ds, /) -> np.complexfloating: ...
@overload
...
def norm(
    x: ToFloat16_1nd, ord: _Ord | None = None, axis: _Ax2 | None = None, *, keepdims: _True
...
def norm(
    x: CoComplex_1nd, ord: _Ord | None = None, axis: _Ax2 | None = None, *, keepdims: _True
) -> _Array_2nd[np.floating]: ...
...
def vector_norm(
    x: ToFloat16_1nd, /, *, axis: _Ax2 | None = None, keepdims: _True, ord: float = 2
) -> Array[np.float16]: ...
...
@overload  # +number, keepdims=True
def vector_norm(
    x: CoComplex_1nd, /, *, axis: _Ax2 | None = None, keepdims: _True, ord: float = 2
) -> Array[np.floating]: ...
...
#
@overload
def diagonal(x: ToObject_2nd, /, *, offset: CanIndex = 0) -> Array[np.object_]: ...
@overload
def diagonal(x: _ToArray_2ds[_NativeScalarT], /, *, offset: CanIndex = 0) -> Array1D[_NativeScalarT]: ...
@overload
def diagonal(x: _ToArray_2nd_ish[_NativeScalarT], /, *, offset: CanIndex = 0) -> Array[_NativeScalarT]: ...
@overload
def diagonal(x: Sequence2ND[bool], /, *, offset: CanIndex = 0) -> Array[np.bool]: ...
@overload
def diagonal(x: Sequence2ND[JustInt], /, *, offset: CanIndex = 0) -> Array[np.intp]: ...
@overload
def diagonal(x: Sequence2ND[JustFloat], /, *, offset: CanIndex = 0) -> Array[np.float64]: ...
@overload
def diagonal(x: Sequence2ND[JustComplex], /, *, offset: CanIndex = 0) -> Array[np.complex128]: ...
@overload
def diagonal(x: Sequence2ND[JustBytes], /, *, offset: CanIndex = 0) -> Array[np.bytes_]: ...
@overload
def diagonal(x: Sequence2ND[JustStr], /, *, offset: CanIndex = 0) -> Array[np.str_]: ...
@overload
...
@overload
def trace(x: Sequence2D[bool], /, *, offset: CanIndex = 0, dtype: None = None) -> np.bool: ...
@overload
def trace(x: Sequence3ND[bool], /, *, offset: CanIndex = 0, dtype: None = None) -> Array[np.bool]: ...
@overload
def trace(x: Sequence2D[JustInt], /, *, offset: CanIndex = 0, dtype: None = None) -> np.intp: ...
@overload
def trace(x: Sequence3ND[JustInt], /, *, offset: CanIndex = 0, dtype: None = None) -> Array[np.intp]: ...
@overload
def trace(x: Sequence2D[JustFloat], /, *, offset: CanIndex = 0, dtype: None = None) -> np.float64: ...
@overload
def trace(x: Sequence3ND[JustFloat], /, *, offset: CanIndex = 0, dtype: None = None) -> Array[np.float64]: ...
@overload
def trace(x: Sequence2D[JustComplex], /, *, offset: CanIndex = 0, dtype: None = None) -> np.complex128: ...
@overload
def trace(x: Sequence3ND[JustComplex], /, *, offset: CanIndex = 0, dtype: None = None) -> Array[np.complex128]: ...
@overload
def trace(x: CoComplex_2ds, /, *, offset: CanIndex = 0, dtype: _ToDType[_ScalarT]) -> _ScalarT: ...
@overload
