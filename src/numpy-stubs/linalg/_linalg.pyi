...
@overload
def multi_dot(arrays: Iterable[Sequence2ND[Is[int]]], *, out: None = None) -> Array[np.intp]: ...
@overload
def multi_dot(arrays: Iterable[Sequence[Is[float]]], *, out: None = None) -> np.float64: ...
@overload
def multi_dot(arrays: Iterable[Sequence2ND[Is[float]]], *, out: None = None) -> Array[np.float64]: ...
@overload
def multi_dot(arrays: Iterable[Sequence[Is[complex]]], *, out: None = None) -> np.complex128: ...
@overload
def multi_dot(arrays: Iterable[Sequence2ND[Is[complex]]], *, out: None = None) -> Array[np.complex128]: ...
@overload
...
@overload
def diagonal(x: Sequence2ND[Is[int]], /, *, offset: CanIndex = 0) -> Array[np.intp]: ...
@overload
def diagonal(x: Sequence2ND[Is[float]], /, *, offset: CanIndex = 0) -> Array[np.float64]: ...
@overload
def diagonal(x: Sequence2ND[Is[complex]], /, *, offset: CanIndex = 0) -> Array[np.complex128]: ...
@overload
def diagonal(x: Sequence2ND[Is[bytes]], /, *, offset: CanIndex = 0) -> Array[np.bytes_]: ...
@overload
def diagonal(x: Sequence2ND[Is[str]], /, *, offset: CanIndex = 0) -> Array[np.str_]: ...
@overload
...
@overload
def trace(x: Sequence2D[Is[int]], /, *, offset: CanIndex = 0, dtype: None = None) -> np.intp: ...
@overload
def trace(x: Sequence3ND[Is[int]], /, *, offset: CanIndex = 0, dtype: None = None) -> Array[np.intp]: ...
@overload
def trace(x: Sequence2D[Is[float]], /, *, offset: CanIndex = 0, dtype: None = None) -> np.float64: ...
@overload
def trace(x: Sequence3ND[Is[float]], /, *, offset: CanIndex = 0, dtype: None = None) -> Array[np.float64]: ...
@overload
def trace(x: Sequence2D[Is[complex]], /, *, offset: CanIndex = 0, dtype: None = None) -> np.complex128: ...
@overload
def trace(x: Sequence3ND[Is[complex]], /, *, offset: CanIndex = 0, dtype: None = None) -> Array[np.complex128]: ...
@overload
