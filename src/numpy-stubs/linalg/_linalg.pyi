...
_Shape2T = TypeVar("_Shape2T", bound=_nt.AtLeast2D)
...
_ToFloat64_1nd: TypeAlias = _nt._ToArray2_1nd[np.float64 | _ToInteger, float]
_ToFloat64_2ds: TypeAlias = _nt._ToArray2_2ds[np.float64 | _ToInteger, float]
_ToFloat64_3nd: TypeAlias = _nt._ToArray2_3nd[np.float64 | _ToInteger, float]
...
_Toinexact64_1nd: TypeAlias = _nt._ToArray2_1nd[_nt.inexact64 | _ToInteger, complex]
_Toinexact64_2ds: TypeAlias = _nt._ToArray2_2ds[_nt.inexact64 | _ToInteger, complex]
_Toinexact64_3nd: TypeAlias = _nt._ToArray2_3nd[_nt.inexact64 | _ToInteger, complex]
...
_ToUnsafe64_1nd: TypeAlias = _nt._ToArray2_1nd[
    _nt.inexact64 | _ToInteger | np.character[Any], complex | _nt._PyCharacter
]
...
@overload
def tensorinv(a: _nt.ToComplex128_1nd, ind: int = 2) -> _Array_2nd[np.complex128]: ...
@overload
def tensorinv(a: _nt.ToFloat32_1nd, ind: int = 2) -> _Array_2nd[np.float32]: ...
@overload
def tensorinv(a: _nt.ToComplex64_1nd, ind: int = 2) -> _Array_2nd[np.complex64]: ...
@overload
def tensorinv(a: _nt.CoFloat64_1nd, ind: int = 2) -> _Array_2nd[np.floating]: ...
@overload
def tensorinv(a: _nt.CoComplex128_1nd, ind: int = 2) -> _Array_2nd[np.inexact]: ...

# keep in sync with `tensorinv`
@overload
def inv(a: _ToFloat64_1nd) -> _Array_2nd[np.float64]: ...
@overload
def inv(a: _nt.ToComplex128_1nd) -> _Array_2nd[np.complex128]: ...
@overload
def inv(a: _nt.ToFloat32_1nd) -> _Array_2nd[np.float32]: ...
@overload
def inv(a: _nt.ToComplex64_1nd) -> _Array_2nd[np.complex64]: ...
@overload
def inv(a: _nt.CoFloat64_1nd) -> _Array_2nd[np.floating]: ...
@overload
...
#
@overload
def matrix_power(a: _nt.CanLenArray[_NumberT, _Shape2T], n: _PosInt) -> _nt.Array[_NumberT, _Shape2T]: ...
@overload
def matrix_power(a: _nt.ToBool_1nd, n: _PosInt) -> _Array_2nd[np.bool]: ...
@overload
def matrix_power(a: _nt.ToInt_1nd, n: _PosInt) -> _Array_2nd[np.intp]: ...
@overload
...
@overload
def matrix_power(a: _nt.ToComplex128_1nd, n: CanIndex) -> _Array_2nd[np.complex128]: ...
@overload
def matrix_power(a: _nt.ToFloat32_1nd, n: CanIndex) -> _Array_2nd[np.float32]: ...
@overload
def matrix_power(a: _nt.ToComplex64_1nd, n: CanIndex) -> _Array_2nd[np.complex64]: ...
@overload
def matrix_power(a: _nt.ToObject_1nd, n: CanIndex) -> _Array_2nd[np.object_]: ...
@overload
def matrix_power(a: _nt.ToUInteger_1nd, n: _PosInt) -> _Array_2nd[np.unsignedinteger]: ...
@overload
def matrix_power(a: _nt.ToInteger_1nd, n: _PosInt) -> _Array_2nd[np.integer]: ...
@overload
def matrix_power(a: _nt.CoComplex128_1nd, n: _NegInt) -> _Array_2nd[np.inexact]: ...
@overload
def matrix_power(a: _nt.CoComplex_1nd | _nt.ToObject_1nd, n: CanIndex) -> _Array_2nd[Any]: ...

#
@overload
def cholesky(a: _ToFloat64_1nd, /, *, upper: bool = False) -> _Array_2nd[np.float64]: ...
@overload
def cholesky(a: _nt.ToComplex128_1nd, /, *, upper: bool = False) -> _Array_2nd[np.complex128]: ...
@overload
def cholesky(a: _nt.ToFloat32_1nd, /, *, upper: bool = False) -> _Array_2nd[np.float32]: ...
@overload
def cholesky(a: _nt.ToComplex64_1nd, /, *, upper: bool = False) -> _Array_2nd[np.complex64]: ...
@overload
def cholesky(a: _nt.CoFloat64_1nd, /, *, upper: bool = False) -> _Array_2nd[np.floating]: ...
@overload
...
def qr(a: _nt.ToComplex128_1nd, mode: L["raw"]) -> _2Tuple[_Array_2nd[np.complex128]]: ...
@overload  # complex128, r
def qr(a: _nt.ToComplex128_1nd, mode: L["r"]) -> _Array_2nd[np.complex128]: ...
...
def qr(a: _nt.ToFloat32_1nd, mode: L["raw"]) -> _2Tuple[_Array_2nd[np.float32]]: ...
@overload  # float32, r
def qr(a: _nt.ToFloat32_1nd, mode: L["r"]) -> _Array_2nd[np.float32]: ...
...
def matrix_norm(x: _nt.ToFloat16_1nd, /, *, keepdims: _True, ord: _Ord = "fro") -> _Array_2nd[np.float16]: ...
@overload  # >2d float16
...
def matrix_norm(x: _nt.CoComplex_1nd, /, *, keepdims: _True, ord: _Ord = "fro") -> _Array_2nd[np.floating]: ...
@overload  # >2d +number
