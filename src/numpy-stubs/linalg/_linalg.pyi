...
from numpy._typing import DTypeLike, _DTypeLike as _ToDType, _ShapeLike
...
_Axis2: TypeAlias = _ToInt | _2Tuple[_ToInt]
...
_ToFloat64_1nd: TypeAlias = _ToArray_1nd[np.double | np.integer | np.bool, float]
_ToFloat64_2ds: TypeAlias = _ToArray_2ds[np.double | np.integer | np.bool, float]
_ToFloat64_3nd: TypeAlias = _ToArray_3nd[np.double | np.integer | np.bool, float]
...
@overload
def tensorsolve(a: ToFloat32_1nd, b: ToFloat32_1nd, axes: _ShapeLike | None = None) -> Array[np.float32]: ...
@overload
...
@overload
def tensorsolve(a: ToComplex64_1nd, b: CoComplex64_1nd, axes: _Axes | None = None) -> Array[np.complex64]: ...
@overload
def tensorsolve(a: CoComplex64_1nd, b: ToComplex64_1nd, axes: _Axes | None = None) -> Array[np.complex64]: ...
@overload
...
@overload
def solve(a: ToComplex64_1nd, b: CoComplex64_1nd) -> Array[np.complex64]: ...
@overload
def solve(a: CoComplex64_1nd, b: ToComplex64_1nd) -> Array[np.complex64]: ...
@overload
...
#
@overload
def matrix_power(a: CanArraySized[_NumberT, _Shape2T], n: _PosInt) -> Array[_NumberT, _Shape2T]: ...
@overload
def matrix_power(a: CoBool_1nd, n: _PosInt) -> _Array_2nd[np.bool]: ...
@overload
def matrix_power(a: ToInt32_1nd, n: _PosInt) -> _Array_2nd[np.int32]: ...
@overload
def matrix_power(a: ToUInt32_1nd, n: _PosInt) -> _Array_2nd[np.uint32]: ...
@overload
def matrix_power(a: ToInt64_1nd, n: _PosInt) -> _Array_2nd[np.int64]: ...
@overload
def matrix_power(a: ToUInt64_1nd, n: _PosInt) -> _Array_2nd[np.uint64]: ...
@overload
def matrix_power(a: ToSInteger_1nd, n: _PosInt) -> _Array_2nd[np.signedinteger]: ...
@overload
...
@overload
def matrix_power(a: ToFloat64_1nd, n: CanIndex) -> _Array_2nd[np.float64]: ...
@overload
def matrix_power(a: ToComplex64_1nd, n: CanIndex) -> _Array_2nd[np.complex64]: ...
@overload
def matrix_power(a: ToComplex128_1nd, n: CanIndex) -> _Array_2nd[np.complex128]: ...
@overload
...
@overload
def matrix_power(a: ToObject_1nd, n: CanIndex) -> _Array_2nd[np.object_]: ...
@overload
def matrix_power(a: CoNumber_1nd | ToObject_1nd, n: CanIndex) -> _Array_2nd[Any]: ...
...
@overload
def outer(x1: _ToArray_1d[_IntegerT], x2: _ToArray_1d[_IntegerT], /) -> Array_2d[_IntegerT]: ...
@overload
...
@overload
def outer(x1: ToFloat32_1d, x2: CoFloat32_1d, /) -> Array_2d[np.float32]: ...
@overload
def outer(x1: CoFloat32_1d, x2: ToFloat32_1d, /) -> Array_2d[np.float32]: ...
@overload
...
@overload
def outer(x1: ToComplex64_1d, x2: CoComplex64_1d, /) -> Array_2d[np.complex64]: ...
@overload
def outer(x1: CoComplex64_1d, x2: ToComplex64_1d, /) -> Array_2d[np.complex64]: ...
@overload
...
# TODO(jorenham): 1d -> scalar; otherwise -> array
@overload
def multi_dot(arrays: Iterable[_ToArray_1ds[_AnyNumberT]], *, out: None = None) -> _AnyNumberT: ...
@overload
def multi_dot(arrays: Iterable[_ToArray_2nd[_AnyNumberT]], *, out: None = None) -> Array[_AnyNumberT]: ...
@overload
...
@overload
def multi_dot(arrays: Iterable[CoNumber_1nd], *, out: _ArrayT) -> _ArrayT: ...
@overload
def multi_dot(arrays: Iterable[CoNumber_1nd | ToTimeDelta_1nd | ToObject_1nd], *, out: None = None) -> Any: ...
...
@overload
def cross(x1: ToCFloating_1nd, x2: CoNumber_1nd, /, *, axis: int = -1) -> Array[np.complexfloating]: ...
@overload
def cross(x1: CoNumber_1nd, x2: ToCFloating_1nd, /, *, axis: int = -1) -> Array[np.complexfloating]: ...
@overload
def cross(x1: CoNumber_1nd, x2: CoNumber_1nd, /, *, axis: int = -1) -> Array[Any]: ...
...
@overload
def matmul(x1: ToIntP_1ds, x2: CoIntP_1ds, /) -> np.intp: ...
@overload
def matmul(x1: CoIntP_1ds, x2: ToIntP_1ds, /) -> np.intp: ...
@overload
def matmul(x1: ToIntP_2nd, x2: CoIntP_1nd, /) -> Array[np.intp]: ...
@overload
def matmul(x1: CoIntP_1nd, x2: ToIntP_2nd, /) -> Array[np.intp]: ...
@overload
def matmul(x1: ToInteger_1ds, x2: CoInteger_1ds, /) -> np.integer: ...
@overload
def matmul(x1: CoInteger_1ds, x2: ToInteger_1ds, /) -> np.integer: ...
@overload
...
@overload
def matmul(x1: ToFloat64_1ds, x2: CoFloat64_1ds, /) -> np.float64: ...
@overload
def matmul(x1: CoFloat64_1ds, x2: ToFloat64_1ds, /) -> np.float64: ...
@overload
...
@overload
def matmul(x1: ToFloating_1ds, x2: CoFloating_1ds, /) -> np.floating: ...
@overload
def matmul(x1: CoFloating_1ds, x2: ToFloating_1ds, /) -> np.floating: ...
@overload
...
@overload
def matmul(x1: ToComplex128_1ds, x2: CoComplex128_1ds, /) -> np.complex128: ...
@overload
def matmul(x1: CoComplex128_1ds, x2: ToComplex128_1ds, /) -> np.complex128: ...
@overload
...
@overload
def matmul(x1: ToCFloating_1ds, x2: CoNumber_1ds, /) -> np.complexfloating: ...
@overload
def matmul(x1: CoNumber_1ds, x2: ToCFloating_1ds, /) -> np.complexfloating: ...
@overload
def matmul(x1: ToCFloating_2nd, x2: CoNumber_1nd, /) -> Array[np.complexfloating]: ...
@overload
def matmul(x1: CoNumber_1nd, x2: ToCFloating_2nd, /) -> Array[np.complexfloating]: ...
@overload
def matmul(x1: CoNumber_2nd, x2: CoNumber_1nd, /) -> Array[Any]: ...
@overload
def matmul(x1: CoNumber_1nd, x2: CoNumber_2nd, /) -> Array[Any]: ...
@overload
def matmul(x1: CoNumber_1nd, x2: CoNumber_1nd, /) -> Any: ...
...
def eigvalsh(a: ToFloat32_1nd | ToComplex64_1nd, UPLO: _UPLO = "L") -> Array[np.float32]: ...
@overload  # float64 | complex128
def eigvalsh(a: _ToFloat64_1nd | ToComplex128_1nd, UPLO: _UPLO = "L") -> Array[np.float64]: ...
@overload  # +complex128
...
def svd(
    a: ToFloat32_1nd | ToComplex64_1nd,
    full_matrices: bool,
    compute_uv: L[False],
    hermitian: bool = False,
) -> Array[np.float32]: ...
...
def svd(
    a: _ToFloat64_1nd | ToComplex128_1nd | Sequence_1nd[complex],
    full_matrices: bool,
    compute_uv: L[False],
    hermitian: bool = False,
) -> Array[np.float64]: ...
...
def svdvals(x: ToFloat32_1nd | ToComplex64_1nd, /) -> Array[np.float32]: ...
@overload  # float64 | complex128
def svdvals(x: _ToFloat64_1nd | ToComplex128_1nd, /) -> Array[np.float64]: ...
@overload  # +complex128
...
def cond(x: ToFloat32_2ds | ToComplex64_2ds, p: _Ord | None = None) -> np.float32: ...
@overload  # >2d float32 | complex64
def cond(x: ToFloat32_3nd | ToComplex64_3nd, p: _Ord | None = None) -> Array[np.float32]: ...
@overload  # 2d float64 | complex128
def cond(x: _ToFloat64_2ds | ToComplex128_2ds | Sequence_2d[complex], p: _Ord | None = None) -> np.float64: ...
@overload  # >2d float64 | complex128
def cond(x: _ToFloat64_3nd | ToComplex128_3nd, p: _Ord | None = None) -> Array[np.float64]: ...
@overload  # 2d +complex128
...
@overload  # 2d float32
def slogdet(a: ToFloat32_2ds) -> SlogdetResult[np.float32, np.float32]: ...
@overload  # >2d float32
...
def slogdet(a: ToComplex64_2ds) -> SlogdetResult[np.float32, np.complex64]: ...
@overload  # >2d complex64
def slogdet(a: ToComplex64_3nd) -> SlogdetResult[Array[np.float32], Array[np.complex64]]: ...
@overload  # 2d complex128
def slogdet(a: ToComplex128_2ds) -> SlogdetResult[np.float64, np.complex128]: ...
@overload  # >2d complex128
...
#
@overload  # 2d float32
def det(a: ToFloat32_2ds) -> np.float32: ...
@overload  # >2d float32
...
@overload  # 2d complex64
def det(a: ToComplex64_2ds) -> np.complex64: ...
@overload  # >2d complex64
def det(a: ToComplex64_3nd) -> Array[np.complex64]: ...
@overload  # 2d complex128
def det(a: ToComplex128_2ds) -> np.complex128: ...
@overload  # >2d complex128
...
def lstsq(a: ToComplex64_1nd, b: CoComplex64_1nd, rcond: float | None = None) -> _LstSqResult[np.complex64, np.float32]: ...
...
def norm(
    x: ToFloat16_1nd,
    ord: _Ord | None = None,
    axis: _Axis2 | None = None,
    *,
    keepdims: L[True],
) -> _Array_2nd[np.float16]: ...
...
def norm(
    x: ToFloat32_1nd | ToComplex64_1nd,
    ord: _Ord | None = None,
    axis: None = None,
    keepdims: L[False] = False,
) -> np.float32: ...
...
def norm(
    x: _ToFloat64_1nd | ToComplex128_1nd | ToCharacter_1nd,
    ord: _Ord | None = None,
    axis: None = None,
    keepdims: L[False] = False,
) -> np.float64: ...
...
def norm(
    x: ToLongDouble_1nd | ToCLongDouble_1nd,
    ord: _Ord | None = None,
    axis: None = None,
    keepdims: L[False] = False,
) -> np.longdouble: ...
...
#
@overload  # 2d float16
def matrix_norm(x: ToFloat16_2ds, /, *, keepdims: bool = False, ord: _Ord = "fro") -> np.float16: ...
@overload  # >2d float16
def matrix_norm(x: ToFloat16_3nd, /, *, keepdims: bool = False, ord: _Ord = "fro") -> Array[np.float16]: ...
@overload  # nd float16, keepdims=True
def matrix_norm(x: ToFloat16_1nd, /, *, keepdims: L[True], ord: _Ord = "fro") -> _Array_2nd[np.float16]: ...
@overload  # 2d float32 | complex64, keepdims=True
def matrix_norm(
    x: ToFloat32_2ds | ToComplex64_2ds,
    /,
    *,
    keepdims: bool = False,
    ord: _Ord = "fro",
...
@overload  # >2d float32 | complex64
def matrix_norm(
    x: ToFloat32_3nd | ToComplex64_3nd,
    /,
    *,
    keepdims: bool = False,
    ord: _Ord = "fro",
...
def matrix_norm(
    x: _ToFloat64_2ds | ToComplex128_2ds | ToCharacter_2ds,
    /,
    *,
    keepdims: bool = False,
    ord: _Ord = "fro",
...
@overload  # >2d float64 | complex128 | character
def matrix_norm(
    x: _ToFloat64_3nd | ToComplex128_3nd | ToCharacter_3nd,
    /,
    *,
    keepdims: bool = False,
    ord: _Ord = "fro",
...
def matrix_norm(
    x: ToLongDouble_2ds | ToCLongDouble_2ds,
    /,
    *,
    keepdims: bool = False,
    ord: _Ord = "fro",
...
@overload  # >2d longdouble | clongdouble
def matrix_norm(
    x: ToLongDouble_3nd | ToCLongDouble_3nd,
    /,
    *,
    keepdims: bool = False,
    ord: _Ord = "fro",
...
@overload  # 2d +number
def matrix_norm(x: CoNumber_2ds, /, *, keepdims: bool = False, ord: _Ord = "fro") -> np.floating: ...
@overload  # >2d +number
def matrix_norm(x: CoNumber_3nd, /, *, keepdims: bool = False, ord: _Ord = "fro") -> Array[np.floating]: ...
@overload  # nd +number, keepdims=True
def matrix_norm(x: CoNumber_1nd, /, *, keepdims: L[True], ord: _Ord = "fro") -> _Array_2nd[np.floating]: ...
@overload  # nd +number
def matrix_norm(x: CoNumber_1nd | ToCharacter_1nd, /, *, keepdims: bool = False, ord: _Ord = "fro") -> Any: ...
...
@overload
def trace(x: _ToArray_3nd[_ScalarT], /, *, offset: CanIndex = 0, dtype: None = None) -> Array[_ScalarT]: ...
@overload
...
@overload
def trace(x: CoNumber_2ds, /, *, offset: CanIndex = 0, dtype: _ToDType[_ScalarT]) -> _ScalarT: ...
@overload
def trace(x: CoNumber_3nd, /, *, offset: CanIndex = 0, dtype: _ToDType[_ScalarT]) -> Array[_ScalarT]: ...
@overload
def trace(x: CoNumber_3nd, /, *, offset: CanIndex = 0, dtype: DTypeLike | None = None) -> Array[Any]: ...
@overload
def trace(x: CoNumber_1nd, /, *, offset: CanIndex = 0, dtype: DTypeLike | None = None) -> Any: ...
