...
@overload
def polyder(p: _ToArray2_1d[np.float64 | np.float32 | np.float16, Is[float]], m: _ToInt = 1) -> Array1D[np.float64]: ...
@overload
def polyder(p: _ToArray2_1d[np.complex128 | np.complex64, Is[complex]], m: _ToInt = 1) -> Array1D[np.complex128]: ...
@overload
