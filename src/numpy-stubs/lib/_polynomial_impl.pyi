...
class poly1d(Generic[_ScalarT_co]):
    ...
    def o(self) -> int: ...
    @property
    def roots(self) -> Array1D[np.inexact]: ...
    @property
    def r(self) -> Array1D[np.inexact]: ...
    ...
    @overload
    def __init__(self, /, c_or_r: _ToArray_1d[_ScalarT_co], r: L[False] = False, variable: str | None = None) -> None: ...
    @overload
    ...
    @overload
    def __array__(self, /, t: np.dtype[_ScalarT], copy: bool | None = None) -> Array1D[_ScalarT]: ...
...
#
@overload
def poly(seq_of_zeros: poly1d) -> Array1D[np.float64]: ...
@overload
def poly(seq_of_zeros: CoInteger_1d | CoInteger_2d) -> Array1D[np.float64]: ...
@overload
def poly(seq_of_zeros: ToFloat64_1d | ToFloat64_2d) -> Array1D[np.float64]: ...
@overload
def poly(seq_of_zeros: ToComplex128_1d | ToComplex128_2d) -> Array1D[np.complex128]: ...
@overload
def poly(seq_of_zeros: ToFloat32_1d | ToFloat32_2d) -> Array1D[np.float32]: ...
@overload
def poly(seq_of_zeros: ToComplex64_1d | ToComplex64_2d) -> Array1D[np.complex64]: ...
@overload
def poly(seq_of_zeros: ToObject_1d | ToObject_2d) -> Array1D[np.object_]: ...
@overload
def poly(seq_of_zeros: CoComplex128_1d | CoComplex128_2d) -> Array1D[np.inexact]: ...

# returns either a float or complex array depending on the input values. See `np.linalg.eigvals`.
@overload
def roots(p: CoInteger_1d) -> Array1D[np.float64 | np.complex128]: ...
@overload
def roots(p: ToFloat64_1d) -> Array1D[np.float64 | np.complex128]: ...
@overload
def roots(p: ToComplex128_1d) -> Array1D[np.complex128]: ...
@overload
def roots(p: ToFloat32_1d) -> Array1D[np.float32 | np.complex64]: ...
@overload
def roots(p: ToComplex64_1d) -> Array1D[np.complex64]: ...
@overload
def roots(p: CoComplex128_1d) -> Array1D[np.inexact]: ...
...
@overload
def polyder(p: ToCLongDouble_1d, m: _ToInt = 1) -> Array1D[np.clongdouble]: ...
@overload
def polyder(p: ToObject_1d, m: _ToInt = 1) -> Array1D[np.object_]: ...
@overload
def polyder(p: CoComplex128_1d, m: _ToInt = 1) -> Array1D[np.complex128 | np.float64 | np.intp]: ...

#
@overload
def polyint(p: poly1d, m: _ToInt = 1, k: CoComplex_nd | ToObject_nd | None = None) -> poly1d: ...
@overload
def polyint(p: CoFloat64_1d, m: _ToInt = 1, k: CoFloat64_0d | CoFloat64_1d | None = None) -> Array1D[np.float64]: ...
@overload
def polyint(p: ToLongDouble_1d, m: _ToInt = 1, k: CoFloating_0d | CoFloating_1d | None = None) -> Array1D[np.longdouble]: ...
@overload
def polyint(
...
@overload
def polyval(p: ToUInteger_1d, x: CoUInt64_0d) -> np.unsignedinteger: ...
@overload
def polyval(p: CoUInt64_1d, x: ToUInteger_0d) -> np.unsignedinteger: ...
@overload
def polyval(p: ToSInteger_1d, x: CoInt64_0d) -> np.signedinteger: ...
@overload
def polyval(p: CoInt64_1d, x: ToSInteger_0d) -> np.signedinteger: ...
@overload
...
@overload
def polyval(p: ToUInteger_1d, x: CoUInt64_1nd) -> Array[np.unsignedinteger]: ...
@overload
def polyval(p: CoUInt64_1d, x: ToUInteger_1nd) -> Array[np.unsignedinteger]: ...
@overload
def polyval(p: ToSInteger_1d, x: CoInt64_1nd) -> Array[np.signedinteger]: ...
@overload
def polyval(p: CoInt64_1d, x: ToSInteger_1nd) -> Array[np.signedinteger]: ...
@overload
...
@overload
def polyadd(a1: ToUInteger_nd, a2: CoUInt64_nd) -> Array[np.unsignedinteger]: ...
@overload
def polyadd(a1: CoUInt64_nd, a2: ToUInteger_nd) -> Array[np.unsignedinteger]: ...
@overload
def polyadd(a1: ToSInteger_nd, a2: CoInt64_nd) -> Array[np.signedinteger]: ...
@overload
def polyadd(a1: CoInt64_nd, a2: ToSInteger_nd) -> Array[np.signedinteger]: ...
@overload
...
@overload
def polymul(a1: ToUInteger_nd, a2: CoUInt64_nd) -> Array[np.unsignedinteger]: ...
@overload
def polymul(a1: CoUInt64_nd, a2: ToUInteger_nd) -> Array[np.unsignedinteger]: ...
@overload
def polymul(a1: ToSInteger_nd, a2: CoInt64_nd) -> Array[np.signedinteger]: ...
@overload
def polymul(a1: CoInt64_nd, a2: ToSInteger_nd) -> Array[np.signedinteger]: ...
@overload
...
@overload
def polysub(a1: ToUInteger_nd, a2: CoUInt64_nd) -> Array[np.unsignedinteger]: ...
@overload
def polysub(a1: CoUInt64_nd, a2: ToUInteger_nd) -> Array[np.unsignedinteger]: ...
@overload
def polysub(a1: ToSInteger_nd, a2: CoInt64_nd) -> Array[np.signedinteger]: ...
@overload
def polysub(a1: CoInt64_nd, a2: ToSInteger_nd) -> Array[np.signedinteger]: ...
@overload
