...
@overload
def poly(seq_of_zeros: ToFloat64_1d | ToFloat64_2d) -> Array_1d[np.float64]: ...
@overload
def poly(seq_of_zeros: ToComplex128_1d | ToComplex128_2d) -> Array_1d[np.complex128]: ...
@overload
...
@overload
def polyder(p: ToLongDouble_1d, m: _ToInt = 1) -> Array_1d[np.longdouble]: ...
@overload
def polyder(p: ToCLongDouble_1d, m: _ToInt = 1) -> Array_1d[np.clongdouble]: ...
@overload
