...
#
@overload
def expand_dims(a: _ToArray[_ScalarT], axis: _nt.ToShape) -> _nt.Array[_ScalarT]: ...
@overload
def expand_dims(a: ArrayLike, axis: _nt.ToShape) -> _nt.Array[Incomplete]: ...
...
@overload
def array_split(
    ary: _ToArray[_ScalarT], indices_or_sections: _nt.ToShape, axis: CanIndex = 0
) -> _ArrayList[_ScalarT]: ...
@overload
def array_split(
    ary: ArrayLike, indices_or_sections: _nt.ToShape, axis: CanIndex = 0
) -> list[_nt.Array[Incomplete]]: ...

#
@overload
def split(ary: _ToArray[_ScalarT], indices_or_sections: _nt.ToShape, axis: CanIndex = 0) -> _ArrayList[_ScalarT]: ...
@overload
def split(ary: ArrayLike, indices_or_sections: _nt.ToShape, axis: CanIndex = 0) -> list[_nt.Array[Incomplete]]: ...

#
@overload
def hsplit(ary: _ToArray[_ScalarT], indices_or_sections: _nt.ToShape) -> _ArrayList[_ScalarT]: ...
@overload
def hsplit(ary: ArrayLike, indices_or_sections: _nt.ToShape) -> list[_nt.Array[Incomplete]]: ...

#
@overload
def vsplit(ary: _ToArray[_ScalarT], indices_or_sections: _nt.ToShape) -> _ArrayList[_ScalarT]: ...
@overload
def vsplit(ary: ArrayLike, indices_or_sections: _nt.ToShape) -> list[_nt.Array[Incomplete]]: ...

#
@overload
def dsplit(ary: _ToArray[_ScalarT], indices_or_sections: _nt.ToShape) -> _ArrayList[_ScalarT]: ...
@overload
def dsplit(ary: ArrayLike, indices_or_sections: _nt.ToShape) -> list[_nt.Array[Incomplete]]: ...
