...
@overload
def kron(a: ToUInteger_nd, b: CoUInteger_nd) -> NDArray[np.unsignedinteger]: ...
@overload
def kron(a: CoUInteger_nd, b: ToUInteger_nd) -> NDArray[np.unsignedinteger]: ...
@overload
def kron(a: ToSInteger_nd, b: CoSInteger_nd) -> NDArray[np.signedinteger]: ...
@overload
def kron(a: CoSInteger_nd, b: ToSInteger_nd) -> NDArray[np.signedinteger]: ...
@overload
