...
def asarray_chkfinite(
    a: ToComplex128_nd, dtype: None = None, order: _OrderKACF | None = None
) -> Array[np.complex128]: ...
@overload
...
@overload
def copy(
    a: CanLenArray[_ScalarT, _ShapeT], order: _OrderKACF = "K", subok: L[False] = False
...
@overload
def gradient(
    f: ToGeneric_0d, *varargs: ArrayLike, axis: _ShapeLike | None = None, edge_order: L[1, 2] = 1
) -> tuple[()]: ...
@overload
...
@overload
def unwrap(
    p: _ArrayLikeFloat_co, discont: float | None = None, axis: int = -1, *, period: float = ...
) -> Array[np.floating]: ...
@overload
def unwrap(
    p: _ArrayLikeObject_co, discont: float | None = None, axis: int = -1, *, period: float = ...
) -> Array[np.object_]: ...
...
@overload
def delete(
    arr: _ArrayLike[_ScalarT], obj: slice | _ArrayLikeInt_co, axis: SupportsIndex | None = None
) -> Array[_ScalarT]: ...
@overload
