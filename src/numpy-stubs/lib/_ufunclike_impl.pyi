...
@overload
def fix(x: _FloatLike_co, out: None = ...) -> np.floating: ...
@overload
def fix(x: _ArrayLikeFloat_co, out: None = ...) -> NDArray[np.floating]: ...
@overload
def fix(x: _ArrayLikeObject_co, out: None = ...) -> NDArray[np.object_]: ...
@overload
