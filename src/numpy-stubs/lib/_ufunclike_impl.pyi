...
@overload
def fix(x: ToInt_0d, out: None = None) -> np.intp: ...
@overload
...
@overload
def fix(x: ToInt_1nd, out: None = None) -> Array[np.intp]: ...
@overload
...
@overload
def isposinf(
    x: CanLenArray[np.floating | np.integer | np.bool, _ShapeT], out: None = None
) -> Array[np.bool, _ShapeT]: ...
@overload
