...
class Arrayterator(ndarray[_Shape, _DType]):
    ...
    def __init__(self, var: ndarray[_Shape, _DType], buf_size: int | None = ...) -> None: ...
    @overload
    def __array__(self, dtype: None = ..., copy: bool | None = ...) -> ndarray[_AnyShape, _DType]: ...
    @overload
    def __array__(self, dtype: DTypeLike, copy: bool | None = ...) -> NDArray[Any]: ...
    def __getitem__(self, index: _Index) -> Arrayterator[_AnyShape, _DType]: ...
    def __iter__(self) -> Iterator[ndarray[_AnyShape, _DType]]: ...
