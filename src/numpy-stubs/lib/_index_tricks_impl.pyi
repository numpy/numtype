...
@overload
def ix_(*args: JustInt | SequenceND[JustInt]) -> _Arrays[np.intp]: ...
@overload
def ix_(*args: JustFloat | SequenceND[JustFloat]) -> _Arrays[np.float64]: ...
@overload
def ix_(*args: JustComplex | SequenceND[JustComplex]) -> _Arrays[np.complex128]: ...
@overload
def ix_(*args: JustBytes | SequenceND[JustBytes]) -> _Arrays[np.bytes_]: ...
@overload
def ix_(*args: JustStr | SequenceND[JustStr]) -> _Arrays[np.str_]: ...
@overload
