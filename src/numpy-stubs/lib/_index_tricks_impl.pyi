...
@overload
def ix_(*args: Just[int] | SequenceND[Just[int]]) -> _Arrays[np.intp]: ...
@overload
def ix_(*args: Just[float] | SequenceND[Just[float]]) -> _Arrays[np.float64]: ...
@overload
def ix_(*args: Just[complex] | SequenceND[Just[complex]]) -> _Arrays[np.complex128]: ...
@overload
def ix_(*args: Just[bytes] | SequenceND[Just[bytes]]) -> _Arrays[np.bytes_]: ...
@overload
def ix_(*args: Just[str] | SequenceND[Just[str]]) -> _Arrays[np.str_]: ...
@overload
