...
@overload
def ix_(*args: bool | Sequence_nd[bool]) -> _Arrays[np.bool]: ...
@overload
def ix_(*args: Is[int] | Sequence_nd[Is[int]]) -> _Arrays[np.intp]: ...
@overload
def ix_(*args: Is[float] | Sequence_nd[Is[float]]) -> _Arrays[np.float64]: ...
@overload
def ix_(*args: Is[complex] | Sequence_nd[Is[complex]]) -> _Arrays[np.complex128]: ...
@overload
def ix_(*args: Is[bytes] | Sequence_nd[Is[bytes]]) -> _Arrays[np.bytes_]: ...
@overload
def ix_(*args: Is[str] | Sequence_nd[Is[str]]) -> _Arrays[np.str_]: ...
@overload
def ix_(*args: int | Sequence_nd[int]) -> _Arrays[np.intp | np.bool]: ...  # type: ignore[overload-cannot-match]  # pyright: ignore[reportOverlappingOverload]
@overload
def ix_(*args: float | Sequence_nd[float]) -> _Arrays[np.float64 | np.intp | np.bool]: ...  # type: ignore[overload-cannot-match]  # pyright: ignore[reportOverlappingOverload]
@overload
def ix_(*args: complex | Sequence_nd[complex]) -> _Arrays[np.complex128 | np.float64 | np.intp | np.bool]: ...  # type: ignore[overload-cannot-match]  # pyright: ignore[reportOverlappingOverload]
