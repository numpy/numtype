...
#
@overload
def tril(m: ToBool_1nd, k: int = 0) -> Array[np.bool_]: ...
@overload
def tril(m: _ToArray_1nd[_ScalarT], k: int = 0) -> Array[_ScalarT]: ...
@overload
def tril(m: ToIntP_1nd, k: int = 0) -> Array[Integer_]: ...
@overload
def tril(m: ToFloat64_1nd, k: int = 0) -> Array[Floating64]: ...
@overload
def tril(m: ToComplex128_1nd, k: int = 0) -> Array[CFloating64]: ...
@overload
def tril(m: ToBytes_1nd, k: int = 0) -> Array[_ToBytes]: ...
@overload
def tril(m: ToStr_1nd, k: int = 0) -> Array[_ToStr]: ...
@overload
