...
#
@overload
def vander(x: _nt._ToArray_1d[_NumberT], N: int | None = None, increasing: bool = False) -> _nt.Array2D[_NumberT]: ...
@overload
def vander(x: _nt.ToBool_1d, N: int | None = None, increasing: bool = False) -> _nt.Array2D[np.intp]: ...
@overload
def vander(x: _nt.ToInteger_1d, N: int | None = None, increasing: bool = False) -> _nt.Array2D[np.signedinteger]: ...
@overload
def vander(x: _nt.ToFloating_1d, N: int | None = None, increasing: bool = False) -> _nt.Array2D[np.floating]: ...
@overload
def vander(x: _nt.ToComplex_1d, N: int | None = None, increasing: bool = False) -> _nt.Array2D[np.complexfloating]: ...
@overload
