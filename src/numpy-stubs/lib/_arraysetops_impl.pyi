...
@overload
def union1d(ar1: ToBool_nd, ar2: ToBool_nd) -> Array_1d[np.bool]: ...
@overload
def union1d(ar1: ToIntP_nd, ar2: CoIntP_nd) -> Array_1d[np.intp]: ...
@overload
def union1d(ar1: CoIntP_nd, ar2: ToIntP_nd) -> Array_1d[np.intp]: ...
@overload
def union1d(ar1: ToComplex128_nd, ar2: CoComplex128_nd) -> Array_1d[np.complex128]: ...
@overload
def union1d(ar1: CoComplex128_nd, ar2: ToComplex128_nd) -> Array_1d[np.complex128]: ...
@overload
