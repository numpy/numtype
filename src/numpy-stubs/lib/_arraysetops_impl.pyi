...
@overload
def unique_values(x: ToIntP_nd) -> Array1D[np.intp]: ...
@overload
...
@overload
def union1d(ar1: ToIntP_nd, ar2: CoIntP_nd) -> Array1D[np.intp]: ...
@overload
def union1d(ar1: CoIntP_nd, ar2: ToIntP_nd) -> Array1D[np.intp]: ...
@overload
...
@overload
def setxor1d(ar1: ToIntP_nd, ar2: CoIntP_nd, assume_unique: bool = False) -> Array1D[np.intp]: ...
@overload
def setxor1d(ar1: CoIntP_nd, ar2: ToIntP_nd, assume_unique: bool = False) -> Array1D[np.intp]: ...
@overload
...
@overload
def setdiff1d(ar1: ToIntP_nd, ar2: CoIntP_nd, assume_unique: bool = False) -> Array1D[np.intp]: ...
@overload
def setdiff1d(ar1: CoIntP_nd, ar2: ToIntP_nd, assume_unique: bool = False) -> Array1D[np.intp]: ...
@overload
