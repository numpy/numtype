...
# NOTE: There are a huge amount of mypy `overload-overlap` false positives here, so we
# disable them all, and just rely on Pyright.
...
#
@overload
def sqrt(x: CoUInt8_0d) -> np.float16: ...
@overload
def sqrt(x: ToUInt16_0d) -> np.float32: ...
@overload
def sqrt(x: _ToArray_0d[np.uint64 | np.uint32]) -> np.float64: ...
@overload
...
@overload
def sqrt(x: ToFloat16_0d) -> np.float16 | np.complex128: ...  # why not complex64...?
@overload
def sqrt(x: ToFloat32_0d) -> np.float32 | np.complex64: ...
@overload
def sqrt(x: ToFloat64_0d) -> np.float64 | np.complex128: ...
@overload
def sqrt(x: ToLongDouble_0d) -> np.longdouble | np.complex128: ...  # why not clongdouble?
@overload
def sqrt(x: ToComplex64_0d) -> np.complex64: ...
@overload
def sqrt(x: ToComplex128_0d) -> np.complex128: ...
@overload
def sqrt(x: ToCLongDouble_0d) -> np.complex128 | np.clongdouble: ...  # why does this sometimes downcast?
@overload
def sqrt(x: ToComplex_0d) -> np.complexfloating: ...
@overload
def sqrt(x: CoComplex_0d) -> np.inexact: ...  # why is this useless comment here?
@overload
def sqrt(x: CoUInt8_1nd) -> Array[np.float16]: ...
@overload
def sqrt(x: ToUInt16_1nd) -> Array[np.float32]: ...
@overload
def sqrt(x: _ToArray_1nd[np.uint64 | np.uint32]) -> Array[np.float64]: ...
@overload
...
@overload
def log(x: CoUInt8_0d) -> np.float16: ...
@overload
def log(x: ToUInt16_0d) -> np.float32: ...
@overload
def log(x: _ToArray_0d[np.uint64 | np.uint32]) -> np.float64: ...
@overload
...
@overload
def log(x: ToFloat16_0d) -> np.float16 | np.complex128: ...  # why not complex64...?
@overload
def log(x: ToFloat32_0d) -> np.float32 | np.complex64: ...
@overload
def log(x: ToFloat64_0d) -> np.float64 | np.complex128: ...
@overload
def log(x: ToLongDouble_0d) -> np.longdouble | np.complex128: ...  # why not clongdouble?
@overload
def log(x: ToComplex64_0d) -> np.complex64: ...
@overload
def log(x: ToComplex128_0d) -> np.complex128: ...
@overload
def log(x: ToCLongDouble_0d) -> np.complex128 | np.clongdouble: ...  # why does this sometimes downcast?
@overload
def log(x: ToComplex_0d) -> np.complexfloating: ...
@overload
def log(x: CoComplex_0d) -> np.inexact: ...  # why is this useless comment here?
@overload
def log(x: CoUInt8_1nd) -> Array[np.float16]: ...
@overload
def log(x: ToUInt16_1nd) -> Array[np.float32]: ...
@overload
def log(x: _ToArray_1nd[np.uint64 | np.uint32]) -> Array[np.float64]: ...
@overload
...
# signature is equivalent to `sqrt`
@overload
def log10(x: CoUInt8_0d) -> np.float16: ...
@overload
def log10(x: ToUInt16_0d) -> np.float32: ...
@overload
def log10(x: _ToArray_0d[np.uint64 | np.uint32]) -> np.float64: ...
@overload
...
@overload
def log10(x: ToFloat16_0d) -> np.float16 | np.complex128: ...  # why not complex64...?
@overload
def log10(x: ToFloat32_0d) -> np.float32 | np.complex64: ...
@overload
def log10(x: ToFloat64_0d) -> np.float64 | np.complex128: ...
@overload
def log10(x: ToLongDouble_0d) -> np.longdouble | np.complex128: ...  # why not clongdouble?
@overload
def log10(x: ToComplex64_0d) -> np.complex64: ...
@overload
def log10(x: ToComplex128_0d) -> np.complex128: ...
@overload
def log10(x: ToCLongDouble_0d) -> np.complex128 | np.clongdouble: ...  # why does this sometimes downcast?
@overload
def log10(x: ToComplex_0d) -> np.complexfloating: ...
@overload
def log10(x: CoComplex_0d) -> np.inexact: ...  # why is this useless comment here?
@overload
def log10(x: CoUInt8_1nd) -> Array[np.float16]: ...
@overload
def log10(x: ToUInt16_1nd) -> Array[np.float32]: ...
@overload
def log10(x: _ToArray_1nd[np.uint64 | np.uint32]) -> Array[np.float64]: ...
@overload
...
# signature is equivalent to `sqrt`
@overload
def log2(x: CoUInt8_0d) -> np.float16: ...
@overload
def log2(x: ToUInt16_0d) -> np.float32: ...
@overload
def log2(x: _ToArray_0d[np.uint64 | np.uint32]) -> np.float64: ...
@overload
...
@overload
def log2(x: ToFloat16_0d) -> np.float16 | np.complex128: ...  # why not complex64...?
@overload
def log2(x: ToFloat32_0d) -> np.float32 | np.complex64: ...
@overload
def log2(x: ToFloat64_0d) -> np.float64 | np.complex128: ...
@overload
def log2(x: ToLongDouble_0d) -> np.longdouble | np.complex128: ...  # why not clongdouble?
@overload
def log2(x: ToComplex64_0d) -> np.complex64: ...
@overload
def log2(x: ToComplex128_0d) -> np.complex128: ...
@overload
def log2(x: ToCLongDouble_0d) -> np.complex128 | np.clongdouble: ...  # why does this sometimes downcast?
@overload
def log2(x: ToComplex_0d) -> np.complexfloating: ...
@overload
def log2(x: CoComplex_0d) -> np.inexact: ...  # why is this useless comment here?
@overload
def log2(x: CoUInt8_1nd) -> Array[np.float16]: ...
@overload
def log2(x: ToUInt16_1nd) -> Array[np.float32]: ...
@overload
def log2(x: _ToArray_1nd[np.uint64 | np.uint32]) -> Array[np.float64]: ...
@overload
...
@overload
def arccos(x: _ToArray_0d[np.uint16 | np.int16]) -> np.float32 | np.complex64: ...
@overload
def arccos(x: _ToArray_0d[np.uint64 | np.int64 | np.uint32 | np.int32, Is[int]]) -> np.float64 | np.complex128: ...
@overload
...
@overload
def arccos(x: _ToArray_1nd[np.uint16 | np.int16]) -> Array[np.float32 | np.complex64]: ...
@overload
...
@overload
def arcsin(x: _ToArray_0d[np.uint16 | np.int16]) -> np.float32 | np.complex64: ...
@overload
def arcsin(x: _ToArray_0d[np.uint64 | np.int64 | np.uint32 | np.int32, Is[int]]) -> np.float64 | np.complex128: ...
@overload
...
@overload
def arcsin(x: _ToArray_1nd[np.uint16 | np.int16]) -> Array[np.float32 | np.complex64]: ...
@overload
...
@overload
def arctanh(x: _ToArray_0d[np.uint16 | np.int16]) -> np.float32 | np.complex64: ...
@overload
def arctanh(x: _ToArray_0d[np.uint64 | np.int64 | np.uint32 | np.int32, Is[int]]) -> np.float64 | np.complex128: ...
@overload
...
@overload
def arctanh(x: _ToArray_1nd[np.uint16 | np.int16]) -> Array[np.float32 | np.complex64]: ...
@overload
...
# TODO: (b,b)-> i1, (u,u)-> u, (u, i|f)-> i|f, (i|f, u)-> i|c, (i|f, i|f)-> i|f|c
@overload
...
@overload
def power(x: ToSInteger_0d, p: ToFloating_0d) -> np.inexact: ...
@overload
...
@overload
def power(x: ToSInteger_1nd, p: ToFloating_nd) -> Array[np.inexact]: ...
@overload
def power(x: ToSInteger_nd, p: ToFloating_1nd) -> Array[np.inexact]: ...
@overload
