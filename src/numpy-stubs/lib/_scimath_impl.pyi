...
#
@overload
def arccos(x: _ToArray_0d[np.integer[_8Bit] | np.bool, bool]) -> np.float16 | np.complex64: ...  # type: ignore[overload-overlap]
@overload
def arccos(x: _ToArray_0d[np.integer[_64Bit] | np.integer[_32Bit], Is[int]]) -> np.float64 | np.complex128: ...
@overload
def arccos(x: _ToArray1_0d[np.integer[_16Bit]]) -> np.float32 | np.complex64: ...
@overload
...
@overload
def arccos(x: _ToArray_1nd[np.integer[_8Bit] | np.bool, bool]) -> Array[np.float16 | np.complex64]: ...  # type: ignore[overload-overlap]
@overload
def arccos(x: _ToArray_1nd[np.integer[_64Bit] | np.integer[_32Bit], Is[int]]) -> Array[np.float64 | np.complex128]: ...
@overload
def arccos(x: _ToArray1_1nd[np.integer[_16Bit]]) -> Array[np.float32 | np.complex64]: ...
@overload
...
@overload
def arcsin(x: _ToArray_0d[np.integer[_8Bit] | np.bool, bool]) -> np.float16 | np.complex64: ...  # type: ignore[overload-overlap]
@overload
def arcsin(x: _ToArray_0d[np.integer[_64Bit] | np.integer[_32Bit], Is[int]]) -> np.float64 | np.complex128: ...
@overload
def arcsin(x: _ToArray1_0d[np.integer[_16Bit]]) -> np.float32 | np.complex64: ...
@overload
...
@overload
def arcsin(x: _ToArray_1nd[np.integer[_8Bit] | np.bool, bool]) -> Array[np.float16 | np.complex64]: ...  # type: ignore[overload-overlap]
@overload
def arcsin(x: _ToArray_1nd[np.integer[_64Bit] | np.integer[_32Bit], Is[int]]) -> Array[np.float64 | np.complex128]: ...
@overload
def arcsin(x: _ToArray1_1nd[np.integer[_16Bit]]) -> Array[np.float32 | np.complex64]: ...
@overload
...
# signature is equivalent to `arccos`
@overload
def arctanh(x: _ToArray_0d[np.integer[_8Bit] | np.bool, bool]) -> np.float16 | np.complex64: ...  # type: ignore[overload-overlap]
@overload
def arctanh(x: _ToArray_0d[np.integer[_64Bit] | np.integer[_32Bit], Is[int]]) -> np.float64 | np.complex128: ...
@overload
def arctanh(x: _ToArray1_0d[np.integer[_16Bit]]) -> np.float32 | np.complex64: ...
@overload
...
@overload
def arctanh(x: _ToArray_1nd[np.integer[_8Bit] | np.bool, bool]) -> Array[np.float16 | np.complex64]: ...  # type: ignore[overload-overlap]
@overload
def arctanh(x: _ToArray_1nd[np.integer[_64Bit] | np.integer[_32Bit], Is[int]]) -> Array[np.float64 | np.complex128]: ...
@overload
def arctanh(x: _ToArray1_1nd[np.integer[_16Bit]]) -> Array[np.float32 | np.complex64]: ...
@overload
