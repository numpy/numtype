...
@overload
def sqrt(x: ToFloat64_1nd) -> Array[np.float64 | np.complex128]: ...  # type: ignore[overload-overlap]
@overload
...
@overload
def log(x: ToFloat64_1nd) -> Array[np.float64 | np.complex128]: ...  # type: ignore[overload-overlap]
@overload
...
@overload
def log10(x: ToFloat64_1nd) -> Array[np.float64 | np.complex128]: ...  # type: ignore[overload-overlap]
@overload
...
@overload
def log2(x: ToFloat64_1nd) -> Array[np.float64 | np.complex128]: ...  # type: ignore[overload-overlap]
@overload
...
@overload
def arccos(x: ToFloat64_1nd) -> Array[np.float64 | np.complex128]: ...  # type: ignore[overload-overlap]
@overload
...
@overload
def arcsin(x: ToFloat64_1nd) -> Array[np.float64 | np.complex128]: ...  # type: ignore[overload-overlap]
@overload
...
@overload
def arctanh(x: ToFloat64_1nd) -> Array[np.float64 | np.complex128]: ...  # type: ignore[overload-overlap]
@overload
