...
np.floating(1)  # type: ignore[call-arg]  # pyright: ignore[reportCallIssue]
np.complexfloating(1)  # type: ignore[call-arg]  # pyright: ignore[reportCallIssue]
np.unsignedinteger(1)  # type: ignore[call-arg]  # pyright: ignore[reportCallIssue]
np.signedinteger(1)  # type: ignore[call-arg]  # pyright: ignore[reportCallIssue]
