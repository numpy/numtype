...
np.ndindex([1, 2, 3])  # type: ignore[call-overload]  # pyright: ignore[reportArgumentType, reportCallIssue]
np.unravel_index(AR_LIKE_f, (1, 2, 3))  # type: ignore[arg-type]  # pyright: ignore[reportArgumentType, reportCallIssue]
