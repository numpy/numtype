...
assert_type(np.real(AR_LIKE_i), npt.NDArray[np.intp])
...
assert_type(np.nan_to_num(AR_LIKE_i, posinf=9999), npt.NDArray[Any])
...
assert_type(np.real_if_close(AR_LIKE_i), npt.NDArray[Any])
