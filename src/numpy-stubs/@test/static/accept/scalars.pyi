...
assert_type(b.ravel(), _nt.Array1D[np.bool])
assert_type(i8.ravel(), _nt.Array1D[np.int64])
assert_type(u8.ravel(), _nt.Array1D[np.uint64])
assert_type(f8.ravel(), _nt.Array1D[np.float64])
assert_type(c16.ravel(), _nt.Array1D[np.complex128])
assert_type(U.ravel(), _nt.Array1D[np.str_])
assert_type(S.ravel(), _nt.Array1D[np.bytes_])

assert_type(b.flatten(), _nt.Array1D[np.bool])
assert_type(i8.flatten(), _nt.Array1D[np.int64])
assert_type(u8.flatten(), _nt.Array1D[np.uint64])
assert_type(f8.flatten(), _nt.Array1D[np.float64])
assert_type(c16.flatten(), _nt.Array1D[np.complex128])
assert_type(U.flatten(), _nt.Array1D[np.str_])
assert_type(S.flatten(), _nt.Array1D[np.bytes_])

assert_type(b.reshape(()), np.bool)
assert_type(i8.reshape([]), np.int64)
assert_type(b.reshape(1), _nt.Array1D[np.bool])
assert_type(i8.reshape(-1), _nt.Array1D[np.int64])
assert_type(u8.reshape(1, 1), _nt.Array2D[np.uint64])
assert_type(f8.reshape(1, -1), _nt.Array2D[np.float64])
assert_type(c16.reshape(1, 1, 1), _nt.Array3D[np.complex128])
assert_type(S.reshape(1, 1, 1, 1), np.ndarray[_nt.Rank4N, np.dtype[np.bytes_]])
