...
assert_type(AR_b - AR_LIKE_c, npt.NDArray[np.complex128])
...
assert_type(AR_LIKE_c - AR_b, npt.NDArray[np.complex128])
...
assert_type(AR_u - AR_LIKE_c, npt.NDArray[np.complex128])
...
assert_type(AR_LIKE_c - AR_u, npt.NDArray[np.complex128])
...
assert_type(AR_i - AR_LIKE_c, npt.NDArray[np.complex128])
...
assert_type(AR_LIKE_c - AR_i, npt.NDArray[np.complex128])
...
# https://github.com/microsoft/pyright/issues/9684
assert_type(c + f8, np.complex128)  # pyright: ignore[reportAssertTypeFailure]
