...
assert_type(np.strings.expandtabs(AR_T), _StringArray)

assert_type(np.strings.ljust(AR_U, 5), _StrArray)
assert_type(np.strings.ljust(AR_S, [4, 3, 1], fillchar=[b"a", b"b", b"c"]), _BytesArray)
assert_type(np.strings.ljust(AR_T, 5), _StringArray)
assert_type(np.strings.ljust(AR_T, [4, 2, 1], fillchar=["a", "b", "c"]), _StringArray)

assert_type(np.strings.rjust(AR_U, 5), _StrArray)
assert_type(np.strings.rjust(AR_S, [4, 3, 1], fillchar=[b"a", b"b", b"c"]), _BytesArray)
assert_type(np.strings.rjust(AR_T, 5), _StringArray)
assert_type(np.strings.rjust(AR_T, [4, 2, 1], fillchar=["a", "b", "c"]), _StringArray)

assert_type(np.strings.lstrip(AR_U), _StrArray)
assert_type(np.strings.lstrip(AR_S, b"_"), _BytesArray)
assert_type(np.strings.lstrip(AR_T), _StringArray)
assert_type(np.strings.lstrip(AR_T, "_"), _StringArray)

assert_type(np.strings.rstrip(AR_U), _StrArray)
assert_type(np.strings.rstrip(AR_S, b"_"), _BytesArray)
assert_type(np.strings.rstrip(AR_T), _StringArray)
assert_type(np.strings.rstrip(AR_T, "_"), _StringArray)

assert_type(np.strings.strip(AR_U), _StrArray)
assert_type(np.strings.strip(AR_S, b"_"), _BytesArray)
assert_type(np.strings.strip(AR_T), _StringArray)
assert_type(np.strings.strip(AR_T, "_"), _StringArray)
...
assert_type(np.strings.translate(AR_T, ""), _StringArray)
