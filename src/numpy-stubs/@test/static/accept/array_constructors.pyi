...
assert_type(np.empty_like(A, dtype="c16", shape=(2, 2)), np.ndarray[tuple[int, int], np.dtype])
...
assert_type(np.zeros_like(A, dtype="c16", shape=(2, 2)), np.ndarray[tuple[int, int], np.dtype])
...
assert_type(np.ones_like(A, dtype="c16", shape=(2, 2)), np.ndarray[tuple[int, int], np.dtype])
...
assert_type(np.identity(10, dtype=int), np.ndarray[tuple[int, int], np.dtype])
