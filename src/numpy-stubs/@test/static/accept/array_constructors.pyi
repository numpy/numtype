...
assert_type(np.fromstring("1 1 1", sep=" "), _nt.Array1D[np.float64])
assert_type(np.fromstring(b"1 1 1", sep=" "), _nt.Array1D[np.float64])
assert_type(np.fromstring("1 1 1", dtype=np.int64, sep=" "), _nt.Array1D[np.int64])
assert_type(np.fromstring(b"1 1 1", dtype=np.int64, sep=" "), _nt.Array1D[np.int64])
assert_type(np.fromstring("1 1 1", dtype="c16", sep=" "), _nt.Array1D)
assert_type(np.fromstring(b"1 1 1", dtype="c16", sep=" "), _nt.Array1D)

assert_type(np.fromfile("test.txt", sep=" "), _nt.Array1D[np.float64])
assert_type(np.fromfile("test.txt", dtype=np.int64, sep=" "), _nt.Array1D[np.int64])
assert_type(np.fromfile("test.txt", dtype="c16", sep=" "), _nt.Array1D)
with open("test.txt", encoding="utf-8") as f:
    assert_type(np.fromfile(f, sep=" "), _nt.Array1D[np.float64])
    assert_type(np.fromfile(b"test.txt", sep=" "), _nt.Array1D[np.float64])
    assert_type(np.fromfile(Path("test.txt"), sep=" "), _nt.Array1D[np.float64])

assert_type(np.fromiter("12345", np.float64), _nt.Array[np.float64])
assert_type(np.fromiter("12345", float), _nt.Array)

assert_type(np.frombuffer(A), _nt.Array1D[np.float64])
assert_type(np.frombuffer(A, dtype=np.int64), _nt.Array1D[np.int64])
assert_type(np.frombuffer(A, dtype="c16"), _nt.Array1D)
