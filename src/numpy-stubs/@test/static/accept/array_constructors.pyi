...
assert_type(np.linspace(0, 10j), _nt.Array[np.complex128])
assert_type(np.linspace(0, 10, dtype=np.int64), _nt.Array[np.int64])
assert_type(np.linspace(0, 10, dtype=int), _nt.Array)
assert_type(np.linspace(0, 10, retstep=True), tuple[_nt.Array[np.float64], np.float64])
assert_type(np.linspace(0j, 10, retstep=True), tuple[_nt.Array[np.complex128], np.complex128])
...
assert_type(np.logspace(0, 10), _nt.Array[np.float64])
assert_type(np.logspace(0, 10j), _nt.Array[np.complex128])
...
assert_type(np.geomspace(0, 10j), _nt.Array[np.complex128])
