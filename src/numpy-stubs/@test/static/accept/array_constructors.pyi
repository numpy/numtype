...
class MyArray(np.ndarray[_nt.Shape1, np.dtype[_ScalarT_co]]): ...
...
assert_type(np.array(B), np.ndarray[_nt.Shape1, np.dtype[np.float64]])
assert_type(np.array(D), np.ndarray[_nt.Shape1, np.dtype[np.float64 | np.int64]])
...
assert_type(np.asarray(B), np.ndarray[_nt.Shape1, np.dtype[np.float64]])
...
assert_type(np.ascontiguousarray(B), np.ndarray[_nt.Shape1, np.dtype[np.float64]])
...
assert_type(np.asfortranarray(B), np.ndarray[_nt.Shape1, np.dtype[np.float64]])
...
assert_type(np.arange(False, True), np.ndarray[_nt.Shape1, np.dtype[np.int_]])
assert_type(np.arange(10), np.ndarray[_nt.Shape1, np.dtype[np.int_]])
assert_type(np.arange(0, 10, step=2), np.ndarray[_nt.Shape1, np.dtype[np.int_]])
assert_type(np.arange(10.0), np.ndarray[_nt.Shape1, np.dtype[np.float64 | np.int_]])
assert_type(np.arange(start=0, stop=10.0), np.ndarray[_nt.Shape1, np.dtype[np.float64 | np.int_]])
assert_type(np.arange(np.timedelta64(0)), np.ndarray[_nt.Shape1, np.dtype[np.timedelta64]])
assert_type(np.arange(0, np.timedelta64(10)), np.ndarray[_nt.Shape1, np.dtype[np.timedelta64]])
assert_type(np.arange(np.datetime64("0"), np.datetime64("10")), np.ndarray[_nt.Shape1, np.dtype[np.datetime64]])
assert_type(np.arange(10, dtype=np.float64), np.ndarray[_nt.Shape1, np.dtype[np.float64]])
assert_type(np.arange(0, 10, step=2, dtype=np.int16), np.ndarray[_nt.Shape1, np.dtype[np.int16]])
assert_type(np.arange(10, dtype=int), np.ndarray[_nt.Shape1, np.dtype[np.int_]])
assert_type(np.arange(0, 10, dtype="f8"), np.ndarray[_nt.Shape1, np.dtype])
...
assert_type(np.empty_like(A, shape=(2, 2)), np.ndarray[_nt.Shape2, np.dtype[np.float64]])
assert_type(np.empty_like(A, dtype=np.int64), npt.NDArray[np.int64])
assert_type(np.empty_like(A, dtype=np.int64, shape=(2, 2)), np.ndarray[_nt.Shape2, np.dtype[np.int64]])
...
assert_type(np.empty_like(True), np.ndarray[_nt.Shape0, np.dtype[np.bool]])
assert_type(np.empty_like([True]), np.ndarray[_nt.Shape1, np.dtype[np.bool]])
assert_type(np.empty_like([[True]]), np.ndarray[_nt.Shape2, np.dtype[np.bool]])
assert_type(np.empty_like([[[True]]]), np.ndarray[_nt.Shape3, np.dtype[np.bool]])
assert_type(np.empty_like(2), np.ndarray[_nt.Shape0, np.dtype[np.intp]])
assert_type(np.empty_like([2]), np.ndarray[_nt.Shape1, np.dtype[np.intp]])
assert_type(np.empty_like([[2]]), np.ndarray[_nt.Shape2, np.dtype[np.intp]])
assert_type(np.empty_like([[[2]]]), np.ndarray[_nt.Shape3, np.dtype[np.intp]])
assert_type(np.empty_like(0.3), np.ndarray[_nt.Shape0, np.dtype[np.float64]])
assert_type(np.empty_like([0.3]), np.ndarray[_nt.Shape1, np.dtype[np.float64]])
assert_type(np.empty_like([[0.3]]), np.ndarray[_nt.Shape2, np.dtype[np.float64]])
assert_type(np.empty_like([[[0.3]]]), np.ndarray[_nt.Shape3, np.dtype[np.float64]])
assert_type(np.empty_like(4j), np.ndarray[_nt.Shape0, np.dtype[np.complex128]])
assert_type(np.empty_like([4j]), np.ndarray[_nt.Shape1, np.dtype[np.complex128]])
assert_type(np.empty_like([[4j]]), np.ndarray[_nt.Shape2, np.dtype[np.complex128]])
assert_type(np.empty_like([[[4j]]]), np.ndarray[_nt.Shape3, np.dtype[np.complex128]])

assert_type(np.zeros_like(A), npt.NDArray[np.float64])
assert_type(np.zeros_like(A, dtype=float), npt.NDArray[np.float64])
assert_type(np.zeros_like(A, shape=(2, 2)), np.ndarray[_nt.Shape2, np.dtype[np.float64]])
assert_type(np.zeros_like(A, dtype=np.int64), npt.NDArray[np.int64])
assert_type(np.zeros_like(A, dtype=np.int64, shape=(2, 2)), np.ndarray[_nt.Shape2, np.dtype[np.int64]])
...
assert_type(np.zeros_like(True), np.ndarray[_nt.Shape0, np.dtype[np.bool]])
assert_type(np.zeros_like([True]), np.ndarray[_nt.Shape1, np.dtype[np.bool]])
assert_type(np.zeros_like([[True]]), np.ndarray[_nt.Shape2, np.dtype[np.bool]])
assert_type(np.zeros_like([[[True]]]), np.ndarray[_nt.Shape3, np.dtype[np.bool]])
assert_type(np.zeros_like(2), np.ndarray[_nt.Shape0, np.dtype[np.intp]])
assert_type(np.zeros_like([2]), np.ndarray[_nt.Shape1, np.dtype[np.intp]])
assert_type(np.zeros_like([[2]]), np.ndarray[_nt.Shape2, np.dtype[np.intp]])
assert_type(np.zeros_like([[[2]]]), np.ndarray[_nt.Shape3, np.dtype[np.intp]])
assert_type(np.zeros_like(0.3), np.ndarray[_nt.Shape0, np.dtype[np.float64]])
assert_type(np.zeros_like([0.3]), np.ndarray[_nt.Shape1, np.dtype[np.float64]])
assert_type(np.zeros_like([[0.3]]), np.ndarray[_nt.Shape2, np.dtype[np.float64]])
assert_type(np.zeros_like([[[0.3]]]), np.ndarray[_nt.Shape3, np.dtype[np.float64]])
assert_type(np.zeros_like(4j), np.ndarray[_nt.Shape0, np.dtype[np.complex128]])
assert_type(np.zeros_like([4j]), np.ndarray[_nt.Shape1, np.dtype[np.complex128]])
assert_type(np.zeros_like([[4j]]), np.ndarray[_nt.Shape2, np.dtype[np.complex128]])
assert_type(np.zeros_like([[[4j]]]), np.ndarray[_nt.Shape3, np.dtype[np.complex128]])

assert_type(np.ones_like(A), npt.NDArray[np.float64])
assert_type(np.ones_like(A, dtype=float), npt.NDArray[np.float64])
assert_type(np.ones_like(A, shape=(2, 2)), np.ndarray[_nt.Shape2, np.dtype[np.float64]])
assert_type(np.ones_like(A, dtype=np.int64), npt.NDArray[np.int64])
assert_type(np.ones_like(A, dtype=np.int64, shape=(2, 2)), np.ndarray[_nt.Shape2, np.dtype[np.int64]])
...
assert_type(np.ones_like(True), np.ndarray[_nt.Shape0, np.dtype[np.bool]])
assert_type(np.ones_like([True]), np.ndarray[_nt.Shape1, np.dtype[np.bool]])
assert_type(np.ones_like([[True]]), np.ndarray[_nt.Shape2, np.dtype[np.bool]])
assert_type(np.ones_like([[[True]]]), np.ndarray[_nt.Shape3, np.dtype[np.bool]])
assert_type(np.ones_like(2), np.ndarray[_nt.Shape0, np.dtype[np.intp]])
assert_type(np.ones_like([2]), np.ndarray[_nt.Shape1, np.dtype[np.intp]])
assert_type(np.ones_like([[2]]), np.ndarray[_nt.Shape2, np.dtype[np.intp]])
assert_type(np.ones_like([[[2]]]), np.ndarray[_nt.Shape3, np.dtype[np.intp]])
assert_type(np.ones_like(0.3), np.ndarray[_nt.Shape0, np.dtype[np.float64]])
assert_type(np.ones_like([0.3]), np.ndarray[_nt.Shape1, np.dtype[np.float64]])
assert_type(np.ones_like([[0.3]]), np.ndarray[_nt.Shape2, np.dtype[np.float64]])
assert_type(np.ones_like([[[0.3]]]), np.ndarray[_nt.Shape3, np.dtype[np.float64]])
assert_type(np.ones_like(4j), np.ndarray[_nt.Shape0, np.dtype[np.complex128]])
assert_type(np.ones_like([4j]), np.ndarray[_nt.Shape1, np.dtype[np.complex128]])
assert_type(np.ones_like([[4j]]), np.ndarray[_nt.Shape2, np.dtype[np.complex128]])
assert_type(np.ones_like([[[4j]]]), np.ndarray[_nt.Shape3, np.dtype[np.complex128]])

assert_type(np.full_like(A, i8), npt.NDArray[np.float64])
assert_type(np.full_like(C, i8), np.ndarray[_nt.Shape1, np.dtype[np.intp]])
...
assert_type(np.ones(_shape_0d), np.ndarray[_nt.Shape0, np.dtype[np.float64]])
assert_type(np.ones(_size), np.ndarray[_nt.Shape1, np.dtype[np.float64]])
assert_type(np.ones(_shape_2d), np.ndarray[_nt.Shape2, np.dtype[np.float64]])
assert_type(np.ones(_shape_nd), np.ndarray[_nt.Shape, np.dtype[np.float64]])
assert_type(np.ones(_shape_1d, dtype=np.int64), np.ndarray[_nt.Shape1, np.dtype[np.int64]])
assert_type(np.ones(_shape_like), npt.NDArray[np.float64])
assert_type(np.ones(_shape_like, dtype=np.dtypes.StringDType()), np.ndarray[_nt.Shape, np.dtypes.StringDType])
assert_type(np.ones(_shape_like, dtype=int), npt.NDArray[Any])

assert_type(np.full(_size, i8), np.ndarray[_nt.Shape1, np.dtype[np.int64]])
assert_type(np.full(_shape_2d, i8), np.ndarray[_nt.Shape2, np.dtype[np.int64]])
...
assert_type(np.full(_size, i8, dtype=np.float64), np.ndarray[_nt.Shape1, np.dtype[np.float64]])
assert_type(np.full(_size, i8, dtype=float), np.ndarray[_nt.Shape1, np.dtype[np.float64]])
...
assert_type(np.identity(10), np.ndarray[_nt.Shape2, np.dtype[np.float64]])
assert_type(np.identity(10, dtype=np.int64), np.ndarray[_nt.Shape2, np.dtype[np.int64]])
assert_type(np.identity(10, dtype=int), np.ndarray[_nt.Shape2, np.dtype])
