...
assert_type(i1_nd @ i_py, _nt.Array[np.int64])
...
assert_type(i_py @ i1_nd, _nt.Array[np.int64])
...
assert_type(i2_nd @ i_py, _nt.Array[np.int64])
...
assert_type(i_py @ i2_nd, _nt.Array[np.int64])
...
assert_type(i4_nd @ i_py, _nt.Array[np.int64])
...
assert_type(i_py @ i4_nd, _nt.Array[np.int64])
...
assert_type(u1_nd @ i_py, _nt.Array[np.int64])
...
assert_type(i_py @ u1_nd, _nt.Array[np.int64])
...
assert_type(u2_nd @ i_py, _nt.Array[np.int64])
...
assert_type(i_py @ u2_nd, _nt.Array[np.int64])
...
assert_type(u4_nd @ i_py, _nt.Array[np.int64])
...
assert_type(i_py @ u4_nd, _nt.Array[np.int64])
...
assert_type(f2_nd @ i_py, _nt.Array[np.float64])
assert_type(f2_nd @ f_py, _nt.Array[np.float64])
assert_type(f2_nd @ c_py, _nt.Array[np.complex128])

assert_type(b_py @ f2_nd, _nt.Array[np.float16])
assert_type(i_py @ f2_nd, _nt.Array[np.float64])
assert_type(f_py @ f2_nd, _nt.Array[np.float64])
assert_type(c_py @ f2_nd, _nt.Array[np.complex128])
...
assert_type(f4_nd @ i_py, _nt.Array[np.float64])
assert_type(f4_nd @ f_py, _nt.Array[np.float64])
assert_type(f4_nd @ c_py, _nt.Array[np.complex128])

assert_type(b_py @ f4_nd, _nt.Array[np.float32])
assert_type(i_py @ f4_nd, _nt.Array[np.float64])
assert_type(f_py @ f4_nd, _nt.Array[np.float64])
assert_type(c_py @ f4_nd, _nt.Array[np.complex128])
...
assert_type(c8_nd @ i_py, _nt.Array[np.complex128])
assert_type(c8_nd @ f_py, _nt.Array[np.complex128])
assert_type(c8_nd @ c_py, _nt.Array[np.complex128])

assert_type(b_py @ c8_nd, _nt.Array[np.complex64])
assert_type(i_py @ c8_nd, _nt.Array[np.complex128])
assert_type(f_py @ c8_nd, _nt.Array[np.complex128])
assert_type(c_py @ c8_nd, _nt.Array[np.complex128])
...
assert_type(i_nd @ i_py, _nt.Array[np.int64])
...
assert_type(i_py @ i_nd, _nt.Array[np.int64])
...
assert_type(u_nd @ i_py, _nt.Array[np.int64 | np.float64])
...
assert_type(i_py @ u_nd, _nt.Array[np.int64 | np.float64])
...
assert_type(iu_nd @ i_py, _nt.Array[np.int64 | np.float64])
...
assert_type(i_py @ iu_nd, _nt.Array[np.int64 | np.float64])
