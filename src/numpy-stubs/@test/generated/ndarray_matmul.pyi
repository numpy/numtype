...
b_py: list[list[bool]]
i_py: list[list[int]]
f_py: list[list[float]]
c_py: list[list[complex]]
...
assert_type(i1_nd @ i_py, npt.NDArray[np.int64])
...
assert_type(i_py @ i1_nd, npt.NDArray[np.int64])
...
assert_type(i2_nd @ i_py, npt.NDArray[np.int64])
...
assert_type(i_py @ i2_nd, npt.NDArray[np.int64])
...
assert_type(i4_nd @ i_py, npt.NDArray[np.int64])
...
assert_type(i_py @ i4_nd, npt.NDArray[np.int64])
...
assert_type(u1_nd @ i_py, npt.NDArray[np.int64])
...
assert_type(i_py @ u1_nd, npt.NDArray[np.int64])
...
assert_type(u2_nd @ i_py, npt.NDArray[np.int64])
...
assert_type(i_py @ u2_nd, npt.NDArray[np.int64])
...
assert_type(u4_nd @ i_py, npt.NDArray[np.int64])
...
assert_type(i_py @ u4_nd, npt.NDArray[np.int64])
...
assert_type(f2_nd @ i_py, npt.NDArray[np.float64])
assert_type(f2_nd @ f_py, npt.NDArray[np.float64])
assert_type(f2_nd @ c_py, npt.NDArray[np.complex128])

assert_type(b_py @ f2_nd, npt.NDArray[np.float16])
assert_type(i_py @ f2_nd, npt.NDArray[np.float64])
assert_type(f_py @ f2_nd, npt.NDArray[np.float64])
assert_type(c_py @ f2_nd, npt.NDArray[np.complex128])
...
assert_type(f4_nd @ i_py, npt.NDArray[np.float64])
assert_type(f4_nd @ f_py, npt.NDArray[np.float64])
assert_type(f4_nd @ c_py, npt.NDArray[np.complex128])

assert_type(b_py @ f4_nd, npt.NDArray[np.float32])
assert_type(i_py @ f4_nd, npt.NDArray[np.float64])
assert_type(f_py @ f4_nd, npt.NDArray[np.float64])
assert_type(c_py @ f4_nd, npt.NDArray[np.complex128])
...
assert_type(c8_nd @ i_py, npt.NDArray[np.complex128])
assert_type(c8_nd @ f_py, npt.NDArray[np.complex128])
assert_type(c8_nd @ c_py, npt.NDArray[np.complex128])

assert_type(b_py @ c8_nd, npt.NDArray[np.complex64])
assert_type(i_py @ c8_nd, npt.NDArray[np.complex128])
assert_type(f_py @ c8_nd, npt.NDArray[np.complex128])
assert_type(c_py @ c8_nd, npt.NDArray[np.complex128])
...
assert_type(i_nd @ i_py, npt.NDArray[np.int64])
...
assert_type(i_py @ i_nd, npt.NDArray[np.int64])
...
assert_type(u_nd @ i_py, npt.NDArray[np.int64 | np.float64])
...
assert_type(i_py @ u_nd, npt.NDArray[np.int64 | np.float64])
...
assert_type(iu_nd @ i_py, npt.NDArray[np.int64 | np.float64])
...
assert_type(i_py @ iu_nd, npt.NDArray[np.int64 | np.float64])
