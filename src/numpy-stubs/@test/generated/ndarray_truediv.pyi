...
assert_type(b1_nd / b1_nd, _nt.Array[np.float64])
assert_type(b1_nd / i1_nd, _nt.Array[np.float64])
assert_type(b1_nd / i2_nd, _nt.Array[np.float64])
assert_type(b1_nd / i4_nd, _nt.Array[np.float64])
assert_type(b1_nd / i8_nd, _nt.Array[np.float64])
assert_type(b1_nd / u1_nd, _nt.Array[np.float64])
assert_type(b1_nd / u2_nd, _nt.Array[np.float64])
assert_type(b1_nd / u4_nd, _nt.Array[np.float64])
assert_type(b1_nd / u8_nd, _nt.Array[np.float64])
...
assert_type(b1_nd / i_nd, _nt.Array[np.float64])
assert_type(b1_nd / u_nd, _nt.Array[np.float64])
assert_type(b1_nd / f_nd, _nt.Array[np.floating])
assert_type(b1_nd / c_nd, _nt.Array[np.complexfloating])
assert_type(b1_nd / iu_nd, _nt.Array[np.float64])
assert_type(b1_nd / fc_nd, _nt.Array[np.inexact])
assert_type(b1_nd / iufc_nd, _nt.Array[np.inexact])

assert_type(b1_nd / b_py, _nt.Array[np.float64])
assert_type(b1_nd / i_py, _nt.Array[np.float64])
assert_type(b1_nd / f_py, _nt.Array[np.float64])
assert_type(b1_nd / c_py, _nt.Array[np.complex128])

assert_type(b_py / b1_nd, _nt.Array[np.float64])
assert_type(i_py / b1_nd, _nt.Array[np.float64])
assert_type(f_py / b1_nd, _nt.Array[np.float64])
assert_type(c_py / b1_nd, _nt.Array[np.complex128])

assert_type(i1_nd / b1_nd, _nt.Array[np.float64])
assert_type(i1_nd / i1_nd, _nt.Array[np.float64])
assert_type(i1_nd / i2_nd, _nt.Array[np.float64])
assert_type(i1_nd / i4_nd, _nt.Array[np.float64])
assert_type(i1_nd / i8_nd, _nt.Array[np.float64])
assert_type(i1_nd / u1_nd, _nt.Array[np.float64])
assert_type(i1_nd / u2_nd, _nt.Array[np.float64])
assert_type(i1_nd / u4_nd, _nt.Array[np.float64])
...
assert_type(i1_nd / i_nd, _nt.Array[np.float64])
assert_type(i1_nd / u_nd, _nt.Array[np.float64])
assert_type(i1_nd / f_nd, _nt.Array[np.floating])
assert_type(i1_nd / c_nd, _nt.Array[np.complexfloating])
assert_type(i1_nd / iu_nd, _nt.Array[np.float64])
assert_type(i1_nd / fc_nd, _nt.Array[np.inexact])
assert_type(i1_nd / iufc_nd, _nt.Array[np.inexact])

assert_type(i1_nd / b_py, _nt.Array[np.float64])
assert_type(i1_nd / i_py, _nt.Array[np.float64])
assert_type(i1_nd / f_py, _nt.Array[np.float64])
assert_type(i1_nd / c_py, _nt.Array[np.complex128])

assert_type(b_py / i1_nd, _nt.Array[np.float64])
assert_type(i_py / i1_nd, _nt.Array[np.float64])
assert_type(f_py / i1_nd, _nt.Array[np.float64])
assert_type(c_py / i1_nd, _nt.Array[np.complex128])

assert_type(i2_nd / b1_nd, _nt.Array[np.float64])
assert_type(i2_nd / i1_nd, _nt.Array[np.float64])
assert_type(i2_nd / i2_nd, _nt.Array[np.float64])
assert_type(i2_nd / i4_nd, _nt.Array[np.float64])
assert_type(i2_nd / i8_nd, _nt.Array[np.float64])
assert_type(i2_nd / u1_nd, _nt.Array[np.float64])
assert_type(i2_nd / u2_nd, _nt.Array[np.float64])
assert_type(i2_nd / u4_nd, _nt.Array[np.float64])
...
assert_type(i2_nd / i_nd, _nt.Array[np.float64])
assert_type(i2_nd / u_nd, _nt.Array[np.float64])
assert_type(i2_nd / f_nd, _nt.Array[np.floating])
assert_type(i2_nd / c_nd, _nt.Array[np.complexfloating])
assert_type(i2_nd / iu_nd, _nt.Array[np.float64])
assert_type(i2_nd / fc_nd, _nt.Array[np.inexact])
assert_type(i2_nd / iufc_nd, _nt.Array[np.inexact])

assert_type(i2_nd / b_py, _nt.Array[np.float64])
assert_type(i2_nd / i_py, _nt.Array[np.float64])
assert_type(i2_nd / f_py, _nt.Array[np.float64])
assert_type(i2_nd / c_py, _nt.Array[np.complex128])

assert_type(b_py / i2_nd, _nt.Array[np.float64])
assert_type(i_py / i2_nd, _nt.Array[np.float64])
assert_type(f_py / i2_nd, _nt.Array[np.float64])
assert_type(c_py / i2_nd, _nt.Array[np.complex128])

assert_type(i4_nd / b1_nd, _nt.Array[np.float64])
assert_type(i4_nd / i1_nd, _nt.Array[np.float64])
assert_type(i4_nd / i2_nd, _nt.Array[np.float64])
assert_type(i4_nd / i4_nd, _nt.Array[np.float64])
assert_type(i4_nd / i8_nd, _nt.Array[np.float64])
assert_type(i4_nd / u1_nd, _nt.Array[np.float64])
assert_type(i4_nd / u2_nd, _nt.Array[np.float64])
assert_type(i4_nd / u4_nd, _nt.Array[np.float64])
...
assert_type(i4_nd / i_nd, _nt.Array[np.float64])
assert_type(i4_nd / u_nd, _nt.Array[np.float64])
assert_type(i4_nd / f_nd, _nt.Array[np.floating])
assert_type(i4_nd / c_nd, _nt.Array[np.complexfloating])
assert_type(i4_nd / iu_nd, _nt.Array[np.float64])
assert_type(i4_nd / fc_nd, _nt.Array[np.inexact])
assert_type(i4_nd / iufc_nd, _nt.Array[np.inexact])

assert_type(i4_nd / b_py, _nt.Array[np.float64])
assert_type(i4_nd / i_py, _nt.Array[np.float64])
assert_type(i4_nd / f_py, _nt.Array[np.float64])
assert_type(i4_nd / c_py, _nt.Array[np.complex128])

assert_type(b_py / i4_nd, _nt.Array[np.float64])
assert_type(i_py / i4_nd, _nt.Array[np.float64])
assert_type(f_py / i4_nd, _nt.Array[np.float64])
assert_type(c_py / i4_nd, _nt.Array[np.complex128])

assert_type(i8_nd / b1_nd, _nt.Array[np.float64])
assert_type(i8_nd / i1_nd, _nt.Array[np.float64])
assert_type(i8_nd / i2_nd, _nt.Array[np.float64])
assert_type(i8_nd / i4_nd, _nt.Array[np.float64])
assert_type(i8_nd / i8_nd, _nt.Array[np.float64])
assert_type(i8_nd / u1_nd, _nt.Array[np.float64])
assert_type(i8_nd / u2_nd, _nt.Array[np.float64])
assert_type(i8_nd / u4_nd, _nt.Array[np.float64])
...
assert_type(i8_nd / i_nd, _nt.Array[np.float64])
assert_type(i8_nd / u_nd, _nt.Array[np.float64])
assert_type(i8_nd / f_nd, _nt.Array[np.floating])
assert_type(i8_nd / c_nd, _nt.Array[np.complexfloating])
assert_type(i8_nd / iu_nd, _nt.Array[np.float64])
assert_type(i8_nd / fc_nd, _nt.Array[np.inexact])
assert_type(i8_nd / iufc_nd, _nt.Array[np.inexact])

assert_type(i8_nd / b_py, _nt.Array[np.float64])
assert_type(i8_nd / i_py, _nt.Array[np.float64])
assert_type(i8_nd / f_py, _nt.Array[np.float64])
assert_type(i8_nd / c_py, _nt.Array[np.complex128])

assert_type(b_py / i8_nd, _nt.Array[np.float64])
assert_type(i_py / i8_nd, _nt.Array[np.float64])
assert_type(f_py / i8_nd, _nt.Array[np.float64])
assert_type(c_py / i8_nd, _nt.Array[np.complex128])

assert_type(u1_nd / b1_nd, _nt.Array[np.float64])
assert_type(u1_nd / i1_nd, _nt.Array[np.float64])
assert_type(u1_nd / i2_nd, _nt.Array[np.float64])
assert_type(u1_nd / i4_nd, _nt.Array[np.float64])
assert_type(u1_nd / i8_nd, _nt.Array[np.float64])
assert_type(u1_nd / u1_nd, _nt.Array[np.float64])
assert_type(u1_nd / u2_nd, _nt.Array[np.float64])
assert_type(u1_nd / u4_nd, _nt.Array[np.float64])
assert_type(u1_nd / u8_nd, _nt.Array[np.float64])
...
assert_type(u1_nd / i_nd, _nt.Array[np.float64])
assert_type(u1_nd / u_nd, _nt.Array[np.float64])
assert_type(u1_nd / f_nd, _nt.Array[np.floating])
assert_type(u1_nd / c_nd, _nt.Array[np.complexfloating])
assert_type(u1_nd / iu_nd, _nt.Array[np.float64])
assert_type(u1_nd / fc_nd, _nt.Array[np.inexact])
assert_type(u1_nd / iufc_nd, _nt.Array[np.inexact])

assert_type(u1_nd / b_py, _nt.Array[np.float64])
assert_type(u1_nd / i_py, _nt.Array[np.float64])
assert_type(u1_nd / f_py, _nt.Array[np.float64])
assert_type(u1_nd / c_py, _nt.Array[np.complex128])

assert_type(b_py / u1_nd, _nt.Array[np.float64])
assert_type(i_py / u1_nd, _nt.Array[np.float64])
assert_type(f_py / u1_nd, _nt.Array[np.float64])
assert_type(c_py / u1_nd, _nt.Array[np.complex128])

assert_type(u2_nd / b1_nd, _nt.Array[np.float64])
assert_type(u2_nd / i1_nd, _nt.Array[np.float64])
assert_type(u2_nd / i2_nd, _nt.Array[np.float64])
assert_type(u2_nd / i4_nd, _nt.Array[np.float64])
assert_type(u2_nd / i8_nd, _nt.Array[np.float64])
assert_type(u2_nd / u1_nd, _nt.Array[np.float64])
assert_type(u2_nd / u2_nd, _nt.Array[np.float64])
assert_type(u2_nd / u4_nd, _nt.Array[np.float64])
assert_type(u2_nd / u8_nd, _nt.Array[np.float64])
...
assert_type(u2_nd / i_nd, _nt.Array[np.float64])
assert_type(u2_nd / u_nd, _nt.Array[np.float64])
assert_type(u2_nd / f_nd, _nt.Array[np.floating])
assert_type(u2_nd / c_nd, _nt.Array[np.complexfloating])
assert_type(u2_nd / iu_nd, _nt.Array[np.float64])
assert_type(u2_nd / fc_nd, _nt.Array[np.inexact])
assert_type(u2_nd / iufc_nd, _nt.Array[np.inexact])

assert_type(u2_nd / b_py, _nt.Array[np.float64])
assert_type(u2_nd / i_py, _nt.Array[np.float64])
assert_type(u2_nd / f_py, _nt.Array[np.float64])
assert_type(u2_nd / c_py, _nt.Array[np.complex128])

assert_type(b_py / u2_nd, _nt.Array[np.float64])
assert_type(i_py / u2_nd, _nt.Array[np.float64])
assert_type(f_py / u2_nd, _nt.Array[np.float64])
assert_type(c_py / u2_nd, _nt.Array[np.complex128])

assert_type(u4_nd / b1_nd, _nt.Array[np.float64])
assert_type(u4_nd / i1_nd, _nt.Array[np.float64])
assert_type(u4_nd / i2_nd, _nt.Array[np.float64])
assert_type(u4_nd / i4_nd, _nt.Array[np.float64])
assert_type(u4_nd / i8_nd, _nt.Array[np.float64])
assert_type(u4_nd / u1_nd, _nt.Array[np.float64])
assert_type(u4_nd / u2_nd, _nt.Array[np.float64])
assert_type(u4_nd / u4_nd, _nt.Array[np.float64])
assert_type(u4_nd / u8_nd, _nt.Array[np.float64])
...
assert_type(u4_nd / i_nd, _nt.Array[np.float64])
assert_type(u4_nd / u_nd, _nt.Array[np.float64])
assert_type(u4_nd / f_nd, _nt.Array[np.floating])
assert_type(u4_nd / c_nd, _nt.Array[np.complexfloating])
assert_type(u4_nd / iu_nd, _nt.Array[np.float64])
assert_type(u4_nd / fc_nd, _nt.Array[np.inexact])
assert_type(u4_nd / iufc_nd, _nt.Array[np.inexact])

assert_type(u4_nd / b_py, _nt.Array[np.float64])
assert_type(u4_nd / i_py, _nt.Array[np.float64])
assert_type(u4_nd / f_py, _nt.Array[np.float64])
assert_type(u4_nd / c_py, _nt.Array[np.complex128])

assert_type(b_py / u4_nd, _nt.Array[np.float64])
assert_type(i_py / u4_nd, _nt.Array[np.float64])
assert_type(f_py / u4_nd, _nt.Array[np.float64])
assert_type(c_py / u4_nd, _nt.Array[np.complex128])

assert_type(u8_nd / b1_nd, _nt.Array[np.float64])
...
assert_type(u8_nd / u1_nd, _nt.Array[np.float64])
assert_type(u8_nd / u2_nd, _nt.Array[np.float64])
assert_type(u8_nd / u4_nd, _nt.Array[np.float64])
assert_type(u8_nd / u8_nd, _nt.Array[np.float64])
...
assert_type(u8_nd / u_nd, _nt.Array[np.float64])
assert_type(u8_nd / f_nd, _nt.Array[np.floating])
assert_type(u8_nd / c_nd, _nt.Array[np.complexfloating])
assert_type(u8_nd / iu_nd, _nt.Array[np.float64])
assert_type(u8_nd / fc_nd, _nt.Array[np.inexact])
assert_type(u8_nd / iufc_nd, _nt.Array[np.inexact])

assert_type(u8_nd / b_py, _nt.Array[np.float64])
assert_type(u8_nd / i_py, _nt.Array[np.float64])
assert_type(u8_nd / f_py, _nt.Array[np.float64])
assert_type(u8_nd / c_py, _nt.Array[np.complex128])

assert_type(b_py / u8_nd, _nt.Array[np.float64])
assert_type(i_py / u8_nd, _nt.Array[np.float64])
...
assert_type(m8_nd / m8_nd, _nt.Array[np.float64])
...
assert_type(i_nd / b1_nd, _nt.Array[np.float64])
assert_type(i_nd / i1_nd, _nt.Array[np.float64])
assert_type(i_nd / i2_nd, _nt.Array[np.float64])
assert_type(i_nd / i4_nd, _nt.Array[np.float64])
assert_type(i_nd / i8_nd, _nt.Array[np.float64])
assert_type(i_nd / u1_nd, _nt.Array[np.float64])
assert_type(i_nd / u2_nd, _nt.Array[np.float64])
assert_type(i_nd / u4_nd, _nt.Array[np.float64])
...
assert_type(i_nd / i_nd, _nt.Array[np.float64])
assert_type(i_nd / u_nd, _nt.Array[np.float64])
assert_type(i_nd / f_nd, _nt.Array[np.floating])
assert_type(i_nd / c_nd, _nt.Array[np.complexfloating])
assert_type(i_nd / iu_nd, _nt.Array[np.float64])
assert_type(i_nd / fc_nd, _nt.Array[np.inexact])
assert_type(i_nd / iufc_nd, _nt.Array[np.inexact])

assert_type(i_nd / b_py, _nt.Array[np.float64])
assert_type(i_nd / i_py, _nt.Array[np.float64])
assert_type(i_nd / f_py, _nt.Array[np.float64])
assert_type(i_nd / c_py, _nt.Array[np.complex128])

assert_type(b_py / i_nd, _nt.Array[np.float64])
assert_type(i_py / i_nd, _nt.Array[np.float64])
assert_type(f_py / i_nd, _nt.Array[np.float64])
assert_type(c_py / i_nd, _nt.Array[np.complex128])

assert_type(u_nd / b1_nd, _nt.Array[np.float64])
assert_type(u_nd / i1_nd, _nt.Array[np.float64])
assert_type(u_nd / i2_nd, _nt.Array[np.float64])
assert_type(u_nd / i4_nd, _nt.Array[np.float64])
assert_type(u_nd / i8_nd, _nt.Array[np.float64])
assert_type(u_nd / u1_nd, _nt.Array[np.float64])
assert_type(u_nd / u2_nd, _nt.Array[np.float64])
assert_type(u_nd / u4_nd, _nt.Array[np.float64])
assert_type(u_nd / u8_nd, _nt.Array[np.float64])
...
assert_type(u_nd / i_nd, _nt.Array[np.float64])
assert_type(u_nd / u_nd, _nt.Array[np.float64])
assert_type(u_nd / f_nd, _nt.Array[np.floating])
assert_type(u_nd / c_nd, _nt.Array[np.complexfloating])
assert_type(u_nd / iu_nd, _nt.Array[np.float64])
assert_type(u_nd / fc_nd, _nt.Array[np.inexact])
assert_type(u_nd / iufc_nd, _nt.Array[np.inexact])

assert_type(u_nd / b_py, _nt.Array[np.float64])
assert_type(u_nd / i_py, _nt.Array[np.float64])
assert_type(u_nd / f_py, _nt.Array[np.float64])
assert_type(u_nd / c_py, _nt.Array[np.complex128])

assert_type(b_py / u_nd, _nt.Array[np.float64])
assert_type(i_py / u_nd, _nt.Array[np.float64])
...
assert_type(iu_nd / b1_nd, _nt.Array[np.float64])
assert_type(iu_nd / i1_nd, _nt.Array[np.float64])
assert_type(iu_nd / i2_nd, _nt.Array[np.float64])
assert_type(iu_nd / i4_nd, _nt.Array[np.float64])
assert_type(iu_nd / i8_nd, _nt.Array[np.float64])
assert_type(iu_nd / u1_nd, _nt.Array[np.float64])
assert_type(iu_nd / u2_nd, _nt.Array[np.float64])
assert_type(iu_nd / u4_nd, _nt.Array[np.float64])
assert_type(iu_nd / u8_nd, _nt.Array[np.float64])
...
assert_type(iu_nd / i_nd, _nt.Array[np.float64])
assert_type(iu_nd / u_nd, _nt.Array[np.float64])
assert_type(iu_nd / f_nd, _nt.Array[np.floating])
assert_type(iu_nd / c_nd, _nt.Array[np.complexfloating])
assert_type(iu_nd / iu_nd, _nt.Array[np.float64])
assert_type(iu_nd / fc_nd, _nt.Array[np.inexact])
assert_type(iu_nd / iufc_nd, _nt.Array[np.inexact])

assert_type(iu_nd / b_py, _nt.Array[np.float64])
assert_type(iu_nd / i_py, _nt.Array[np.float64])
assert_type(iu_nd / f_py, _nt.Array[np.float64])
assert_type(iu_nd / c_py, _nt.Array[np.complex128])

assert_type(b_py / iu_nd, _nt.Array[np.float64])
assert_type(i_py / iu_nd, _nt.Array[np.float64])
...
assert_type(iufc_nd / b1_nd, _nt.Array[np.inexact])
assert_type(iufc_nd / i1_nd, _nt.Array[np.inexact])
assert_type(iufc_nd / i2_nd, _nt.Array[np.inexact])
assert_type(iufc_nd / i4_nd, _nt.Array[np.inexact])
assert_type(iufc_nd / i8_nd, _nt.Array[np.inexact])
assert_type(iufc_nd / u1_nd, _nt.Array[np.inexact])
assert_type(iufc_nd / u2_nd, _nt.Array[np.inexact])
assert_type(iufc_nd / u4_nd, _nt.Array[np.inexact])
assert_type(iufc_nd / u8_nd, _nt.Array[np.inexact])
...
assert_type(iufc_nd / i_nd, _nt.Array[np.inexact])
assert_type(iufc_nd / u_nd, _nt.Array[np.inexact])
assert_type(iufc_nd / f_nd, _nt.Array[np.inexact])
assert_type(iufc_nd / c_nd, _nt.Array[np.complexfloating])
assert_type(iufc_nd / iu_nd, _nt.Array[np.inexact])
assert_type(iufc_nd / fc_nd, _nt.Array[np.inexact])
assert_type(iufc_nd / iufc_nd, _nt.Array[np.inexact])

assert_type(iufc_nd / b_py, _nt.Array[np.inexact])
assert_type(iufc_nd / i_py, _nt.Array[np.inexact])
assert_type(iufc_nd / f_py, _nt.Array[np.inexact])
assert_type(iufc_nd / c_py, _nt.Array[np.complexfloating])

assert_type(b_py / iufc_nd, _nt.Array[np.inexact])
assert_type(i_py / iufc_nd, _nt.Array[np.inexact])
