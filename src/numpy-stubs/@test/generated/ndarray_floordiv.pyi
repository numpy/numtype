...
assert_type(m8_nd // f2_nd, _nt.Array[np.timedelta64])
assert_type(m8_nd // f4_nd, _nt.Array[np.timedelta64])
assert_type(m8_nd // f8_nd, _nt.Array[np.timedelta64])
assert_type(m8_nd // fld_nd, _nt.Array[np.timedelta64])
m8_nd // c16_nd  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
assert_type(m8_nd // m8_nd, _nt.Array[np.int64])
assert_type(m8_nd // i_nd, _nt.Array[np.timedelta64])
assert_type(m8_nd // u_nd, _nt.Array[np.timedelta64])
assert_type(m8_nd // f_nd, _nt.Array[np.timedelta64])
...
assert_type(m8_nd // f_py, _nt.Array[np.timedelta64])
