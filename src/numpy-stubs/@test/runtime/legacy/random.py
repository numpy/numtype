...
SEED_NONE: Final[None] = None
SEED_INT: Final[int] = 4579435749574957634658964293569
SEED_ARR: Final[npt.NDArray[np.int64]] = np.array([1, 2, 3, 4], dtype=np.int64)
SEED_ARRLIKE: Final[list[int]] = [1, 2, 3, 4]
SEED_SEED_SEQ: Final[np.random.SeedSequence] = np.random.SeedSequence(0)
SEED_MT19937: Final[np.random.MT19937] = np.random.MT19937(0)
SEED_PCG64: Final[np.random.PCG64] = np.random.PCG64(0)
SEED_PHILOX: Final[np.random.Philox] = np.random.Philox(0)
SEED_SFC64: Final[np.random.SFC64] = np.random.SFC64(0)
