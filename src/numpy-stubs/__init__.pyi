...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeT_co, _DTypeT_co]):
    ...
    @overload
    def __add__(self: _nt.CastsWithInt[_ScalarT], x: _PyIntND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __add__(self: _nt.CastsWithFloat[_ScalarT], x: _PyFloatND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __add__(self: _nt.CastsWithComplex[_ScalarT], x: _PyComplexND, /) -> NDArray[_ScalarT]: ...
    @overload
    ...
    @overload
    def __add__(self: NDArray[generic[_T]], x: _nt.Sequence1ND[_nt.op.CanRAdd[_T]], /) -> NDArray[Incomplete]: ...
    ...
    @overload
    def __radd__(self: _nt.CastsWithInt[_ScalarT], x: _PyIntND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __radd__(self: _nt.CastsWithFloat[_ScalarT], x: _PyFloatND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __radd__(self: _nt.CastsWithComplex[_ScalarT], x: _PyComplexND, /) -> NDArray[_ScalarT]: ...
    @overload
    ...
    @overload
    def __radd__(self: NDArray[generic[_T]], x: _nt.Sequence1ND[_nt.op.CanAdd[_T]], /) -> NDArray[Incomplete]: ...

    #
    @overload  # type: ignore[misc]
    def __iadd__(self: NDArray[_ScalarT], x: _nt.Casts[_ScalarT], /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __iadd__(self: NDArray[bool_], x: _PyBoolND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __iadd__(self: NDArray[number], x: _PyCoIntND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __iadd__(self: NDArray[inexact], x: _PyCoFloatND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __iadd__(self: NDArray[complexfloating], x: _PyCoComplexND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __iadd__(self: NDArray[datetime64], x: _nt.CoTimeDelta_nd, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    ...
    @overload
    def __sub__(self: _nt.CastsWithInt[_ScalarT], x: _PyIntND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __sub__(self: _nt.CastsWithFloat[_ScalarT], x: _PyFloatND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __sub__(self: _nt.CastsWithComplex[_ScalarT], x: _PyComplexND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __sub__(self: NDArray[datetime64], x: _nt.ToDateTime_nd, /) -> NDArray[timedelta64]: ...
    @overload
    ...
    @overload
    def __rsub__(self: _nt.CastsWithInt[_ScalarT], x: _PyIntND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __rsub__(self: _nt.CastsWithFloat[_ScalarT], x: _PyFloatND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __rsub__(self: _nt.CastsWithComplex[_ScalarT], x: _PyComplexND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __rsub__(self: NDArray[datetime64], x: _nt.ToDateTime_nd, /) -> NDArray[timedelta64]: ...
    @overload
    ...
    @overload
    def __isub__(self: NDArray[number], x: _PyCoIntND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __isub__(self: NDArray[inexact], x: _PyCoFloatND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __isub__(self: NDArray[complexfloating], x: _PyCoComplexND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    ...
    #
    @overload
    def __mul__(self: NDArray[_CoNumberT], x: _nt.Casts[_CoNumberT], /) -> NDArray[_CoNumberT]: ...
    @overload
    def __mul__(self: NDArray[_SelfScalarT], x: _nt.CastsWith[_SelfScalarT, _ScalarT], /) -> NDArray[_ScalarT]: ...  # type: ignore[overload-overlap]
    @overload
    def __mul__(self: _nt.CastsWithBuiltin[_T, _ScalarT], x: _nt.SequenceND[_T], /) -> NDArray[_ScalarT]: ...
    @overload
    def __mul__(self: _nt.CastsWithInt[_ScalarT], x: _PyCoIntND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __mul__(self: _nt.CastsWithFloat[_ScalarT], x: _PyFloatND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __mul__(self: _nt.CastsWithComplex[_ScalarT], x: _PyComplexND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __mul__(self: NDArray[timedelta64], x: _nt.ToFloating_nd, /) -> NDArray[timedelta64]: ...
    @overload
    def __mul__(self: NDArray[object_], x: object, /) -> NDArray[object_]: ...  # type: ignore[overload-cannot-match]
    @overload
    def __mul__(self: NDArray[integer], x: _nt.ToString_nd, /) -> _nt.StringArrayND[_T]: ...
    @overload
    def __mul__(self: _nt.StringArrayND[_T], x: _nt.ToInteger_nd, /) -> _nt.StringArrayND[_T]: ...
    @overload
    def __mul__(self: NDArray[generic[_T]], x: _nt.Sequence1ND[_nt.op.CanRMul[_T]], /) -> NDArray[Incomplete]: ...

    #
    @overload
    def __rmul__(self: NDArray[_CoNumberT], x: _nt.Casts[_CoNumberT], /) -> NDArray[_CoNumberT]: ...
    @overload
    def __rmul__(self: NDArray[_SelfScalarT], x: _nt.CastsWith[_SelfScalarT, _ScalarT], /) -> NDArray[_ScalarT]: ...  # type: ignore[overload-overlap]
    @overload
    def __rmul__(self: _nt.CastsWithBuiltin[_T, _ScalarT], x: _nt.SequenceND[_T], /) -> NDArray[_ScalarT]: ...
    @overload
    def __rmul__(self: _nt.CastsWithInt[_ScalarT], x: _PyCoIntND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __rmul__(self: _nt.CastsWithFloat[_ScalarT], x: _PyFloatND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __rmul__(self: _nt.CastsWithComplex[_ScalarT], x: _PyComplexND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __rmul__(self: NDArray[timedelta64], x: _nt.ToFloating_nd, /) -> NDArray[timedelta64]: ...
    @overload
    def __rmul__(self: NDArray[object_], x: object, /) -> NDArray[object_]: ...  # type: ignore[overload-cannot-match]
    @overload
    def __rmul__(self: NDArray[integer], x: _nt.ToString_nd, /) -> _nt.StringArrayND[_T]: ...
    @overload
    def __rmul__(self: _nt.StringArrayND[_T], x: _nt.ToInteger_nd, /) -> _nt.StringArrayND[_T]: ...
    @overload
    def __rmul__(self: NDArray[generic[_T]], x: _nt.Sequence1ND[_nt.op.CanMul[_T]], /) -> NDArray[Incomplete]: ...

    #
    @overload  # type: ignore[misc]
    def __imul__(self: NDArray[_CoNumberT], x: _nt.Casts[_CoNumberT], /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __imul__(self: NDArray[bool_], x: _PyBoolND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __imul__(self: NDArray[number], x: _PyCoIntND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __imul__(self: NDArray[inexact], x: _PyCoFloatND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __imul__(self: NDArray[complexfloating], x: _PyCoComplexND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __imul__(self: NDArray[timedelta64], x: _nt.CoFloating_nd, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __imul__(self: NDArray[object_], x: object, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __imul__(self: _nt.StringArrayND[_T], x: _nt.ToInteger_nd, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __imul__(
        self: NDArray[generic[_T]], x: _nt.Sequence1ND[_nt.op.CanRMul[_T, _T]], /
    ) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    ...
    @overload
    def __matmul__(self: NDArray[_CoNumberT], x: _nt.CastsArray[_CoNumberT], /) -> NDArray[_CoNumberT]: ...
    @overload
    def __matmul__(self: NDArray[_CoNumberT], x: _nt.CastsWithArray[_CoNumberT, _ScalarT], /) -> NDArray[_ScalarT]: ...
    @overload
    def __matmul__(self: NDArray[_CoNumberT], x: _nt.Sequence1ND[py_bool], /) -> NDArray[_CoNumberT]: ...
    @overload
    def __matmul__(self: NDArray[_nt.co_int64], x: _nt.Sequence1ND[_nt.JustInt], /) -> NDArray[intp]: ...
    @overload
    def __matmul__(
        self: _HasDType[_HasType[_JustUnsignedInteger | _JustInteger]], x: _nt.Sequence1ND[_nt.JustInt], /
    ) -> NDArray[intp | float64]: ...
    @overload
    def __matmul__(self: NDArray[uint64 | _float64_max], x: _nt.Sequence1ND[float], /) -> NDArray[float64]: ...
    @overload
    def __matmul__(self: NDArray[_complex128_max], x: _nt.Sequence1ND[complex], /) -> NDArray[complex128]: ...
    @overload
    def __matmul__(self: NDArray[_inexact64_max], x: _nt.Sequence1ND[_nt.JustComplex], /) -> NDArray[complex128]: ...
    @overload
    def __matmul__(self: _nt.CastsWithInt[_ScalarT], x: _nt.Sequence1ND[_nt.JustInt], /) -> NDArray[_ScalarT]: ...
    @overload
    def __matmul__(self: _nt.CastsWithFloat[_ScalarT], x: _nt.Sequence1ND[_nt.JustFloat], /) -> NDArray[_ScalarT]: ...
    @overload
    def __matmul__(
        self: _nt.CastsWithComplex[_ScalarT], x: _nt.Sequence1ND[_nt.JustComplex], /
    ) -> NDArray[_ScalarT]: ...
    @overload
    def __matmul__(self: NDArray[object_], x: _nt.ToObject_1nd | _nt.Sequence1ND[object], /) -> NDArray[object_]: ...

    # keep in sync with __matmul__
    @overload
    def __rmatmul__(self: NDArray[_CoNumberT], x: _nt.CastsArray[_CoNumberT], /) -> NDArray[_CoNumberT]: ...
    @overload
    def __rmatmul__(self: NDArray[_CoNumberT], x: _nt.CastsWithArray[_CoNumberT, _ScalarT], /) -> NDArray[_ScalarT]: ...
    @overload
    def __rmatmul__(self: NDArray[_CoNumberT], x: _nt.Sequence1ND[py_bool], /) -> NDArray[_CoNumberT]: ...
    @overload
    def __rmatmul__(self: NDArray[_nt.co_int64], x: _nt.Sequence1ND[_nt.JustInt], /) -> NDArray[intp]: ...
    @overload
    def __rmatmul__(
        self: _HasDType[_HasType[_JustUnsignedInteger | _JustInteger]], x: _nt.Sequence1ND[_nt.JustInt], /
    ) -> NDArray[intp | float64]: ...
    @overload
    def __rmatmul__(self: NDArray[uint64 | _float64_max], x: _nt.Sequence1ND[float], /) -> NDArray[float64]: ...
    @overload
    def __rmatmul__(self: NDArray[_complex128_max], x: _nt.Sequence1ND[complex], /) -> NDArray[complex128]: ...
    @overload
    def __rmatmul__(self: NDArray[_inexact64_max], x: _nt.Sequence1ND[_nt.JustComplex], /) -> NDArray[complex128]: ...
    @overload
    def __rmatmul__(self: _nt.CastsWithInt[_ScalarT], x: _nt.Sequence1ND[_nt.JustInt], /) -> NDArray[_ScalarT]: ...
    @overload
    def __rmatmul__(self: _nt.CastsWithFloat[_ScalarT], x: _nt.Sequence1ND[_nt.JustFloat], /) -> NDArray[_ScalarT]: ...
    @overload
    def __rmatmul__(
        self: _nt.CastsWithComplex[_ScalarT], x: _nt.Sequence1ND[_nt.JustComplex], /
    ) -> NDArray[_ScalarT]: ...
    @overload
    def __rmatmul__(self: NDArray[object_], x: _nt.ToObject_1nd | _nt.Sequence1ND[object], /) -> NDArray[object_]: ...
    ...
    @overload
    def __pow__(self: _nt.CastsWithInt[_NumberT], x: _PyCoIntND, k: None = None, /) -> NDArray[_NumberT]: ...
    @overload
    def __pow__(self: _nt.CastsWithFloat[_ScalarT], x: _PyFloatND, k: None = None, /) -> NDArray[_ScalarT]: ...
    @overload
    def __pow__(self: _nt.CastsWithComplex[_ScalarT], x: _PyComplexND, k: None = None, /) -> NDArray[_ScalarT]: ...
    @overload
    ...
    @overload
    def __rpow__(self: _nt.CastsWithInt[_NumberT], x: _PyCoIntND, k: None = None, /) -> NDArray[_NumberT]: ...
    @overload
    def __rpow__(self: _nt.CastsWithFloat[_ScalarT], x: _PyFloatND, k: None = None, /) -> NDArray[_ScalarT]: ...
    @overload
    def __rpow__(self: _nt.CastsWithComplex[_ScalarT], x: _PyComplexND, k: None = None, /) -> NDArray[_ScalarT]: ...
    @overload
    def __rpow__(self: NDArray[object_], x: object, k: None = None, /) -> NDArray[object_]: ...

    #
    @overload  # type: ignore[misc]
    def __ipow__(self: NDArray[_NumberT], x: _nt.Casts[_NumberT], /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __ipow__(self: NDArray[number], x: _PyCoIntND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __ipow__(self: NDArray[inexact], x: _PyCoFloatND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __ipow__(self: NDArray[complexfloating], x: _PyCoComplexND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __ipow__(self: NDArray[object_], x: object, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    ...
    @overload
    def __truediv__(self: _nt.CastsWithFloat[_ScalarT], x: _PyCoFloatND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __truediv__(self: _nt.CastsWithComplex[_ScalarT], x: _PyComplexND, /) -> NDArray[_ScalarT]: ...
    @overload
    ...
    @overload
    def __rtruediv__(self: _nt.CastsWithFloat[_ScalarT], x: _PyCoFloatND, /) -> NDArray[_ScalarT]: ...
    @overload
    def __rtruediv__(self: _nt.CastsWithComplex[_ScalarT], x: _PyComplexND, /) -> NDArray[_ScalarT]: ...
    @overload
    ...
    #
    @overload  # type: ignore[misc]
    def __itruediv__(self: NDArray[_InexactT], x: _nt.Casts[_InexactT], /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __itruediv__(self: NDArray[inexact], x: _PyCoFloatND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __itruediv__(self: NDArray[complexfloating], x: _PyCoComplexND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __itruediv__(
    ...
    @overload
    def __floordiv__(self: _nt.CastsWithInt[_RealScalarT], x: _PyIntND, /) -> NDArray[_RealScalarT]: ...
    @overload
    def __floordiv__(self: _nt.CastsWithFloat[_RealScalarT], x: _PyFloatND, /) -> NDArray[_RealScalarT]: ...
    @overload
    ...
    @overload
    def __rfloordiv__(self: _nt.CastsWithInt[_RealScalarT], x: _PyIntND, /) -> NDArray[_RealScalarT]: ...
    @overload
    def __rfloordiv__(self: _nt.CastsWithFloat[_RealScalarT], x: _PyFloatND, /) -> NDArray[_RealScalarT]: ...
    @overload
    ...
    @overload
    def __ifloordiv__(self: NDArray[integer], x: _PyCoIntND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __ifloordiv__(self: NDArray[floating], x: _PyCoFloatND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __ifloordiv__(
        self: NDArray[timedelta64], x: _nt.ToInteger_nd | _nt.ToFloating_nd, /
    ) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    ...
    @overload
    def __mod__(self: _nt.CastsWithFloat[_RealScalarT], x: _PyFloatND, /) -> NDArray[_RealScalarT]: ...
    @overload
    ...
    @overload
    def __rmod__(self: _nt.CastsWithFloat[_RealScalarT], x: _PyFloatND, /) -> NDArray[_RealScalarT]: ...
    @overload
    ...
    @overload
    def __imod__(self: NDArray[integer], x: _PyCoIntND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __imod__(self: NDArray[floating], x: _PyCoFloatND, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    ...
    @overload
    def __divmod__(self: _nt.CastsWithFloat[_RealScalarT], x: _PyFloatND, /) -> _2Tuple[NDArray[_RealScalarT]]: ...
    @overload
    def __divmod__(
    ...
    @overload
    def __rdivmod__(self: _nt.CastsWithFloat[_RealScalarT], x: _PyFloatND, /) -> _2Tuple[NDArray[_RealScalarT]]: ...
    @overload
    def __rdivmod__(
        self: NDArray[timedelta64], x: _nt.ToTimeDelta_nd, /
    ) -> tuple[NDArray[int64], NDArray[timedelta64]]: ...
    ...
    #
    @overload
    def __lshift__(self: NDArray[bool_], x: _nt.ToBool_nd, /) -> NDArray[int8]: ...
    @overload
    def __lshift__(self: NDArray[bool_], x: _PyIntND, /) -> NDArray[intp]: ...
    @overload
    def __lshift__(self: NDArray[_IntegerT], x: _nt.Casts[_IntegerT] | _PyCoIntND, /) -> NDArray[_IntegerT]: ...
    @overload
    def __lshift__(self: NDArray[_IntegerT], x: _nt.CastsWith[_IntegerT, _IntegralT], /) -> NDArray[_IntegralT]: ...
    @overload
    def __lshift__(self: NDArray[object_], x: object, /) -> NDArray[object_]: ...

    #
    @overload
    def __rlshift__(self: NDArray[bool_], x: _nt.ToBool_nd, /) -> NDArray[int8]: ...
    @overload
    def __rlshift__(self: NDArray[bool_], x: _PyIntND, /) -> NDArray[intp]: ...
    @overload
    def __rlshift__(self: NDArray[_IntegerT], x: _nt.Casts[_IntegerT] | _PyCoIntND, /) -> NDArray[_IntegerT]: ...
    @overload
    def __rlshift__(self: NDArray[_IntegerT], x: _nt.CastsWith[_IntegerT, _IntegralT], /) -> NDArray[_IntegralT]: ...
    @overload
    def __rlshift__(self: NDArray[object_], x: object, /) -> NDArray[object_]: ...
    ...
    @overload
    def __ilshift__(self: NDArray[object_], x: object, /) -> ndarray[_ShapeT_co, _DTypeT_co]: ...

    #
    @overload
    def __rshift__(self: NDArray[bool_], x: _nt.ToBool_nd, /) -> NDArray[int8]: ...
    @overload
    def __rshift__(self: NDArray[bool_], x: _PyIntND, /) -> NDArray[intp]: ...
    @overload
    def __rshift__(self: NDArray[_IntegerT], x: _nt.Casts[_IntegerT] | _PyCoIntND, /) -> NDArray[_IntegerT]: ...
    @overload
    def __rshift__(self: NDArray[_IntegerT], x: _nt.CastsWith[_IntegerT, _IntegralT], /) -> NDArray[_IntegralT]: ...
    @overload
    def __rshift__(self: NDArray[object_], x: object, /) -> NDArray[object_]: ...

    #
    @overload
    def __rrshift__(self: NDArray[bool_], x: _nt.ToBool_nd, /) -> NDArray[int8]: ...
    @overload
    def __rrshift__(self: NDArray[bool_], x: _PyIntND, /) -> NDArray[intp]: ...
    @overload
    def __rrshift__(self: NDArray[_IntegerT], x: _nt.Casts[_IntegerT] | _PyCoIntND, /) -> NDArray[_IntegerT]: ...
    @overload
    def __rrshift__(self: NDArray[_IntegerT], x: _nt.CastsWith[_IntegerT, _IntegralT], /) -> NDArray[_IntegralT]: ...
    @overload
    def __rrshift__(self: NDArray[object_], x: object, /) -> NDArray[object_]: ...
