...
_CoFloat64: TypeAlias = int | _nt.JustFloat | _nt.CanArray0D[_nt.co_float64]
...
_CoComplex128: TypeAlias = (
    int | _nt.JustFloat | _nt.JustComplex | _nt.CanArray0D[complex128 | complex64 | float64 | float32 | float16 | _nt.co_integer]
)
_ToComplex128: TypeAlias = _nt.JustComplex | _nt.CanArray0D[complex128 | complex64]
...
class integer(_IntegralMixin, _RoundMixin, number[_BitT, int]):
    ...
    # keep in sync with __add__
    @overload
    def __pow__(self, x: int, mod: None = None, /) -> Self: ...
    @overload
    ...
    @overload
    def __rfloordiv__(self, x: _nt.Just[integer], /) -> integer | float64: ...
    ...
    @overload
    def __rmod__(self, x: _nt.Just[integer], /) -> integer | float64: ...

    #
    @overload
    def __divmod__(self, x: int, /) -> _2Tuple[Self]: ...
    @overload
    ...
    @overload
    def __rdivmod__(self, x: _nt.Just[integer], /) -> _2Tuple[integer | float64]: ...

    #
    @overload
    def __lshift__(self, x: int, /) -> Self: ...
    @overload
    ...
    #
    @overload
    def __rshift__(self, x: int, /) -> Self: ...
    @overload
...
class signedinteger(integer[_BitT]):
    ...
    @overload
    def __add__(self, x: _nt.Just[integer] | _JustUnsignedInteger, /) -> signedinteger | float64: ...
    ...
    @overload
    def __pow__(self, x: _nt.Just[integer] | _JustUnsignedInteger, mod: None = None, /) -> signedinteger | float64: ...
    ...
    @overload
    def __floordiv__(self, x: _nt.Just[integer] | _JustUnsignedInteger, /) -> signedinteger | float64: ...
    ...
    @overload
    def __mod__(self, x: _nt.Just[integer] | _JustUnsignedInteger, /) -> signedinteger | float64: ...
    ...
    @overload
    def __divmod__(self, x: _nt.Just[integer] | _JustUnsignedInteger, /) -> _2Tuple[signedinteger | float64]: ...
    ...
    def __ror__(self, x: int, /) -> Self: ...
    @overload
    def __ror__(self, x: _nt.Just[integer] | _JustSignedInteger, /) -> signedinteger: ...
...
class unsignedinteger(integer[_BitT]):
    ...
    @overload
    def __add__(self, x: _nt.Just[integer], /) -> integer | float64: ...
    ...
    @overload
    def __mul__(self, x: _nt.Just[integer], /) -> integer | float64: ...
    ...
    @overload
    def __pow__(self, x: _nt.Just[integer], mod: None = None, /) -> integer | float64: ...
    ...
    @overload
    def __floordiv__(self, x: _nt.Just[integer], /) -> integer | float64: ...
    ...
    @overload
    def __mod__(self, x: _nt.Just[integer], /) -> integer | float64: ...
    ...
    @overload
    def __divmod__(self, x: _nt.Just[integer], /) -> _2Tuple[integer | float64]: ...
...
class inexact(number[_BitT, _InexactItemT_co], Generic[_BitT, _InexactItemT_co]):
    ...
    #
    @overload
    def __sub__(self, x: int | _nt.JustFloat, /) -> Self: ...
    @overload
    ...
    #
    @overload
    def __rsub__(self, x: int | _nt.JustFloat, /) -> Self: ...
    @overload
    ...
    #
    @overload
    def __mul__(self, x: int | _nt.JustFloat, /) -> Self: ...
    @overload
    ...
    #
    @overload
    def __rmul__(self, x: int | _nt.JustFloat, /) -> Self: ...
    @overload
    ...
    #
    @overload
    def __pow__(self, x: int | _nt.JustFloat, mod: None = None, /) -> Self: ...
    @overload
    ...
    #
    @overload
    def __rpow__(self, x: int | _nt.JustFloat, mod: None = None, /) -> Self: ...
    @overload
    ...
    #
    @overload
    def __truediv__(self, x: int | _nt.JustFloat, /) -> Self: ...
    @overload
    ...
    #
    @overload
    def __rtruediv__(self, x: int | _nt.JustFloat, /) -> Self: ...
    @overload
...
class floating(_RealMixin, _RoundMixin, inexact[_BitT, float]):
    ...
    def __add__(self, x: _nt.JustComplex, /) -> complexfloating: ...
    @overload
    def __add__(self, x: integer | _nt.Just[floating], /) -> floating: ...
    ...
    def __radd__(self, x: _nt.JustComplex, /) -> complexfloating: ...
    @overload
    def __radd__(self, x: integer | _nt.Just[floating], /) -> floating: ...
    @overload
    def __radd__(self, x: _nt.Just[inexact], /) -> inexact: ...
    ...
    def __sub__(self, x: _nt.JustComplex, /) -> complexfloating: ...
    @overload
    def __sub__(self, x: integer | _nt.Just[floating], /) -> floating: ...
    ...
    def __rsub__(self, x: _nt.JustComplex, /) -> complexfloating: ...
    @overload
    def __rsub__(self, x: integer | _nt.Just[floating], /) -> floating: ...
    @overload
    def __rsub__(self, x: _nt.Just[inexact], /) -> inexact: ...
    ...
    def __mul__(self, x: _nt.JustComplex, /) -> complexfloating: ...
    @overload
    def __mul__(self, x: integer | _nt.Just[floating], /) -> floating: ...
    ...
    def __rmul__(self, x: _nt.JustComplex, /) -> complexfloating: ...
    @overload
    def __rmul__(self, x: integer | _nt.Just[floating], /) -> floating: ...
    @overload
    def __rmul__(self, x: _nt.Just[inexact], /) -> inexact: ...
    ...
    def __pow__(self, x: _nt.JustComplex, mod: None = None, /) -> complexfloating: ...
    @overload
    def __pow__(self, x: integer | _nt.Just[floating], mod: None = None, /) -> floating: ...
    ...
    def __rpow__(self, x: _nt.JustComplex, mod: None = None, /) -> complexfloating: ...
    @overload
    def __rpow__(self, x: integer | _nt.Just[floating], mod: None = None, /) -> floating: ...
    @overload
    def __rpow__(self, x: _nt.Just[inexact], mod: None = None, /) -> inexact: ...
    ...
    def __truediv__(self, x: _nt.JustComplex, /) -> complexfloating: ...
    @overload
    def __truediv__(self, x: integer | _nt.Just[floating], /) -> floating: ...
    ...
    def __rtruediv__(self, x: _nt.JustComplex, /) -> complexfloating: ...
    @overload
    def __rtruediv__(self, x: integer | _nt.Just[floating], /) -> floating: ...
    @overload
    def __rtruediv__(self, x: _nt.Just[inexact], /) -> inexact: ...
...
class complexfloating(inexact[_BitT1, complex], Generic[_BitT1, _BitT2]):
    ...
    # keep in sync with `__radd__`
    @overload
    def __rsub__(self, x: int | _nt.JustFloat | _nt.JustComplex, /) -> Self: ...
    @overload
    ...
    # keep in sync with `__radd__`
    @overload
    def __rmul__(self, x: int | _nt.JustFloat | _nt.JustComplex, /) -> Self: ...
    @overload
    ...
    # keep in sync with `__radd__`
    @overload
    def __rpow__(self, x: int | _nt.JustFloat | _nt.JustComplex, mod: None = None, /) -> Self: ...
    @overload
    ...
    # keep in sync with `__radd__`
    @overload
    def __rtruediv__(self, x: int | _nt.JustFloat | _nt.JustComplex, /) -> Self: ...
    @overload
    def __rtruediv__(self, x: integer | _JustInexact, /) -> complexfloating: ...  # pyright: ignore[reportIncompatibleMethodOverride]
...
class _IntROpMixin(Generic[_T_co]):
    ...
    @overload
    def __radd__(self, x: _nt.Just[integer] | _JustUnsignedInteger, /) -> _T_co | float64: ...
    ...
    @overload
    def __rmul__(self, x: _nt.Just[integer] | _JustUnsignedInteger, /) -> _T_co | float64: ...
    ...
    @overload
    def __rpow__(self, x: _nt.Just[integer] | _JustUnsignedInteger, mod: None = None, /) -> _T_co | float64: ...
    ...
    @overload
    def __rfloordiv__(self, x: _nt.Just[integer] | _JustUnsignedInteger, /) -> _T_co | float64: ...
    ...
    @overload
    def __rmod__(self, x: _nt.Just[integer] | _JustUnsignedInteger, /) -> _T_co | float64: ...
    ...
    @overload
    def __rdivmod__(self, x: _nt.Just[integer] | _JustUnsignedInteger, /) -> _2Tuple[_T_co | float64]: ...

    #
    @overload
    def __rlshift__(self, x: int, /) -> Self: ...
    @overload
    def __rlshift__(self, x: _JustSignedInteger | _JustUnsignedInteger | _nt.Just[integer], /) -> _T_co: ...

    #
    @overload
    def __rrshift__(self, x: int, /) -> Self: ...
    @overload
    def __rrshift__(self, x: _JustSignedInteger | _JustUnsignedInteger | _nt.Just[integer], /) -> _T_co: ...

    #
    @overload
    def __rand__(self, x: int, /) -> Self: ...
    @overload
    def __rand__(self, x: _JustSignedInteger | _JustUnsignedInteger | _nt.Just[integer], /) -> _T_co: ...

    #
    @overload
    def __rxor__(self, x: int, /) -> Self: ...
    @overload
    def __rxor__(self, x: _JustSignedInteger | _JustUnsignedInteger | _nt.Just[integer], /) -> _T_co: ...
...
class uint8(unsignedinteger[_n._8]):
    ...
    def __add__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __add__(self, x: _nt.Just[integer], /) -> integer: ...
    @overload
    ...
    def __radd__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __radd__(self, x: _nt.Just[integer], /) -> integer: ...
    @overload
    ...
    def __mul__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __mul__(self, x: _nt.Just[integer], /) -> integer: ...
    @overload
    ...
    def __rmul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rmul__(self, x: _nt.Just[integer], /) -> integer: ...
    @overload
    ...
    def __pow__(self, x: _JustSignedInteger, mod: None = None, /) -> signedinteger: ...
    @overload
    def __pow__(self, x: _nt.Just[integer], mod: None = None, /) -> integer: ...
    @overload
    ...
    def __rpow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __rpow__(self, x: _nt.Just[integer], mod: None = None, /) -> integer: ...
    @overload
...
class uint32(unsignedinteger[_n._32]):
    ...
    def __add__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __add__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> int64: ...
    @overload
    def __add__(self, x: _nt.Just[integer], /) -> integer: ...
    ...
    def __radd__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __radd__(self, x: _nt.Just[integer], /) -> integer: ...  # type: ignore[overload-overlap]
    @overload
    def __radd__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> int64: ...
    @overload
    def __radd__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __mul__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __mul__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> int64: ...
    @overload
    def __mul__(self, x: _nt.Just[integer], /) -> integer: ...
    ...
    def __rmul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rmul__(self, x: _nt.Just[integer], /) -> integer: ...  # type: ignore[overload-overlap]
    @overload
    def __rmul__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> int64: ...
    @overload
    def __rmul__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __pow__(self, x: _JustUnsignedInteger, mod: None = None, /) -> unsignedinteger: ...
    @overload
    def __pow__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, mod: None = None, /) -> int64: ...
    @overload
    def __pow__(self, x: _nt.Just[integer], mod: None = None, /) -> integer: ...
    ...
    def __rpow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __rpow__(self, x: _nt.Just[integer], mod: None = None, /) -> integer: ...  # type: ignore[overload-overlap]
    @overload
    def __rpow__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, mod: None = None, /) -> int64: ...
    @overload
    def __rpow__(self, x: _JustUnsignedInteger, mod: None = None, /) -> unsignedinteger: ...
    ...
    def __floordiv__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __floordiv__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> int64: ...
    @overload
    def __floordiv__(self, x: _nt.Just[integer], /) -> integer: ...
    ...
    def __rfloordiv__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rfloordiv__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> int64: ...
    @overload
    def __rfloordiv__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __rfloordiv__(self, x: _nt.Just[integer], /) -> integer: ...
    ...
    def __mod__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __mod__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> int64: ...
    @overload
    def __mod__(self, x: _nt.Just[integer], /) -> integer: ...
    ...
    def __rmod__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rmod__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> int64: ...
    @overload
    def __rmod__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __rmod__(self, x: _nt.Just[integer], /) -> integer: ...
    ...
    def __divmod__(self, x: _JustUnsignedInteger, /) -> _2Tuple[unsignedinteger]: ...
    @overload
    def __divmod__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> _2Tuple[int64]: ...
    @overload
    def __divmod__(self, x: _nt.Just[integer], /) -> _2Tuple[integer]: ...
    ...
    def __rdivmod__(self, x: _nt.JustFloat, /) -> _2Tuple[float64]: ...
    @overload
    def __rdivmod__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> _2Tuple[int64]: ...
    @overload
    def __rdivmod__(self, x: _JustUnsignedInteger, /) -> _2Tuple[unsignedinteger]: ...
    @overload
    def __rdivmod__(self, x: _nt.Just[integer], /) -> _2Tuple[integer]: ...
...
class int64(_IntROpMixin[int64], signedinteger[_n._64]):
    ...
    def __divmod__(self, x: _nt.JustFloat, /) -> _2Tuple[float64]: ...
    @overload
    def __divmod__(self, x: _nt.Just[integer] | _JustUnsignedInteger, /) -> _2Tuple[Self | float64]: ...
...
class uint64(unsignedinteger[_n._64]):
    ...
    def __add__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __add__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> float64: ...
    @overload
    def __add__(self, x: _nt.Just[integer], /) -> Self | float64: ...
    ...
    def __radd__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __radd__(self, x: _nt.Just[integer], /) -> Self | float64: ...  # type: ignore[overload-overlap]
    @overload
    def __radd__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> float64: ...
    @overload
    ...
    def __mul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __mul__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> float64: ...
    @overload
    def __mul__(self, x: _nt.Just[integer], /) -> Self | float64: ...
    ...
    def __rmul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rmul__(self, x: _nt.Just[integer], /) -> Self | float64: ...  # type: ignore[overload-overlap]
    @overload
    ...
    def __pow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __pow__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, mod: None = None, /) -> float64: ...
    @overload
    def __pow__(self, x: _nt.Just[integer], mod: None = None, /) -> Self | float64: ...
    ...
    def __rpow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __rpow__(self, x: _nt.Just[integer], mod: None = None, /) -> Self | float64: ...  # type: ignore[overload-overlap]
    @overload
    ...
    def __floordiv__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __floordiv__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> float64: ...
    @overload
    def __floordiv__(self, x: _nt.Just[integer], /) -> Self | float64: ...
    ...
    def __rfloordiv__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rfloordiv__(self, x: _nt.Just[integer], /) -> Self | float64: ...  # type: ignore[overload-overlap]
    @overload
    ...
    def __mod__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __mod__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> float64: ...
    @overload
    def __mod__(self, x: _nt.Just[integer], /) -> Self | float64: ...
    ...
    def __rmod__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rmod__(self, x: _nt.Just[integer], /) -> Self | float64: ...  # type: ignore[overload-overlap]
    @overload
    ...
    def __divmod__(self, x: _nt.JustFloat, /) -> _2Tuple[float64]: ...
    @overload
    def __divmod__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> _2Tuple[float64]: ...
    @overload
    def __divmod__(self, x: _nt.Just[integer], /) -> _2Tuple[Self | float64]: ...
    ...
    def __rdivmod__(self, x: _nt.JustFloat, /) -> _2Tuple[float64]: ...
    @overload
    def __rdivmod__(self, x: _nt.Just[integer], /) -> _2Tuple[Self | float64]: ...  # type: ignore[overload-overlap]
    @overload
    def __rdivmod__(self, x: _nt.CanArray0D[signedinteger] | _JustSignedInteger, /) -> _2Tuple[float64]: ...

    # NOTE: The reported LSP violation below are false positives
...
class float16(floating[_n._16]):
    ...
    @overload
    def __add__(self, x: _JustInteger | _nt.Just[floating], /) -> floating: ...
    @overload
    ...
    @overload
    def __add__(self, x: _nt.ToInteger_0d | _JustFloating, /) -> floating: ...
    @overload
    ...
    @overload
    def __radd__(self, x: _JustInteger | _nt.Just[floating], /) -> floating: ...
    @overload
    def __radd__(self, x: _nt.Just[inexact], /) -> inexact: ...
    @overload
    ...
    @overload
    def __radd__(self, x: _nt.ToInteger_0d | _JustFloating, /) -> floating: ...
    @overload
    ...
    @overload
    def __sub__(self, x: _JustInteger | _nt.Just[floating], /) -> floating: ...
    @overload
    ...
    @overload
    def __sub__(self, x: _nt.ToInteger_0d | _JustFloating, /) -> floating: ...
    @overload
    def __sub__(self, x: _JustComplexFloating, /) -> complexfloating: ...

    # keep in sync with __radd__
    @overload
    def __rsub__(self, x: _CoFloat16, /) -> Self: ...
    @overload
    def __rsub__(self, x: _nt.JustComplex, /) -> complex64: ...
    @overload
    def __rsub__(self, x: _JustInteger | _nt.Just[floating], /) -> floating: ...
    @overload
    def __rsub__(self, x: _nt.Just[inexact], /) -> inexact: ...
    @overload
    ...
    @overload
    def __rsub__(self, x: _nt.ToInteger_0d | _JustFloating, /) -> floating: ...
    @overload
    ...
    @overload
    def __mul__(self, x: _JustInteger | _nt.Just[floating], /) -> floating: ...
    @overload
    ...
    @overload
    def __mul__(self, x: _nt.ToInteger_0d | _JustFloating, /) -> floating: ...
    @overload
    def __mul__(self, x: _JustComplexFloating, /) -> complexfloating: ...

    # keep in sync with __radd__
    @overload
    def __rmul__(self, x: _CoFloat16, /) -> Self: ...
    @overload
    def __rmul__(self, x: _nt.JustComplex, /) -> complex64: ...
    @overload
    def __rmul__(self, x: _JustInteger | _nt.Just[floating], /) -> floating: ...
    @overload
    def __rmul__(self, x: _nt.Just[inexact], /) -> inexact: ...
    @overload
    ...
    @overload
    def __rmul__(self, x: _nt.ToInteger_0d | _JustFloating, /) -> floating: ...
    @overload
    ...
    @overload
    def __pow__(self, x: _JustInteger | _nt.Just[floating], mod: None = None, /) -> floating: ...
    @overload
    def __pow__(self, x: _nt.Just[inexact], mod: None = None, /) -> inexact: ...
    @overload
    def __pow__(self, x: _nt.CanArray0D[_nt.integer16], mod: None = None, /) -> float32: ...
    @overload
    def __pow__(self, x: _nt.CanArray0D[_nt.integer64 | _nt.integer32], mod: None = None, /) -> float64: ...
    @overload
    def __pow__(self, x: _nt.ToInteger_0d | _JustFloating, mod: None = None, /) -> floating: ...
    @overload
    def __pow__(self, x: _JustComplexFloating, mod: None = None, /) -> complexfloating: ...

    # keep in sync with __radd__
    @overload
    def __rpow__(self, x: _CoFloat16, mod: None = None, /) -> Self: ...
    @overload
    def __rpow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex64: ...
    @overload
    def __rpow__(self, x: _JustInteger | _nt.Just[floating], mod: None = None, /) -> floating: ...
    @overload
    def __rpow__(self, x: _nt.Just[inexact], mod: None = None, /) -> inexact: ...
    @overload
    def __rpow__(self, x: _nt.CanArray0D[_nt.integer16], mod: None = None, /) -> float32: ...
    @overload
    def __rpow__(self, x: _nt.CanArray0D[_nt.integer64 | _nt.integer32], mod: None = None, /) -> float64: ...
    @overload
    def __rpow__(self, x: _nt.ToInteger_0d | _JustFloating, mod: None = None, /) -> floating: ...
    @overload
    ...
    @overload
    def __truediv__(self, x: _JustInteger | _nt.Just[floating], /) -> floating: ...
    @overload
    ...
    @overload
    def __truediv__(self, x: _nt.ToInteger_0d | _JustFloating, /) -> floating: ...
    @overload
    def __truediv__(self, x: _JustComplexFloating, /) -> complexfloating: ...

    # keep in sync with __radd__
    @overload
    def __rtruediv__(self, x: _CoFloat16, /) -> Self: ...
    @overload
    def __rtruediv__(self, x: _nt.JustComplex, /) -> complex64: ...
    @overload
    def __rtruediv__(self, x: _JustInteger | _nt.Just[floating], /) -> floating: ...
    @overload
    def __rtruediv__(self, x: _nt.Just[inexact], /) -> inexact: ...
    @overload
    ...
    @overload
    def __rtruediv__(self, x: _nt.ToInteger_0d | _JustFloating, /) -> floating: ...
    @overload
    ...
    @overload
    def __divmod__(self, x: _JustSignedInteger | _JustUnsignedInteger | _nt.Just[integer], /) -> _2Tuple[floating]: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    @overload
    def __rdivmod__(self, x: _JustSignedInteger | _JustUnsignedInteger | _nt.Just[integer], /) -> _2Tuple[floating]: ...  # pyright: ignore[reportIncompatibleMethodOverride]
...
class float64(floating[_n._64], float):  # type: ignore[misc]
    ...
    def __sub__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __sub__(self, x: _JustFloating, /) -> floating: ...
    @overload
    def __sub__(self, x: _nt.Just[inexact], /) -> inexact: ...
    @overload
    ...
    def __rsub__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rsub__(self, x: _JustFloating, /) -> floating: ...
    @overload
    def __rsub__(self, x: _nt.Just[inexact], /) -> inexact: ...
    @overload
    ...
    def __mul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __mul__(self, x: _JustFloating, /) -> floating: ...
    @overload
    def __mul__(self, x: _nt.Just[inexact], /) -> inexact: ...
    @overload
    ...
    def __rmul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rmul__(self, x: _JustFloating, /) -> floating: ...
    @overload
    def __rmul__(self, x: _nt.Just[inexact], /) -> inexact: ...
    @overload
    ...
    def __pow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __pow__(self, x: _JustFloating, mod: None = None, /) -> floating: ...
    @overload
    def __pow__(self, x: _nt.Just[inexact], mod: None = None, /) -> inexact: ...
    @overload
    ...
    def __rpow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __rpow__(self, x: _JustFloating, mod: None = None, /) -> floating: ...
    @overload
    def __rpow__(self, x: _nt.Just[inexact], mod: None = None, /) -> inexact: ...
    @overload
    ...
    def __truediv__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __truediv__(self, x: _JustFloating, /) -> floating: ...
    @overload
    def __truediv__(self, x: _nt.Just[inexact], /) -> inexact: ...
    @overload
    ...
    def __rtruediv__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rtruediv__(self, x: _JustFloating, /) -> floating: ...
    @overload
    def __rtruediv__(self, x: _nt.Just[inexact], /) -> inexact: ...
    @overload
...
class longdouble(floating[_n._64L]):
    ...
    @overload
    def __add__(self, x: _nt.CoFloating_0d | _nt.Just[floating], /) -> Self: ...
    @overload
    def __add__(self, x: _nt.Just[inexact], /) -> inexact: ...
    ...
    @overload
    def __radd__(self, x: _nt.CoFloating_0d | _nt.Just[floating], /) -> Self: ...
    @overload
    ...
    @overload
    def __sub__(self, x: _nt.CoFloating_0d | _nt.Just[floating], /) -> Self: ...
    @overload
    def __sub__(self, x: _nt.Just[inexact], /) -> inexact: ...
    ...
    @overload
    def __rsub__(self, x: _nt.CoFloating_0d | _nt.Just[floating], /) -> Self: ...
    @overload
    ...
    @overload
    def __mul__(self, x: _nt.CoFloating_0d | _nt.Just[floating], /) -> Self: ...
    @overload
    def __mul__(self, x: _nt.Just[inexact], /) -> inexact: ...
    ...
    @overload
    def __rmul__(self, x: _nt.CoFloating_0d | _nt.Just[floating], /) -> Self: ...
    @overload
    ...
    @overload
    def __pow__(self, x: _nt.CoFloating_0d | _nt.Just[floating], mod: None = None, /) -> Self: ...
    @overload
    def __pow__(self, x: _nt.Just[inexact], mod: None = None, /) -> inexact: ...
    ...
    @overload
    def __rpow__(self, x: _nt.CoFloating_0d | _nt.Just[floating], mod: None = None, /) -> Self: ...
    @overload
    ...
    @overload
    def __truediv__(self, x: _nt.CoFloating_0d | _nt.Just[floating], /) -> Self: ...
    @overload
    def __truediv__(self, x: _nt.Just[inexact], /) -> inexact: ...
    ...
    @overload
    def __rtruediv__(self, x: _nt.CoFloating_0d | _nt.Just[floating], /) -> Self: ...
    @overload
    def __rtruediv__(self, x: _nt.Just[number] | _nt.Just[inexact], /) -> inexact: ...
