...
_Complex64_co: TypeAlias = number[_32Bit] | number[_16Bit] | number[_8Bit] | py_bool | bool_
...
_ConvertibleToComplex: TypeAlias = CanComplex | CanFloat | CanIndex | _CharLike_co
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeT_co, _DTypeT_co]):
    ...
    #
    @overload
    def __add__(self: NDArray[_NumberT], rhs: int | bool_, /) -> ndarray[_ShapeT_co, dtype[_NumberT]]: ...  # type: ignore[overload-overlap]
    @overload
    def __add__(self: NDArray[_NumberT], rhs: _ArrayLikeBool_co, /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    def __add__(self: NDArray[bool_], rhs: _ArrayLike[_NumberT], /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __radd__(self: NDArray[_NumberT], lhs: int | bool_, /) -> ndarray[_ShapeT_co, dtype[_NumberT]]: ...  # type: ignore[overload-overlap, misc]
    @overload
    def __radd__(self: NDArray[_NumberT], lhs: _ArrayLikeBool_co, /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    def __radd__(self: NDArray[bool_], lhs: _ArrayLike[_NumberT], /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    ...
    #
    @overload
    def __sub__(self: NDArray[_NumberT], rhs: int | bool_, /) -> ndarray[_ShapeT_co, dtype[_NumberT]]: ...  # type: ignore[overload-overlap]
    @overload
    def __sub__(self: NDArray[_NumberT], rhs: _ArrayLikeBool_co, /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    def __sub__(self: NDArray[bool_], rhs: _ArrayLike[_NumberT], /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __rsub__(self: NDArray[_NumberT], lhs: int | bool_, /) -> ndarray[_ShapeT_co, dtype[_NumberT]]: ...  # type: ignore[overload-overlap, misc]
    @overload
    def __rsub__(self: NDArray[_NumberT], lhs: _ArrayLikeBool_co, /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    def __rsub__(self: NDArray[bool_], lhs: _ArrayLike[_NumberT], /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    ...
    #
    @overload
    def __mul__(self: NDArray[_NumberT], rhs: int | bool_, /) -> ndarray[_ShapeT_co, dtype[_NumberT]]: ...  # type: ignore[overload-overlap]
    @overload
    def __mul__(self: NDArray[_NumberT], rhs: _ArrayLikeBool_co, /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    def __mul__(self: NDArray[bool_], rhs: _ArrayLike[_NumberT], /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __rmul__(self: NDArray[_NumberT], lhs: int | bool_, /) -> ndarray[_ShapeT_co, dtype[_NumberT]]: ...  # type: ignore[overload-overlap, misc]
    @overload
    def __rmul__(self: NDArray[_NumberT], lhs: _ArrayLikeBool_co, /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    def __rmul__(self: NDArray[bool_], lhs: _ArrayLike[_NumberT], /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __matmul__(self: NDArray[_NumberT], rhs: _ArrayLikeBool_co, /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    def __matmul__(self: NDArray[bool_], rhs: _ArrayLike[_NumberT], /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __rmatmul__(self: NDArray[_NumberT], lhs: _ArrayLikeBool_co, /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    def __rmatmul__(self: NDArray[bool_], lhs: _ArrayLike[_NumberT], /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    ...
    #
    @overload
    def __pow__(self: NDArray[_NumberT], rhs: int | bool_, /) -> ndarray[_ShapeT_co, dtype[_NumberT]]: ...  # type: ignore[overload-overlap]
    @overload
    def __pow__(self: NDArray[_NumberT], rhs: _ArrayLikeBool_co, /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    def __pow__(self: NDArray[bool_], rhs: _ArrayLike[_NumberT], /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    def __pow__(self: NDArray[bool_], rhs: _ArrayLikeBool_co, /) -> NDArray[int8]: ...
    @overload
    def __pow__(self: NDArray[floating[_64Bit]], rhs: _ArrayLikeFloat64_co, /) -> NDArray[float64]: ...
    @overload
    def __pow__(self: _ArrayFloat64_co, rhs: _ArrayLike[floating[_64Bit]], /) -> NDArray[float64]: ...
    @overload
    def __pow__(self: NDArray[complexfloating[_64Bit]], rhs: _ArrayLikeComplex128_co, /) -> NDArray[complex128]: ...
    @overload
    def __pow__(self: _ArrayComplex128_co, rhs: _ArrayLike[complexfloating[_64Bit]], /) -> NDArray[complex128]: ...
    @overload
    def __pow__(self: NDArray[unsignedinteger], rhs: _ArrayLikeUInt_co, /) -> NDArray[unsignedinteger]: ...
    @overload
    def __pow__(self: _ArrayUInt_co, rhs: _ArrayLike[unsignedinteger], /) -> NDArray[unsignedinteger]: ...
    @overload
    def __pow__(self: NDArray[signedinteger], rhs: _ArrayLikeInt_co, /) -> NDArray[signedinteger]: ...
    @overload
    def __pow__(self: _ArrayInt_co, rhs: _ArrayLike[signedinteger], /) -> NDArray[signedinteger]: ...
    @overload
    def __pow__(self: NDArray[floating], rhs: _ArrayLikeFloat_co, /) -> NDArray[floating]: ...
    @overload
    def __pow__(self: _ArrayFloat_co, rhs: _ArrayLike[floating], /) -> NDArray[floating]: ...
    @overload
    def __pow__(self: NDArray[complexfloating], rhs: _ArrayLikeComplex_co, /) -> NDArray[complexfloating]: ...
    @overload
    def __pow__(self: _ArrayComplex_co, rhs: _ArrayLike[complexfloating], /) -> NDArray[complexfloating]: ...
    @overload
    def __pow__(self: NDArray[bool_ | number], rhs: _ArrayLikeNumber_co, /) -> NDArray[Incomplete]: ...
    @overload
    def __pow__(self: NDArray[object_], rhs: object, /) -> NDArray[object_]: ...
    @overload
    def __pow__(self, rhs: _ArrayLikeObject_co, /) -> NDArray[object_]: ...

    #
    @overload
    def __rpow__(self: NDArray[_NumberT], lhs: int | bool_, /) -> ndarray[_ShapeT_co, dtype[_NumberT]]: ...  # type: ignore[overload-overlap, misc]
    @overload
    def __rpow__(self: NDArray[_NumberT], lhs: _ArrayLikeBool_co, /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    def __rpow__(self: NDArray[bool_], lhs: _ArrayLike[_NumberT], /) -> NDArray[_NumberT]: ...  # type: ignore[overload-overlap]
    @overload
    def __rpow__(self: NDArray[bool_], lhs: _ArrayLikeBool_co, /) -> NDArray[int8]: ...
    @overload
    def __rpow__(self: NDArray[floating[_64Bit]], lhs: _ArrayLikeFloat64_co, /) -> NDArray[float64]: ...
    @overload
    def __rpow__(self: _ArrayFloat64_co, lhs: _ArrayLike[floating[_64Bit]], /) -> NDArray[float64]: ...
    @overload
    def __rpow__(self: NDArray[complexfloating[_64Bit]], lhs: _ArrayLikeComplex128_co, /) -> NDArray[complex128]: ...
    @overload
    def __rpow__(self: _ArrayComplex128_co, lhs: _ArrayLike[complexfloating[_64Bit]], /) -> NDArray[complex128]: ...
    @overload
    def __rpow__(self: NDArray[unsignedinteger], lhs: _ArrayLikeUInt_co, /) -> NDArray[unsignedinteger]: ...
    @overload
    def __rpow__(self: _ArrayUInt_co, lhs: _ArrayLike[unsignedinteger], /) -> NDArray[unsignedinteger]: ...
    @overload
    def __rpow__(self: NDArray[signedinteger], lhs: _ArrayLikeInt_co, /) -> NDArray[signedinteger]: ...
    @overload
    def __rpow__(self: _ArrayInt_co, lhs: _ArrayLike[signedinteger], /) -> NDArray[signedinteger]: ...
    @overload
    def __rpow__(self: NDArray[floating], lhs: _ArrayLikeFloat_co, /) -> NDArray[floating]: ...
    @overload
    def __rpow__(self: _ArrayFloat_co, lhs: _ArrayLike[floating], /) -> NDArray[floating]: ...
    @overload
    def __rpow__(self: NDArray[complexfloating], lhs: _ArrayLikeComplex_co, /) -> NDArray[complexfloating]: ...
    @overload
    def __rpow__(self: _ArrayComplex_co, lhs: _ArrayLike[complexfloating], /) -> NDArray[complexfloating]: ...
    @overload
    def __rpow__(self: NDArray[bool_ | number], lhs: _ArrayLikeNumber_co, /) -> NDArray[Incomplete]: ...
    @overload
    def __rpow__(self: NDArray[object_], lhs: object, /) -> NDArray[object_]: ...
    @overload
    def __rpow__(self, lhs: _ArrayLikeObject_co, /) -> NDArray[object_]: ...
...
class integer(_IntegralMixin, _RoundMixin, number[_NBitT, int]):
    ...
    #
    @overload
    def __truediv__(self, x: bool_ | integer | int | float, /) -> float64: ...
    @overload
    ...
    @overload
    def __rmod__(self, x: int | float, /) -> Self | float64: ...
    ...
    @overload
    def __rdivmod__(self, x: int | float, /) -> _2Tuple[Self] | _2Tuple[float64]: ...

    #
    @overload
    def __rpow__(self, x: int, /) -> Self: ...
    @overload
    def __rpow__(self, x: float, /) -> float64 | Self: ...
    @overload
    def __rpow__(self, x: complex, /) -> complex128 | float64 | Self: ...
...
class signedinteger(integer[_NBitT]):
    ...
    #
    @overload
    def __add__(self, x: int | Self | int8 | bool_, /) -> Self: ...
    @overload
    ...
    #  keep in sync with __add__
    @overload
    def __sub__(self, x: int | Self | int8 | bool_, /) -> Self: ...
    @overload
    ...
    #  keep in sync with __add__
    @overload
    def __mul__(self, x: int | Self | int8 | bool_, /) -> Self: ...
    @overload
    ...
    #  keep in sync with __add__
    @overload
    def __pow__(self, x: int | Self | int8 | bool_, /) -> Self: ...
    @overload
    def __pow__(self, x: int64, /) -> int64: ...
    @overload
    def __pow__(self: int64, x: signedinteger, /) -> int64: ...
    @overload
    def __pow__(self: int32, x: int8 | int16 | int32, /) -> int32: ...
    @overload
    def __pow__(self: int16, x: int32, /) -> int32: ...
    @overload
    def __pow__(self: int16, x: int8 | int16, /) -> int16: ...
    @overload
    def __pow__(self: int8, x: _SignedIntegerT, /) -> _SignedIntegerT: ...
    @overload
    def __pow__(self, x: floating[_64Bit], /) -> float64: ...
    @overload
    def __pow__(self, x: complexfloating[_64Bit], /) -> complex128: ...
    @overload
    def __pow__(self, x: float, /) -> float64 | Self: ...
    @overload
    def __pow__(self, x: complex, /) -> complex128 | float64 | Self: ...

    #  keep in sync with __add__ (minus complex)
    @overload
    def __floordiv__(self, x: int | Self | int8 | bool_, /) -> Self: ...
    @overload
    ...
    def __mod__(self, x: int | Self | int8 | bool_, /) -> Self: ...
    @overload
    ...
    @overload
    def __mod__(self, x: signedinteger[_NBitT1], /) -> signedinteger[_NBitT | _NBitT1]: ...
    @overload
    ...
    # keep in sync with __mod__
    @overload  # type: ignore[override]
    def __divmod__(self, x: int | Self | int8 | bool_, /) -> _2Tuple[Self]: ...
    @overload
    ...
    @overload
    def __divmod__(self, x: signedinteger[_NBitT1], /) -> _2Tuple[signedinteger[_NBitT | _NBitT1]]: ...
    @overload
    ...
    #
    @overload  # type: ignore[override]
    def __lshift__(self, x: int | Self | int8 | bool_, /) -> Self: ...
    @overload
    def __lshift__(self: int64, x: signedinteger, /) -> int64: ...
    @overload
    def __lshift__(self, x: int64, /) -> int64: ...
    @overload
    def __lshift__(self, x: signedinteger[_NBitT1], /) -> signedinteger[_NBitT | _NBitT1]: ...
    @overload
    def __lshift__(self, x: _IntLike_co, /) -> signedinteger: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    # keep in sync with __lshift__
    @overload  # type: ignore[override]
    def __rshift__(self, x: int | Self | int8 | bool_, /) -> Self: ...
    @overload
    def __rshift__(self: int64, x: signedinteger, /) -> int64: ...
    @overload
    def __rshift__(self, x: int64, /) -> int64: ...
    @overload
    def __rshift__(self, x: signedinteger[_NBitT1], /) -> signedinteger[_NBitT | _NBitT1]: ...
    @overload
    def __rshift__(self, x: _IntLike_co, /) -> signedinteger: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    # keep in sync with __lshift__
    @overload  # type: ignore[override]
    def __and__(self, x: int | Self | int8 | bool_, /) -> Self: ...
    @overload
    def __and__(self: int64, x: signedinteger, /) -> int64: ...
    @overload
    def __and__(self, x: int64, /) -> int64: ...
    @overload
    def __and__(self, x: signedinteger[_NBitT1], /) -> signedinteger[_NBitT | _NBitT1]: ...
    @overload
    def __and__(self, x: _IntLike_co, /) -> signedinteger: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    # keep in sync with __lshift__
    @overload  # type: ignore[override]
    def __xor__(self, x: int | Self | int8 | bool_, /) -> Self: ...
    @overload
    def __xor__(self: int64, x: signedinteger, /) -> int64: ...
    @overload
    def __xor__(self, x: int64, /) -> int64: ...
    @overload
    def __xor__(self, x: signedinteger[_NBitT1], /) -> signedinteger[_NBitT | _NBitT1]: ...
    @overload
    def __xor__(self, x: _IntLike_co, /) -> signedinteger: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    # keep in sync with __lshift__
    @overload  # type: ignore[override]
    def __or__(self, x: int | Self | int8 | bool_, /) -> Self: ...
    @overload
...
class unsignedinteger(integer[_NBitT]):
    ...
    #
    @overload
    def __add__(self, x: int | Self | uint8 | bool_, /) -> Self: ...
    @overload
    ...
    # keep in sync with __add__
    @overload
    def __sub__(self, x: int | Self | uint8 | bool_, /) -> Self: ...
    @overload
    ...
    # keep in sync with __add__
    @overload
    def __mul__(self, x: int | Self | uint8 | bool_, /) -> Self: ...
    @overload
    ...
    @overload
    def __pow__(self, x: int | Self | uint8 | bool_, /) -> Self: ...
    @overload
    def __pow__(self, x: uint64, /) -> uint64: ...
    @overload
    def __pow__(self: uint64, x: signedinteger, /) -> float64: ...
    @overload
    def __pow__(self: uint64, x: unsignedinteger | bool_, /) -> uint64: ...
    @overload
    def __pow__(self: uint32, x: signedinteger, /) -> int64: ...
    @overload
    def __pow__(self: uint32 | uint16 | uint8, x: int64, /) -> int64: ...
    @overload
    def __pow__(self: uint32, x: uint32 | uint16 | uint8, /) -> uint32: ...
    @overload
    def __pow__(self: uint16, x: uint32, /) -> uint32: ...
    @overload
    def __pow__(self: uint16, x: int16 | int8, /) -> int32: ...
    @overload
    def __pow__(self: uint16 | uint8, x: int32, /) -> int32: ...
    @overload
    def __pow__(self: uint16, x: uint16 | uint8, /) -> uint16: ...
    @overload
    def __pow__(self: uint8, x: _UnsignedIntegerT, /) -> _UnsignedIntegerT: ...
    @overload
    def __pow__(self: uint8, x: int16 | int8, /) -> int16: ...
    @overload
    def __pow__(self, x: unsignedinteger, /) -> unsignedinteger: ...
    @overload
    def __pow__(self, x: signedinteger, /) -> float64 | signedinteger: ...
    @overload
    def __pow__(self, x: integer, /) -> float64 | integer: ...
    @overload
    def __pow__(self, x: floating[_64Bit], /) -> float64: ...
    @overload
    def __pow__(self, x: complexfloating[_64Bit], /) -> complex128: ...
    @overload
    def __pow__(self, x: object_, /) -> object_: ...
    @overload
    def __pow__(self, x: float, /) -> float64 | Self: ...
    @overload
    def __pow__(self, x: complex, /) -> complex128 | float64 | Self: ...
    ...
    @overload
    def __rpow__(self: uint64, x: signedinteger, /) -> float64: ...
    @overload
    def __rpow__(self: uint32, x: signedinteger, /) -> int64: ...
    @overload
    def __rpow__(self: uint32 | uint16 | uint8, x: int64, /) -> int64: ...
    @overload
    def __rpow__(self: uint16, x: int16 | int8, /) -> int32: ...
    @overload
    def __rpow__(self: uint16 | uint8, x: int32, /) -> int32: ...
    @overload
    def __rpow__(self: uint8, x: int16 | int8, /) -> int16: ...
    @overload
    def __rpow__(self, x: signedinteger, /) -> float64 | signedinteger: ...
    @overload
    def __rpow__(self, x: integer, /) -> float64 | integer: ...
    @overload
    def __rpow__(self, x: object_, /) -> object_: ...
    @overload
    def __rpow__(self, x: int, /) -> Self: ...
    @overload
    def __rpow__(self, x: float, /) -> float64 | Self: ...
    @overload
    def __rpow__(self, x: complex, /) -> complex128 | float64 | Self: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    # keep in sync with __pow__ (minus the complex overloads)
    @overload
    def __floordiv__(self, x: int | Self | uint8 | bool_, /) -> Self: ...
    @overload
    def __floordiv__(self, x: uint64, /) -> uint64: ...
    @overload
    def __floordiv__(self: uint64, x: signedinteger, /) -> float64: ...
    @overload
    def __floordiv__(self: uint64, x: unsignedinteger | bool_, /) -> uint64: ...
    @overload
    def __floordiv__(self: uint32, x: signedinteger, /) -> int64: ...
    @overload
    def __floordiv__(self: uint32, x: uint32 | uint16 | uint8, /) -> uint32: ...
    @overload
    def __floordiv__(self: uint16, x: uint32, /) -> uint32: ...
    @overload
    def __floordiv__(self: uint16, x: int16 | int8, /) -> int32: ...
    @overload
    def __floordiv__(self: uint16, x: uint16 | uint8, /) -> uint16: ...
    @overload
    def __floordiv__(self: uint8, x: _UnsignedIntegerT, /) -> _UnsignedIntegerT: ...
    @overload
    ...
    @overload  # type: ignore[override]
    def __mod__(self, x: int | Self | uint8 | bool_, /) -> Self: ...
    @overload
    ...
    @overload  # type: ignore[override]
    def __divmod__(self, x: int | Self | uint8 | bool_, /) -> _2Tuple[Self]: ...
    @overload
    ...
    #
    @overload  # type: ignore[override]
    def __lshift__(self, x: int | Self | uint8 | bool_, /) -> Self: ...
    @overload
    ...
    # keep in sync with __lshift__
    @overload  # type: ignore[override]
    def __rshift__(self, x: int | Self | uint8 | bool_, /) -> Self: ...
    @overload
    ...
    @overload  # type: ignore[override]
    def __and__(self, x: int | Self | uint8 | bool_, /) -> Self: ...
    @overload
    ...
    @overload  # type: ignore[override]
    def __xor__(self, x: int | Self | uint8 | bool_, /) -> Self: ...
    @overload
    ...
    @overload  # type: ignore[override]
    def __or__(self, x: int | Self | uint8 | bool_, /) -> Self: ...
    @overload
...
class complexfloating(inexact[_NBitT1, complex], Generic[_NBitT1, _NBitT2]):
    ...
    def __init__(
        self,
        real: complex | CanComplex | CanFloat | CanIndex = ...,
        imag: complex | CanFloat | CanIndex = ...,
        /,
    ) -> None: ...
    @overload
    ...
    #
    @overload
    def __add__(self, other: inexact[_NBitT1] | _Complex64_co, /) -> Self: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __add__(self, other: number[_NBitT], /) -> complexfloating[_NBitT | _NBitT1, _NBitT | _NBitT2]: ...

    #
    @overload
    def __radd__(self, other: inexact[_NBitT1] | _Complex64_co, /) -> Self: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __radd__(self, other: number[_NBitT], /) -> complexfloating[_NBitT | _NBitT1, _NBitT | _NBitT2]: ...

    #
    @overload
    def __sub__(self, other: inexact[_NBitT1] | _Complex64_co, /) -> Self: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __sub__(self, other: number[_NBitT], /) -> complexfloating[_NBitT | _NBitT1, _NBitT | _NBitT2]: ...

    #
    @overload
    def __rsub__(self, other: inexact[_NBitT1] | _Complex64_co, /) -> Self: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __rsub__(self, other: number[_NBitT], /) -> complexfloating[_NBitT | _NBitT1, _NBitT | _NBitT2]: ...

    #
    @overload
    def __mul__(self, other: inexact[_NBitT1] | _Complex64_co, /) -> Self: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __mul__(self, other: number[_NBitT], /) -> complexfloating[_NBitT | _NBitT1, _NBitT | _NBitT2]: ...

    #
    @overload
    def __rmul__(self, other: inexact[_NBitT1] | _Complex64_co, /) -> Self: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __rmul__(self, other: number[_NBitT], /) -> complexfloating[_NBitT | _NBitT1, _NBitT | _NBitT2]: ...

    #
    @overload
    def __truediv__(self, other: inexact[_NBitT1] | _Complex64_co, /) -> Self: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __truediv__(self, other: number[_NBitT], /) -> complexfloating[_NBitT | _NBitT1, _NBitT | _NBitT2]: ...

    #
    @overload
    def __rtruediv__(self, other: inexact[_NBitT1] | _Complex64_co, /) -> Self: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __rtruediv__(self, other: number[_NBitT], /) -> complexfloating[_NBitT | _NBitT1, _NBitT | _NBitT2]: ...

    #
    @overload
    def __pow__(self, other: inexact[_NBitT1] | _Complex64_co, /) -> Self: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __pow__(self, other: number[_NBitT], /) -> complexfloating[_NBitT | _NBitT1, _NBitT | _NBitT2]: ...

    #
    @overload
    def __rpow__(self, other: inexact[_NBitT1] | _Complex64_co, /) -> Self: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __rpow__(self, other: number[_NBitT], /) -> complexfloating[_NBitT | _NBitT1, _NBitT | _NBitT2]: ...
...
class complex128(complexfloating[_64Bit], complex):  # type: ignore[misc]
    ...
    @overload
    def __add__(self, rhs: inexact[_NBitT], /) -> complexfloating[_NBitT | _64Bit]: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    @overload
    def __sub__(self, rhs: inexact[_NBitT], /) -> complexfloating[_NBitT | _64Bit]: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    @overload
    def __mul__(self, rhs: inexact[_NBitT], /) -> complexfloating[_NBitT | _64Bit]: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    @overload
    def __truediv__(self, rhs: inexact[_NBitT], /) -> complexfloating[_NBitT | _64Bit]: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    @overload
    def __pow__(self, rhs: inexact[_NBitT], /) -> complexfloating[_NBitT | _64Bit]: ...  # pyright: ignore[reportIncompatibleMethodOverride]
...
class datetime64(_RealMixin, generic[_DT64ItemT_co], Generic[_DT64ItemT_co]):
    ...
    #
    @overload
    def __add__(self: datetime64[_AnyDT64Item], x: int | integer | bool_, /) -> datetime64[_AnyDT64Item]: ...
    @overload
    ...
    @overload
    def __sub__(self: datetime64[_AnyDT64Item], x: int | integer | bool_, /) -> datetime64[_AnyDT64Item]: ...
    @overload
    ...
    #
    @overload
    def __rsub__(self: datetime64[_AnyDT64Item], x: int | integer | bool_, /) -> datetime64[_AnyDT64Item]: ...
    @overload
...
absolute: Final[_UFunc_Nin1_Nout1[L["absolute"], L[20]]] = ...
arccos: Final[_UFunc_Nin1_Nout1[L["arccos"], L[8]]] = ...
arccosh: Final[_UFunc_Nin1_Nout1[L["arccosh"], L[8]]] = ...
arcsin: Final[_UFunc_Nin1_Nout1[L["arcsin"], L[8]]] = ...
arcsinh: Final[_UFunc_Nin1_Nout1[L["arcsinh"], L[8]]] = ...
arctan: Final[_UFunc_Nin1_Nout1[L["arctan"], L[8]]] = ...
arctanh: Final[_UFunc_Nin1_Nout1[L["arctanh"], L[8]]] = ...
bitwise_count: Final[_UFunc_Nin1_Nout1[L["bitwise_count"], L[11]]] = ...
bitwise_not: Final[_UFunc_Nin1_Nout1[L["invert"], L[12]]] = ...
cbrt: Final[_UFunc_Nin1_Nout1[L["cbrt"], L[5]]] = ...
ceil: Final[_UFunc_Nin1_Nout1[L["ceil"], L[7]]] = ...
conj: Final[_UFunc_Nin1_Nout1[L["conjugate"], L[18]]] = ...
conjugate: Final[_UFunc_Nin1_Nout1[L["conjugate"], L[18]]] = ...
cos: Final[_UFunc_Nin1_Nout1[L["cos"], L[9]]] = ...
cosh: Final[_UFunc_Nin1_Nout1[L["cosh"], L[8]]] = ...
deg2rad: Final[_UFunc_Nin1_Nout1[L["deg2rad"], L[5]]] = ...
degrees: Final[_UFunc_Nin1_Nout1[L["degrees"], L[5]]] = ...
exp2: Final[_UFunc_Nin1_Nout1[L["exp2"], L[8]]] = ...
exp: Final[_UFunc_Nin1_Nout1[L["exp"], L[10]]] = ...
expm1: Final[_UFunc_Nin1_Nout1[L["expm1"], L[8]]] = ...
fabs: Final[_UFunc_Nin1_Nout1[L["fabs"], L[5]]] = ...
floor: Final[_UFunc_Nin1_Nout1[L["floor"], L[7]]] = ...
invert: Final[_UFunc_Nin1_Nout1[L["invert"], L[12]]] = ...
isfinite: Final[_UFunc_Nin1_Nout1[L["isfinite"], L[20]]] = ...
isinf: Final[_UFunc_Nin1_Nout1[L["isinf"], L[20]]] = ...
isnan: Final[_UFunc_Nin1_Nout1[L["isnan"], L[20]]] = ...
isnat: Final[_UFunc_Nin1_Nout1[L["isnat"], L[2]]] = ...
log10: Final[_UFunc_Nin1_Nout1[L["log10"], L[8]]] = ...
log1p: Final[_UFunc_Nin1_Nout1[L["log1p"], L[8]]] = ...
log2: Final[_UFunc_Nin1_Nout1[L["log2"], L[8]]] = ...
log: Final[_UFunc_Nin1_Nout1[L["log"], L[10]]] = ...
logical_not: Final[_UFunc_Nin1_Nout1[L["logical_not"], L[20]]] = ...
negative: Final[_UFunc_Nin1_Nout1[L["negative"], L[19]]] = ...
positive: Final[_UFunc_Nin1_Nout1[L["positive"], L[19]]] = ...
rad2deg: Final[_UFunc_Nin1_Nout1[L["rad2deg"], L[5]]] = ...
radians: Final[_UFunc_Nin1_Nout1[L["radians"], L[5]]] = ...
reciprocal: Final[_UFunc_Nin1_Nout1[L["reciprocal"], L[18]]] = ...
rint: Final[_UFunc_Nin1_Nout1[L["rint"], L[10]]] = ...
sign: Final[_UFunc_Nin1_Nout1[L["sign"], L[19]]] = ...
signbit: Final[_UFunc_Nin1_Nout1[L["signbit"], L[4]]] = ...
sin: Final[_UFunc_Nin1_Nout1[L["sin"], L[9]]] = ...
sinh: Final[_UFunc_Nin1_Nout1[L["sinh"], L[8]]] = ...
spacing: Final[_UFunc_Nin1_Nout1[L["spacing"], L[4]]] = ...
sqrt: Final[_UFunc_Nin1_Nout1[L["sqrt"], L[10]]] = ...
square: Final[_UFunc_Nin1_Nout1[L["square"], L[18]]] = ...
tan: Final[_UFunc_Nin1_Nout1[L["tan"], L[8]]] = ...
tanh: Final[_UFunc_Nin1_Nout1[L["tanh"], L[8]]] = ...
trunc: Final[_UFunc_Nin1_Nout1[L["trunc"], L[7]]] = ...

add: Final[_UFunc_Nin2_Nout1[L["add"], L[22], L[0]]] = ...
arctan2: Final[_UFunc_Nin2_Nout1[L["arctan2"], L[5]]] = ...
...
copysign: Final[_UFunc_Nin2_Nout1[L["copysign"], L[4]]] = ...
divide: Final[_UFunc_Nin2_Nout1[L["true_divide"], L[11]]] = ...
equal: Final[_UFunc_Nin2_Nout1[L["equal"], L[23]]] = ...
float_power: Final[_UFunc_Nin2_Nout1[L["float_power"], L[4]]] = ...
floor_divide: Final[_UFunc_Nin2_Nout1[L["floor_divide"], L[21]]] = ...
fmax: Final[_UFunc_Nin2_Nout1[L["fmax"], L[21]]] = ...
fmin: Final[_UFunc_Nin2_Nout1[L["fmin"], L[21]]] = ...
fmod: Final[_UFunc_Nin2_Nout1[L["fmod"], L[15]]] = ...
gcd: Final[_UFunc_Nin2_Nout1[L["gcd"], L[11], L[0]]] = ...
greater: Final[_UFunc_Nin2_Nout1[L["greater"], L[23]]] = ...
greater_equal: Final[_UFunc_Nin2_Nout1[L["greater_equal"], L[23]]] = ...
heaviside: Final[_UFunc_Nin2_Nout1[L["heaviside"], L[4]]] = ...
hypot: Final[_UFunc_Nin2_Nout1[L["hypot"], L[5], L[0]]] = ...
lcm: Final[_UFunc_Nin2_Nout1[L["lcm"], L[11]]] = ...
ldexp: Final[_UFunc_Nin2_Nout1[L["ldexp"], L[8]]] = ...
left_shift: Final[_UFunc_Nin2_Nout1[L["left_shift"], L[11]]] = ...
less: Final[_UFunc_Nin2_Nout1[L["less"], L[23]]] = ...
less_equal: Final[_UFunc_Nin2_Nout1[L["less_equal"], L[23]]] = ...
...
maximum: Final[_UFunc_Nin2_Nout1[L["maximum"], L[21]]] = ...
minimum: Final[_UFunc_Nin2_Nout1[L["minimum"], L[21]]] = ...
mod: Final[_UFunc_Nin2_Nout1[L["remainder"], L[16]]] = ...
multiply: Final[_UFunc_Nin2_Nout1[L["multiply"], L[23], L[1]]] = ...
nextafter: Final[_UFunc_Nin2_Nout1[L["nextafter"], L[4]]] = ...
not_equal: Final[_UFunc_Nin2_Nout1[L["not_equal"], L[23]]] = ...
power: Final[_UFunc_Nin2_Nout1[L["power"], L[18]]] = ...
remainder: Final[_UFunc_Nin2_Nout1[L["remainder"], L[16]]] = ...
right_shift: Final[_UFunc_Nin2_Nout1[L["right_shift"], L[11]]] = ...
subtract: Final[_UFunc_Nin2_Nout1[L["subtract"], L[21]]] = ...
true_divide: Final[_UFunc_Nin2_Nout1[L["true_divide"], L[11]]] = ...
...
frexp: Final[_UFunc_Nin1_Nout2[L["frexp"], L[4]]] = ...
modf: Final[_UFunc_Nin1_Nout2[L["modf"], L[4]]] = ...

divmod: Final[_UFunc_Nin2_Nout2[L["divmod"], L[15]]] = ...
