...
class integer(_IntegralMixin, _RoundMixin, number[_BitT, int]):
    ...
    @overload  # the  `| complex128` is a workaround for mypys
...
class float64(floating[_n._64], float):  # type: ignore[misc]
    ...
    # NOTE: The reported LSP violations below are safe to ignore
...
class complex128(complexfloating[_n._64], complex):
    ...
    @overload
    def __add__(self, x: _nt.CanArray0D[longdouble], /) -> clongdouble: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    @overload
    def __rtruediv__(self, x: _nt.ToLongDouble_0d, /) -> clongdouble: ...  # pyright: ignore[reportIncompatibleMethodOverride]
