...
_RealNumericT = TypeVar("_RealNumericT", bound=bool_ | integer | floating | object_)
...
class integer(_IntegralMixin, _RoundMixin, number[_BitT, int]):
    ...
    @overload
    def __floordiv__(self, x: _nt.PromoteWith0D[Self, _RealNumericT], /) -> _RealNumericT: ...
    ...
    @overload
    def __rfloordiv__(self, x: _nt.PromoteWith0D[Self, _RealNumericT], /) -> _RealNumericT: ...
    ...
    @overload
    def __mod__(self, x: _nt.PromoteWith0D[Self, _RealNumericT], /) -> _RealNumericT: ...
    ...
    @overload
    def __rmod__(self, x: _nt.PromoteWith0D[Self, _RealNumericT], /) -> _RealNumericT: ...
    ...
    @overload
    def __divmod__(self, x: _nt.PromoteWith0D[Self, _RealNumericT], /) -> _2Tuple[_RealNumericT]: ...
    ...
    @overload
    def __rdivmod__(self, x: _nt.PromoteWith0D[Self, _RealNumericT], /) -> _2Tuple[_RealNumericT]: ...
