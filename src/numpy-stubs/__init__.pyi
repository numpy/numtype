...
_JustInteger: TypeAlias = _nt.Just[integer] | _JustSignedInteger | _JustUnsignedInteger
_JustFloating: TypeAlias = _nt.Just[floating]
_JustComplexFloating: TypeAlias = _nt.Just[complexfloating]
_JustInexact: TypeAlias = _nt.Just[inexact] | _JustFloating | _JustComplexFloating
_JustNumber: TypeAlias = (
    _nt.Just[number]
    | _nt.Just[integer]
    | _nt.Just[inexact]
    | _JustSignedInteger
    | _JustUnsignedInteger
    | _JustFloating
    | _JustComplexFloating
)

_CoInt8: TypeAlias = int | _nt.CanArray0D[_nt.co_int8]
_CoUInt8: TypeAlias = int | _nt.CanArray0D[_nt.co_uint8]
_CoInt16: TypeAlias = int | _nt.CanArray0D[_nt.co_int16]
_CoUInt16: TypeAlias = int | _nt.CanArray0D[_nt.co_uint16]
_CoInt32: TypeAlias = int | _nt.CanArray0D[_nt.co_int32]
_CoUInt32: TypeAlias = int | _nt.CanArray0D[_nt.co_uint32]
_CoInt64: TypeAlias = int | _nt.CanArray0D[signedinteger | bool_]
_CoUInt64: TypeAlias = int | _nt.CanArray0D[unsignedinteger | bool_]
...
class integer(_IntegralMixin, _RoundMixin, number[_BitT, int]):
    ...
    @overload
    def __lshift__(self, x: _nt.CanArray0D[unsignedinteger], /) -> unsignedinteger: ...
    @overload
...
class signedinteger(integer[_BitT]):
    ...
    @overload
    def __add__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __add__(self, x: _JustUnsignedInteger, /) -> signedinteger | float64: ...
    ...
    @overload
    def __sub__(self, x: _JustUnsignedInteger, /) -> signedinteger | float64: ...
    ...
    @overload
    def __mul__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __mul__(self, x: _JustUnsignedInteger, /) -> signedinteger | float64: ...
    ...
    @overload
    def __pow__(self, x: _JustSignedInteger, mod: None = None, /) -> signedinteger: ...
    @overload
    def __pow__(self, x: _JustUnsignedInteger, mod: None = None, /) -> signedinteger | float64: ...
    ...
    @overload
    def __floordiv__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __floordiv__(self, x: _JustUnsignedInteger, /) -> signedinteger | float64: ...
    ...
    @overload
    def __mod__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __mod__(self, x: _JustUnsignedInteger, /) -> signedinteger | float64: ...
    ...
    @overload
    def __divmod__(self, x: _JustSignedInteger, /) -> _2Tuple[signedinteger]: ...
    @overload
    def __divmod__(self, x: _JustUnsignedInteger, /) -> _2Tuple[signedinteger | float64]: ...

    #
    @overload  # type: ignore[override]
    def __lshift__(self, x: _CoInt8, /) -> Self: ...
    @overload
    def __lshift__(self, x: _JustSignedInteger, /) -> signedinteger: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    # keep in sync with __lshift__
    @overload  # type: ignore[override]
    def __rshift__(self, x: _CoInt8, /) -> Self: ...
    @overload
    def __rshift__(self, x: _JustSignedInteger, /) -> signedinteger: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    # keep in sync with __lshift__
    @overload  # type: ignore[override]
    def __and__(self, x: _CoInt8, /) -> Self: ...
    @overload
    def __and__(self, x: _JustSignedInteger, /) -> signedinteger: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    # keep in sync with __lshift__
    @overload  # type: ignore[override]
    def __xor__(self, x: _CoInt8, /) -> Self: ...
    @overload
    def __xor__(self, x: _JustSignedInteger, /) -> signedinteger: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    # keep in sync with __lshift__
    @overload  # type: ignore[override]
    def __or__(self, x: _CoInt8, /) -> Self: ...
    @overload
    def __or__(self, x: _JustSignedInteger, /) -> signedinteger: ...  # pyright: ignore[reportIncompatibleMethodOverride]
...
class unsignedinteger(integer[_BitT]):
    ...
    def __add__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __add__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __add__(self, x: _JustSignedInteger, /) -> signedinteger | float64: ...
    ...
    def __radd__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __radd__(self, x: _JustSignedInteger, /) -> float64 | signedinteger: ...
    ...
    def __rsub__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rsub__(self, x: _JustSignedInteger, /) -> float64 | signedinteger: ...
    ...
    def __mul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __mul__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __mul__(self, x: _JustSignedInteger, /) -> signedinteger | float64: ...
    ...
    def __rmul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rmul__(self, x: _JustSignedInteger, /) -> float64 | signedinteger: ...
    ...
    def __pow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __pow__(self, x: _JustUnsignedInteger, mod: None = None, /) -> unsignedinteger: ...
    @overload
    def __pow__(self, x: _JustSignedInteger, mod: None = None, /) -> signedinteger | float64: ...
    ...
    def __rpow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __rpow__(self, x: _JustSignedInteger, mod: None = None, /) -> float64 | signedinteger: ...
    ...
    def __floordiv__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __floordiv__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __floordiv__(self, x: _JustSignedInteger, /) -> signedinteger | float64: ...

    # keep in sync with __radd__ (minus the complex overload)
    @overload
    def __rfloordiv__(self, x: int, /) -> Self: ...
    @overload
    def __rfloordiv__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rfloordiv__(self, x: _JustSignedInteger, /) -> float64 | signedinteger: ...
    ...
    def __mod__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __mod__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __mod__(self, x: _JustSignedInteger, /) -> signedinteger | float64: ...
    ...
    def __rmod__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rmod__(self, x: _JustSignedInteger, /) -> float64 | signedinteger: ...
    ...
    def __divmod__(self, x: _nt.JustFloat, /) -> _2Tuple[float64]: ...
    @overload
    def __divmod__(self, x: _JustUnsignedInteger, /) -> _2Tuple[unsignedinteger]: ...
    @overload
    def __divmod__(self, x: _JustSignedInteger, /) -> _2Tuple[signedinteger | float64]: ...
    ...
    def __rdivmod__(self, x: _nt.JustFloat, /) -> _2Tuple[float64]: ...
    @overload
    def __rdivmod__(self, x: _JustSignedInteger, /) -> _2Tuple[float64 | signedinteger]: ...
...
class complexfloating(inexact[_BitT1, complex], Generic[_BitT1, _BitT2]):
    ...
    @abc.abstractmethod
    @overload
    def __rsub__(self, x: _JustNumber, /) -> complexfloating: ...
    ...
    @abc.abstractmethod
    @overload
    def __rmul__(self, x: _JustNumber, /) -> complexfloating: ...
    ...
    @abc.abstractmethod
    @overload
    def __rpow__(self, x: _JustNumber, mod: None = None, /) -> complexfloating: ...
    ...
    @abc.abstractmethod
    @overload
    def __rtruediv__(self, x: _JustNumber, /) -> complexfloating: ...
...
class _IntROpMixin(Generic[_T_co]):
    ...
    def __radd__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __radd__(self, x: _JustSignedInteger, /) -> _T_co: ...
    @overload
    def __radd__(self, x: _JustUnsignedInteger, /) -> _T_co | float64: ...
    ...
    @overload
    def __rsub__(self, x: _JustUnsignedInteger, /) -> _T_co | float64: ...
    ...
    def __rmul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rmul__(self, x: _JustSignedInteger, /) -> _T_co: ...
    @overload
    def __rmul__(self, x: _JustUnsignedInteger, /) -> _T_co | float64: ...
    ...
    def __rpow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __rpow__(self, x: _JustSignedInteger, mod: None = None, /) -> _T_co: ...
    @overload
    def __rpow__(self, x: _JustUnsignedInteger, mod: None = None, /) -> _T_co | float64: ...
    ...
    def __rfloordiv__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rfloordiv__(self, x: _JustSignedInteger, /) -> _T_co: ...
    @overload
    def __rfloordiv__(self, x: _JustUnsignedInteger, /) -> _T_co | float64: ...
    ...
    def __rmod__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rmod__(self, x: _JustSignedInteger, /) -> _T_co: ...
    @overload
    def __rmod__(self, x: _JustUnsignedInteger, /) -> _T_co | float64: ...
    ...
    def __rdivmod__(self, x: _nt.JustFloat, /) -> _2Tuple[float64]: ...
    @overload
    def __rdivmod__(self, x: _JustSignedInteger, /) -> _2Tuple[_T_co]: ...
    @overload
    def __rdivmod__(self, x: _JustUnsignedInteger, /) -> _2Tuple[_T_co | float64]: ...

    #
    @overload
    def __rlshift__(self, x: int, /) -> Self: ...
    @overload
    def __rlshift__(self, x: _JustSignedInteger | _nt.Just[unsignedinteger] | _nt.Just[integer], /) -> _T_co: ...

    #
    @overload
    def __rrshift__(self, x: int, /) -> Self: ...
    @overload
    def __rrshift__(self, x: _JustSignedInteger | _nt.Just[unsignedinteger] | _nt.Just[integer], /) -> _T_co: ...

    #
    @overload
    def __rand__(self, x: int, /) -> Self: ...
    @overload
    def __rand__(self, x: _JustSignedInteger | _nt.Just[unsignedinteger] | _nt.Just[integer], /) -> _T_co: ...

    #
    @overload
    def __rxor__(self, x: int, /) -> Self: ...
    @overload
    def __rxor__(self, x: _JustSignedInteger | _nt.Just[unsignedinteger] | _nt.Just[integer], /) -> _T_co: ...

    #
    @overload
    def __ror__(self, x: int, /) -> Self: ...
    @overload
    def __ror__(self, x: _JustSignedInteger | _nt.Just[unsignedinteger] | _nt.Just[integer], /) -> _T_co: ...
...
class int8(_IntROpMixin[signedinteger], signedinteger[_n._8]):
    ...
    @overload
    def __lshift__(self, x: _JustUnsignedInteger, /) -> signedinteger: ...
    ...
    @overload
    def __rshift__(self, x: _JustUnsignedInteger, /) -> signedinteger: ...
    ...
    @overload
    def __and__(self, x: _JustUnsignedInteger, /) -> signedinteger: ...
    ...
    @overload
    def __xor__(self, x: _JustUnsignedInteger, /) -> signedinteger: ...
    ...
    @overload
    def __or__(self, x: _JustUnsignedInteger, /) -> signedinteger: ...
...
class uint8(unsignedinteger[_n._8]):
    ...
    def __add__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __add__(self, x: _nt.CanArray0D[_UnsignedIntegerT], /) -> _UnsignedIntegerT: ...
    @overload
    def __add__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __add__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    def __add__(self, x: _nt.CanArray0D[int16 | int8], /) -> int16: ...

    #
    @overload
    def __radd__(self, x: _CoUInt8, /) -> Self: ...
    @overload
    def __radd__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __radd__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __radd__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __radd__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __radd__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    ...
    @overload
    def __sub__(self, x: _nt.CanArray0D[int16 | int8], /) -> int16: ...

    #
    @overload
    def __rsub__(self, x: _CoUInt8, /) -> Self: ...
    @overload
    def __rsub__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rsub__(self, x: _nt.JustComplex, /) -> complex128: ...
    ...
    @overload
    def __rsub__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rsub__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    ...
    def __mul__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __mul__(self, x: _nt.CanArray0D[_UnsignedIntegerT], /) -> _UnsignedIntegerT: ...
    @overload
    def __mul__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __mul__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    def __mul__(self, x: _nt.CanArray0D[int16 | int8], /) -> int16: ...

    #
    @overload
    def __rmul__(self, x: _CoUInt8, /) -> Self: ...
    @overload
    def __rmul__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rmul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rmul__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __rmul__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    ...
    def __pow__(self, x: _JustSignedInteger, mod: None = None, /) -> signedinteger: ...
    @overload
    def __pow__(self, x: _nt.CanArray0D[_UnsignedIntegerT], mod: None = None, /) -> _UnsignedIntegerT: ...
    @overload
    def __pow__(self, x: _nt.CanArray0D[int64], mod: None = None, /) -> int64: ...
    @overload
    def __pow__(self, x: _nt.CanArray0D[int32], mod: None = None, /) -> int32: ...
    @overload
    def __pow__(self, x: _nt.CanArray0D[int16 | int8], mod: None = None, /) -> int16: ...

    #
    @overload
    def __rpow__(self, x: _CoUInt8, mod: None = None, /) -> Self: ...
    @overload
    def __rpow__(self, x: _nt.JustFloat, mod: None = None, /) -> float64: ...
    @overload
    def __rpow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __rpow__(self, x: _JustSignedInteger, mod: None = None, /) -> signedinteger: ...
    @overload
    def __rpow__(self, x: _nt.CanArray0D[int64], mod: None = None, /) -> int64: ...
    @overload
    def __rpow__(self, x: _nt.CanArray0D[int32], mod: None = None, /) -> int32: ...
    @overload
    ...
    def __floordiv__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __floordiv__(self, x: _nt.CanArray0D[_UnsignedIntegerT], /) -> _UnsignedIntegerT: ...
    @overload
    def __floordiv__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __floordiv__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    ...
    def __rfloordiv__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rfloordiv__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __rfloordiv__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rfloordiv__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    ...
    def __mod__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __mod__(self, x: _nt.CanArray0D[_UnsignedIntegerT], /) -> _UnsignedIntegerT: ...
    @overload
    def __mod__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __mod__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    ...
    def __rmod__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rmod__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __rmod__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rmod__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    ...
    def __divmod__(self, x: _JustSignedInteger, /) -> _2Tuple[signedinteger]: ...
    @overload
    def __divmod__(self, x: _nt.CanArray0D[_UnsignedIntegerT], /) -> _2Tuple[_UnsignedIntegerT]: ...
    @overload
    def __divmod__(self, x: _nt.CanArray0D[int64], /) -> _2Tuple[int64]: ...
    @overload
    def __divmod__(self, x: _nt.CanArray0D[int32], /) -> _2Tuple[int32]: ...
    @overload
    ...
    def __rdivmod__(self, x: _nt.JustFloat, /) -> _2Tuple[float64]: ...
    @overload
    def __rdivmod__(self, x: _JustSignedInteger, /) -> _2Tuple[signedinteger]: ...
    @overload
    def __rdivmod__(self, x: _nt.CanArray0D[int64], /) -> _2Tuple[int64]: ...
    @overload
    def __rdivmod__(self, x: _nt.CanArray0D[int32], /) -> _2Tuple[int32]: ...
    @overload
    ...
    def __lshift__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __lshift__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __lshift__(self, x: _nt.CanArray0D[_UnsignedIntegerT], /) -> _UnsignedIntegerT: ...
    @overload
    def __lshift__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __lshift__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    def __lshift__(self, x: _nt.CanArray0D[int16 | int8], /) -> int16: ...
    ...
    def __rlshift__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __rlshift__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rlshift__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    ...
    def __rshift__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __rshift__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __rshift__(self, x: _nt.CanArray0D[_UnsignedIntegerT], /) -> _UnsignedIntegerT: ...
    @overload
    def __rshift__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rshift__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    def __rshift__(self, x: _nt.CanArray0D[int16 | int8], /) -> int16: ...
    ...
    def __rrshift__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __rrshift__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rrshift__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    ...
    def __and__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __and__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __and__(self, x: _nt.CanArray0D[_UnsignedIntegerT], /) -> _UnsignedIntegerT: ...
    @overload
    def __and__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __and__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    def __and__(self, x: _nt.CanArray0D[int16 | int8], /) -> int16: ...
    ...
    def __rand__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __rand__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rand__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    ...
    def __xor__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __xor__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __xor__(self, x: _nt.CanArray0D[_UnsignedIntegerT], /) -> _UnsignedIntegerT: ...
    @overload
    def __xor__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __xor__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    def __xor__(self, x: _nt.CanArray0D[int16 | int8], /) -> int16: ...
    ...
    def __rxor__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __rxor__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rxor__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    ...
    def __or__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __or__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __or__(self, x: _nt.CanArray0D[_UnsignedIntegerT], /) -> _UnsignedIntegerT: ...
    @overload
    def __or__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __or__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    def __or__(self, x: _nt.CanArray0D[int16 | int8], /) -> int16: ...
    ...
    def __ror__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __ror__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __ror__(self, x: _nt.CanArray0D[int32], /) -> int32: ...
    @overload
    def __ror__(self, x: _nt.CanArray0D[int16 | int8], /) -> int16: ...
...
class int16(_IntROpMixin[signedinteger], signedinteger[_n._16]):
    ...
    def __add__(self, x: _JustUnsignedInteger, /) -> signedinteger | float64: ...
    @overload
    def __add__(self, x: _nt.CanArray0D[int32 | uint16], /) -> int32: ...
    @overload
    ...
    def __mul__(self, x: _JustUnsignedInteger, /) -> signedinteger | float64: ...
    @overload
    def __mul__(self, x: _nt.CanArray0D[int32 | uint16], /) -> int32: ...
    @overload
    ...
    def __pow__(self, x: _JustUnsignedInteger, mod: None = None, /) -> signedinteger | float64: ...
    @overload
    def __pow__(self, x: _nt.CanArray0D[int32 | uint16], mod: None = None, /) -> int32: ...
    @overload
    ...
    def __floordiv__(self, x: _JustUnsignedInteger, /) -> signedinteger | float64: ...
    @overload
    def __floordiv__(self, x: _nt.CanArray0D[int32 | uint16], /) -> int32: ...
    @overload
    ...
    def __mod__(self, x: _JustUnsignedInteger, /) -> signedinteger | float64: ...
    @overload
    def __mod__(self, x: _nt.CanArray0D[int32 | uint16], /) -> int32: ...
    @overload
    ...
    def __divmod__(self, x: _JustUnsignedInteger, /) -> _2Tuple[signedinteger | float64]: ...
    @overload
    def __divmod__(self, x: _nt.CanArray0D[int32 | uint16], /) -> _2Tuple[int32]: ...
    @overload
...
class uint16(unsignedinteger[_n._16]):
    ...
    def __add__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __add__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __add__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    ...
    def __radd__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __radd__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    ...
    def __sub__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __sub__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __sub__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    ...
    def __rsub__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rsub__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    ...
    def __mul__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __mul__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __mul__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    ...
    def __rmul__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rmul__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    ...
    def __pow__(self, x: _JustSignedInteger, mod: None = None, /) -> signedinteger: ...
    @overload
    def __pow__(self, x: _nt.CanArray0D[int32 | int16 | int8], mod: None = None, /) -> int32: ...
    @overload
    def __pow__(self, x: _nt.CanArray0D[int64], mod: None = None, /) -> int64: ...
    ...
    def __rpow__(self, x: _nt.CanArray0D[int64], mod: None = None, /) -> int64: ...
    @overload
    def __rpow__(self, x: _nt.CanArray0D[int32 | int16 | int8], mod: None = None, /) -> int32: ...
    @overload
    ...
    def __floordiv__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __floordiv__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __floordiv__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    ...
    def __rfloordiv__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rfloordiv__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __rfloordiv__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __mod__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __mod__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __mod__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    ...
    def __rmod__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rmod__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __rmod__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __divmod__(self, x: _JustSignedInteger, /) -> _2Tuple[signedinteger]: ...
    @overload
    def __divmod__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> _2Tuple[int32]: ...
    @overload
    def __divmod__(self, x: _nt.CanArray0D[int64], /) -> _2Tuple[int64]: ...
    ...
    def __rdivmod__(self, x: _nt.CanArray0D[int64], /) -> _2Tuple[int64]: ...
    @overload
    def __rdivmod__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> _2Tuple[int32]: ...
    @overload
    def __rdivmod__(self, x: _JustUnsignedInteger, /) -> _2Tuple[unsignedinteger]: ...
    ...
    def __lshift__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __lshift__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __lshift__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    ...
    def __rlshift__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rlshift__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __rlshift__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __rshift__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __rshift__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __rshift__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    ...
    def __rrshift__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rrshift__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __rrshift__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __and__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __and__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __and__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    ...
    def __rand__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rand__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __rand__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __xor__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __xor__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __xor__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    ...
    def __rxor__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __rxor__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __rxor__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __or__(self, x: _JustSignedInteger, /) -> signedinteger: ...
    @overload
    def __or__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __or__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    ...
    def __ror__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    @overload
    def __ror__(self, x: _nt.CanArray0D[int32 | int16 | int8], /) -> int32: ...
    @overload
    def __ror__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
...
class uint32(unsignedinteger[_n._32]):
    ...
    def __add__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __add__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...

    #
    @overload
    def __radd__(self, x: _CoUInt32, /) -> Self: ...
    @overload
    def __radd__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __radd__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __radd__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...
    @overload
    def __radd__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __sub__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __sub__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...
    ...
    def __rsub__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rsub__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...
    @overload
    def __rsub__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __mul__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __mul__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...

    #
    @overload
    def __rmul__(self, x: _CoUInt32, /) -> Self: ...
    @overload
    def __rmul__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rmul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rmul__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...
    @overload
    def __rmul__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __pow__(self, x: _JustUnsignedInteger, mod: None = None, /) -> unsignedinteger: ...
    @overload
    def __pow__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], mod: None = None, /) -> int64: ...

    #
    @overload
    def __rpow__(self, x: _CoUInt32, mod: None = None, /) -> Self: ...
    @overload
    def __rpow__(self, x: _nt.JustFloat, mod: None = None, /) -> float64: ...
    @overload
    def __rpow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __rpow__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], mod: None = None, /) -> int64: ...
    @overload
    def __rpow__(self, x: _JustUnsignedInteger, mod: None = None, /) -> unsignedinteger: ...
    ...
    def __floordiv__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __floordiv__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...
    ...
    def __rfloordiv__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rfloordiv__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...
    @overload
    def __rfloordiv__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __mod__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __mod__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...
    ...
    def __rmod__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rmod__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...
    @overload
    def __rmod__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __divmod__(self, x: _JustUnsignedInteger, /) -> _2Tuple[unsignedinteger]: ...
    @overload
    def __divmod__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> _2Tuple[int64]: ...
    ...
    def __rdivmod__(self, x: _nt.JustFloat, /) -> _2Tuple[float64]: ...
    @overload
    def __rdivmod__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> _2Tuple[int64]: ...
    @overload
    def __rdivmod__(self, x: _JustUnsignedInteger, /) -> _2Tuple[unsignedinteger]: ...
    ...
    def __lshift__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __lshift__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...

    #
    @overload
    def __rlshift__(self, x: _CoUInt32, /) -> Self: ...
    @overload
    def __rlshift__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...
    @overload
    def __rlshift__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __rshift__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __rshift__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...

    #
    @overload
    def __rrshift__(self, x: _CoUInt32, /) -> Self: ...
    @overload
    def __rrshift__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...
    @overload
    def __rrshift__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __and__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __and__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...

    #
    @overload
    def __rand__(self, x: _CoUInt32, /) -> Self: ...
    @overload
    def __rand__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...
    @overload
    def __rand__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __xor__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __xor__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...

    #
    @overload
    def __rxor__(self, x: _CoUInt32, /) -> Self: ...
    @overload
    def __rxor__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...
    @overload
    def __rxor__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    ...
    def __or__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
    @overload
    def __or__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...

    #
    @overload
    def __ror__(self, x: _CoUInt32, /) -> Self: ...
    @overload
    def __ror__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> int64: ...
    @overload
    def __ror__(self, x: _JustUnsignedInteger, /) -> unsignedinteger: ...
...
class int64(_IntROpMixin[int64], signedinteger[_n._64]):
    ...
    def __add__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __add__(self, x: _JustUnsignedInteger, /) -> Self | float64: ...
    ...
    def __sub__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __sub__(self, x: _JustUnsignedInteger, /) -> Self | float64: ...
    ...
    def __mul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __mul__(self, x: _JustUnsignedInteger, /) -> Self | float64: ...
    ...
    def __pow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __pow__(self, x: _JustUnsignedInteger, mod: None = None, /) -> Self | float64: ...
    ...
    def __floordiv__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __floordiv__(self, x: _JustUnsignedInteger, /) -> Self | float64: ...
    ...
    def __mod__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __mod__(self, x: _JustUnsignedInteger, /) -> Self | float64: ...
    ...
    def __divmod__(self, x: _nt.JustFloat, /) -> _2Tuple[float64]: ...
    @overload
    def __divmod__(self, x: _JustUnsignedInteger, /) -> _2Tuple[Self | float64]: ...
    ...
    @overload
    def __lshift__(self, x: _JustUnsignedInteger, /) -> int64: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    #
    @overload  # type: ignore[override]
    def __rshift__(self, x: _CoInt64, /) -> Self: ...
    @overload
    def __rshift__(self, x: _JustUnsignedInteger, /) -> int64: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    #
    @overload  # type: ignore[override]
    def __and__(self, x: _CoInt64, /) -> Self: ...
    @overload
    def __and__(self, x: _JustUnsignedInteger, /) -> int64: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    #
    @overload  # type: ignore[override]
    def __xor__(self, x: _CoInt64, /) -> Self: ...
    @overload
    def __xor__(self, x: _JustUnsignedInteger, /) -> int64: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    #
    @overload  # type: ignore[override]
    def __or__(self, x: _CoInt64, /) -> Self: ...
    @overload
    def __or__(self, x: _JustUnsignedInteger, /) -> int64: ...  # pyright: ignore[reportIncompatibleMethodOverride]
...
class uint64(unsignedinteger[_n._64]):
    ...
    def __add__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __add__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> float64: ...

    #
    @overload
    def __radd__(self, x: _CoUInt64, /) -> Self: ...
    @overload
    def __radd__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __radd__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __radd__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> float64: ...
    @overload
    ...
    def __rsub__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rsub__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> float64: ...
    ...
    def __rmul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rmul__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> float64: ...
    ...
    def __rpow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __rpow__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], mod: None = None, /) -> float64: ...
    ...
    def __floordiv__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __floordiv__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> float64: ...

    # keep in sync with __floordiv__
    @overload
    def __rfloordiv__(self, x: _CoUInt64, /) -> Self: ...
    @overload
    def __rfloordiv__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rfloordiv__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> float64: ...
    ...
    def __mod__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __mod__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> float64: ...

    # keep in sync with __floordiv__
    @overload
    def __rmod__(self, x: _CoUInt64, /) -> Self: ...
    @overload
    def __rmod__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rmod__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> float64: ...
    ...
    def __rdivmod__(self, x: _nt.JustFloat, /) -> _2Tuple[float64]: ...
    @overload
    def __rdivmod__(self, x: _nt.CanArray0D[signedinteger] | _nt.Just[signedinteger], /) -> _2Tuple[float64]: ...

    #
    @override
    def __lshift__(self, x: _CoUInt64, /) -> Self: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]
    @override
    def __rlshift__(self, x: _CoUInt64, /) -> Self: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]

    #
    @override
    def __rshift__(self, x: _CoUInt64, /) -> Self: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]
    @override
    def __rrshift__(self, x: _CoUInt64, /) -> Self: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]

    #
    @override
    def __and__(self, x: _CoUInt64, /) -> Self: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]
    @override
    def __rand__(self, x: _CoUInt64, /) -> Self: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]

    #
    @override
    def __xor__(self, x: _CoUInt64, /) -> Self: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]
    @override
    def __rxor__(self, x: _CoUInt64, /) -> Self: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]

    #
    @override
    def __or__(self, x: _CoUInt64, /) -> Self: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]
    @override
    def __ror__(self, x: _CoUInt64, /) -> Self: ...  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride]
...
class float16(floating[_n._16]):
    ...
    @overload
    def __radd__(self, x: _nt.ToInteger_0d, /) -> floating: ...
    @overload
    ...
    @overload
    def __sub__(self, x: _nt.ToInteger_0d, /) -> floating: ...
    @overload
    ...
    @overload
    def __rsub__(self, x: _nt.ToInteger_0d, /) -> floating: ...
    @overload
    ...
    @overload
    def __mul__(self, x: _nt.ToInteger_0d, /) -> floating: ...
    @overload
    ...
    @overload
    def __rmul__(self, x: _nt.ToInteger_0d, /) -> floating: ...
    @overload
    ...
    @overload
    def __pow__(self, x: _nt.ToInteger_0d, k: None = None, /) -> floating: ...
    @overload
    ...
    @overload
    def __rpow__(self, x: _nt.ToInteger_0d, k: None = None, /) -> floating: ...
    @overload
    ...
    @overload
    def __truediv__(self, x: _nt.ToInteger_0d, /) -> floating: ...
    @overload
    ...
    @overload
    def __rtruediv__(self, x: _nt.ToInteger_0d, /) -> floating: ...
    @overload
    ...
    @overload
    def __floordiv__(self, x: _nt.ToInteger_0d, /) -> floating: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    @overload
    def __rfloordiv__(self, x: _nt.ToInteger_0d, /) -> floating: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    @overload
    def __mod__(self, x: _nt.ToInteger_0d, /) -> floating: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    @overload
    def __rmod__(self, x: _nt.ToInteger_0d, /) -> floating: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    @overload
    def __divmod__(self, x: _JustSignedInteger | _nt.Just[unsignedinteger] | _nt.Just[integer], /) -> _2Tuple[floating]: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    @overload
    def __rdivmod__(self, x: _JustSignedInteger | _nt.Just[unsignedinteger] | _nt.Just[integer], /) -> _2Tuple[floating]: ...  # pyright: ignore[reportIncompatibleMethodOverride]
...
class float32(floating[_n._32]):
    ...
    @overload
    def __pow__(self, x: _nt.ToInteger_0d, mod: None = None, /) -> floating: ...
    @overload
    ...
    @overload
    def __rpow__(self, x: _nt.ToInteger_0d, mod: None = None, /) -> floating: ...
    @overload
...
class complex128(complexfloating[_n._64], complex):
    ...
    def __add__(self, x: _JustNumber, /) -> complexfloating: ...
    @overload
    def __add__(self, x: _nt.CanArray0D[longdouble], /) -> clongdouble: ...
