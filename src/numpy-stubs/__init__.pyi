...
class floating(_RealMixin, _RoundMixin, inexact[_BitT, float]):
    ...
    #
    @overload
    def __radd__(self, x: float | _nt.CanArray0D[_nt.co_integer8], /) -> Self: ...
    @overload
    ...
    # keep in sync with `__radd__`
    @overload
    def __rsub__(self, x: float | _nt.CanArray0D[_nt.co_integer8], /) -> Self: ...
    @overload
    ...
    @overload
    def __rmul__(self, x: float | _nt.CanArray0D[_nt.co_integer8], /) -> Self: ...
    @overload
    ...
    @overload
    def __rpow__(self, x: float | _nt.CanArray0D[_nt.co_integer8], k: None = None, /) -> Self: ...
    @overload
    ...
    @overload
    def __rtruediv__(self, x: float | _nt.CanArray0D[_nt.co_integer8], /) -> Self: ...
    @overload
    ...
    @overload
    def __rfloordiv__(self, x: float | _nt.CanArray0D[_nt.co_integer8], /) -> Self: ...
    @overload
    ...
    @overload
    def __mod__(self, x: float | _nt.CanArray0D[Self | _nt.co_float16], /) -> Self: ...

    # keep in sync with `__rfloordiv__`
    @overload
    def __rmod__(self, x: float | _nt.CanArray0D[_nt.co_integer8], /) -> Self: ...
    @overload
    ...
    @overload
    def __divmod__(self, x: _nt.ToLongDouble_0d, /) -> _2Tuple[longdouble]: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def __divmod__(self, x: _nt.CanArray0D[Self | _nt.co_float16], /) -> _2Tuple[Self]: ...

    # keep in sync with `__rmod__`
    @overload
    def __rdivmod__(self, x: float | _nt.CanArray0D[_nt.co_integer8], /) -> _2Tuple[Self]: ...
    @overload
