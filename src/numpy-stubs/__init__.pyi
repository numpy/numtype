...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeT_co, _DTypeT_co]):
    ...
    #
    @overload
    def __pow__(self: NDArray[_NumberT], rhs: int | bool_, /) -> ndarray[_ShapeT_co, dtype[_NumberT]]: ...
    @overload
    def __pow__(self: NDArray[_NumberT], rhs: _ArrayLikeBool_co, /) -> NDArray[_NumberT]: ...
    @overload
    def __pow__(self: NDArray[bool_], rhs: _ArrayLike[_NumberT], /) -> NDArray[_NumberT]: ...
    @overload
    ...
    #
    @overload
    def __rpow__(self: NDArray[_NumberT], lhs: int | bool_, /) -> ndarray[_ShapeT_co, dtype[_NumberT]]: ...  # type: ignore[misc]
    @overload
    def __rpow__(self: NDArray[_NumberT], lhs: _ArrayLikeBool_co, /) -> NDArray[_NumberT]: ...
    @overload
    def __rpow__(self: NDArray[bool_], lhs: _ArrayLike[_NumberT], /) -> NDArray[_NumberT]: ...
    @overload
...
class number(generic[_NumberItemT_co], Generic[_NBitT, _NumberItemT_co]):
    ...
    def __pow__(self, x: Any, /) -> number: ...
    def __rpow__(self, x: Any, /) -> number: ...
...
class integer(_IntegralMixin, _RoundMixin, number[_NBitT, int]):
    ...
    @overload
    def __rpow__(self, x: floating[_64Bit], /) -> float64: ...  # type: ignore[misc]
    @overload
    def __rpow__(self, x: float, /) -> float64 | Self: ...
    @overload
    def __rpow__(self, x: complexfloating[_64Bit], /) -> complex128: ...
    @overload
...
class signedinteger(integer[_NBitT]):
    ...
    #  keep in sync with __add__
    @overload
    def __pow__(self, x: Self | int | int8 | bool_, /) -> Self: ...
    @overload
...
class unsignedinteger(integer[_NBitT]):
    ...
    @overload
    def __pow__(self, x: Self | int | uint8 | bool_, /) -> Self: ...
    @overload
...
class complexfloating(inexact[_NBitT1, complex], Generic[_NBitT1, _NBitT2]):
    ...
    # keep in sync with `__add__`
    @overload
    def __pow__(self, x: inexact[_NBitT1] | _Complex64_co, /) -> Self: ...
    @overload
    def __pow__(self, x: inexact[_128Bit] | inexact[_96Bit], /) -> clongdouble: ...
    @overload
    def __pow__(self: complexfloating[_128Bit] | complexfloating[_96Bit], x: number, /) -> clongdouble: ...
    @overload
    def __pow__(self: complexfloating[_64Bit], x: inexact[_64Bit] | inexact[_32Bit] | integer, /) -> complex128: ...  # type: ignore[overload-overlap]
    @overload
    def __pow__(self: complexfloating[_32Bit], x: number[_64Bit] | integer[_32Bit], /) -> complex128: ...
    @overload
    def __pow__(self: complexfloating[_32Bit], x: inexact[_32Bit] | number[_16Bit] | number[_8Bit], /) -> complex64: ...
    @overload
    def __pow__(self, x: complex, /) -> Self: ...

    # keep in sync with `__radd__`
    @overload
    def __rpow__(self, x: inexact[_NBitT1] | _Complex64_co, /) -> Self: ...  # type: ignore[misc]
    @overload
    def __rpow__(self, x: inexact[_128Bit] | inexact[_96Bit], /) -> clongdouble: ...
    @overload
    def __rpow__(self: complexfloating[_128Bit] | complexfloating[_96Bit], x: number, /) -> clongdouble: ...
    @overload
    def __rpow__(self: complexfloating[_64Bit], x: inexact[_64Bit] | inexact[_32Bit] | integer, /) -> complex128: ...  # type: ignore[overload-overlap]
    @overload
    def __rpow__(self: complexfloating[_32Bit], x: number[_64Bit] | integer[_32Bit], /) -> complex128: ...
    @overload
    def __rpow__(self: complexfloating[_32Bit], x: inexact[_32Bit] | number[_16Bit] | number[_8Bit], /) -> complex64: ...
    @overload
    def __rpow__(self, x: complex, /) -> Self: ...
