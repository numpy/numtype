...
class float64(floating[_n._64], float):  # type: ignore[misc]
    ...
    # keep in sync with `__add__`
    @overload  # type: ignore[override]
    def __pow__(self, x: _nt.CoFloat64_0d, k: None = None, /) -> Self: ...
    @overload
    def __pow__(self, x: _nt.JustComplex, k: None = None, /) -> complex128: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    @overload
    def __rpow__(self, x: _nt.CoFloat64_0d, k: None = None, /) -> Self: ...
    @overload
    def __rpow__(self, x: _nt.JustComplex, k: None = None, /) -> complex128: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    #
    @override
    def __floordiv__(self, x: _nt.CoFloat64_0d, /) -> Self: ...
    @override
    def __rfloordiv__(self, x: _nt.CoFloat64_0d, /) -> Self: ...

    #
    @override
    def __mod__(self, x: _nt.CoFloat64_0d, /) -> Self: ...
    @override
