...
class signedinteger(integer[_BitT]):
    ...
    @overload
    def __add__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...
    @overload
    def __add__(self, x: _nt.Just[unsignedinteger], /) -> signedinteger | float64: ...
    ...
    @overload
    def __sub__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...
    @overload
    def __sub__(self, x: _nt.Just[unsignedinteger], /) -> signedinteger | float64: ...
    ...
    @overload
    def __mul__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...
    @overload
    def __mul__(self, x: _nt.Just[unsignedinteger], /) -> signedinteger | float64: ...
    ...
    @overload
    def __pow__(self, x: _nt.Just[signedinteger], mod: None = None, /) -> signedinteger: ...
    @overload
    def __pow__(self, x: _nt.Just[unsignedinteger], mod: None = None, /) -> signedinteger | float64: ...
    ...
    @overload
    def __floordiv__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...
    @overload
    def __floordiv__(self, x: _nt.Just[unsignedinteger], /) -> signedinteger | float64: ...
    ...
    @overload
    def __mod__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...
    @overload
    def __mod__(self, x: _nt.Just[unsignedinteger], /) -> signedinteger | float64: ...
    ...
    @overload
    def __divmod__(self, x: _nt.Just[signedinteger], /) -> _2Tuple[signedinteger]: ...
    @overload
    def __divmod__(self, x: _nt.Just[unsignedinteger], /) -> _2Tuple[signedinteger | float64]: ...

    #
    @overload  # type: ignore[override]
    def __lshift__(self, x: _CoInt8, /) -> Self: ...
    @overload
    def __lshift__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    # keep in sync with __lshift__
    @overload  # type: ignore[override]
    def __rshift__(self, x: _CoInt8, /) -> Self: ...
    @overload
    def __rshift__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    # keep in sync with __lshift__
    @overload  # type: ignore[override]
    def __and__(self, x: _CoInt8, /) -> Self: ...
    @overload
    def __and__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    # keep in sync with __lshift__
    @overload  # type: ignore[override]
    def __xor__(self, x: _CoInt8, /) -> Self: ...
    @overload
    def __xor__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    # keep in sync with __lshift__
    @overload  # type: ignore[override]
    def __or__(self, x: _CoInt8, /) -> Self: ...
    @overload
    def __or__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...  # pyright: ignore[reportIncompatibleMethodOverride]
...
class unsignedinteger(integer[_BitT]):
    ...
    def __add__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __add__(self, x: _nt.Just[unsignedinteger], /) -> unsignedinteger: ...
    @overload
    def __add__(self, x: _nt.Just[signedinteger], /) -> signedinteger | float64: ...
    ...
    def __radd__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __radd__(self, x: _nt.Just[signedinteger], /) -> float64 | signedinteger: ...
    ...
    def __sub__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __sub__(self, x: _nt.Just[unsignedinteger], /) -> unsignedinteger: ...
    @overload
    def __sub__(self, x: _nt.Just[signedinteger], /) -> signedinteger | float64: ...
    ...
    def __rsub__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rsub__(self, x: _nt.Just[signedinteger], /) -> float64 | signedinteger: ...
    ...
    def __mul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __mul__(self, x: _nt.Just[unsignedinteger], /) -> unsignedinteger: ...
    @overload
    def __mul__(self, x: _nt.Just[signedinteger], /) -> signedinteger | float64: ...
    ...
    def __rmul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rmul__(self, x: _nt.Just[signedinteger], /) -> float64 | signedinteger: ...
    ...
    def __pow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __pow__(self, x: _nt.Just[unsignedinteger], mod: None = None, /) -> unsignedinteger: ...
    @overload
    def __pow__(self, x: _nt.Just[signedinteger], mod: None = None, /) -> signedinteger | float64: ...
    ...
    def __rpow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __rpow__(self, x: _nt.Just[signedinteger], mod: None = None, /) -> float64 | signedinteger: ...
    ...
    def __floordiv__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __floordiv__(self, x: _nt.Just[unsignedinteger], /) -> unsignedinteger: ...
    @overload
    def __floordiv__(self, x: _nt.Just[signedinteger], /) -> signedinteger | float64: ...
    ...
    def __rfloordiv__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rfloordiv__(self, x: _nt.Just[signedinteger], /) -> float64 | signedinteger: ...
    ...
    def __mod__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __mod__(self, x: _nt.Just[unsignedinteger], /) -> unsignedinteger: ...
    @overload
    def __mod__(self, x: _nt.Just[signedinteger], /) -> signedinteger | float64: ...
    ...
    def __rmod__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rmod__(self, x: _nt.Just[signedinteger], /) -> float64 | signedinteger: ...
    ...
    def __divmod__(self, x: _nt.JustFloat, /) -> _2Tuple[float64]: ...
    @overload
    def __divmod__(self, x: _nt.Just[unsignedinteger], /) -> _2Tuple[unsignedinteger]: ...
    @overload
    def __divmod__(self, x: _nt.Just[signedinteger], /) -> _2Tuple[signedinteger | float64]: ...
    ...
    def __rlshift__(self, x: int, /) -> Self: ...
    @overload
    def __rlshift__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...
    ...
    def __rrshift__(self, x: int, /) -> Self: ...
    @overload
    def __rrshift__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...
    ...
    def __rand__(self, x: int, /) -> Self: ...
    @overload
    def __rand__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...
    ...
    def __rxor__(self, x: int, /) -> Self: ...
    @overload
    def __rxor__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...
    ...
    def __ror__(self, x: int, /) -> Self: ...
    @overload
    def __ror__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...
...
class _IntROpMixin(Generic[_T_co]):
    ...
    def __radd__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __radd__(self, x: _nt.Just[signedinteger], /) -> _T_co: ...
    @overload
    def __radd__(self, x: _nt.Just[unsignedinteger], /) -> _T_co | float64: ...
    ...
    def __rsub__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rsub__(self, x: _nt.Just[signedinteger], /) -> _T_co: ...
    @overload
    def __rsub__(self, x: _nt.Just[unsignedinteger], /) -> _T_co | float64: ...
    ...
    def __rmul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rmul__(self, x: _nt.Just[signedinteger], /) -> _T_co: ...
    @overload
    def __rmul__(self, x: _nt.Just[unsignedinteger], /) -> _T_co | float64: ...
    ...
    def __rpow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __rpow__(self, x: _nt.Just[signedinteger], mod: None = None, /) -> _T_co: ...
    @overload
    def __rpow__(self, x: _nt.Just[unsignedinteger], mod: None = None, /) -> _T_co | float64: ...
    ...
    def __rfloordiv__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rfloordiv__(self, x: _nt.Just[signedinteger], /) -> _T_co: ...
    @overload
    def __rfloordiv__(self, x: _nt.Just[unsignedinteger], /) -> _T_co | float64: ...
    ...
    def __rmod__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rmod__(self, x: _nt.Just[signedinteger], /) -> _T_co: ...
    @overload
    def __rmod__(self, x: _nt.Just[unsignedinteger], /) -> _T_co | float64: ...
    ...
    def __rdivmod__(self, x: _nt.JustFloat, /) -> _2Tuple[float64]: ...
    @overload
    def __rdivmod__(self, x: _nt.Just[signedinteger], /) -> _2Tuple[_T_co]: ...
    @overload
    def __rdivmod__(self, x: _nt.Just[unsignedinteger], /) -> _2Tuple[_T_co | float64]: ...

    #
    @overload
    def __rlshift__(self, x: int, /) -> Self: ...
    @overload
    def __rlshift__(self, x: _nt.Just[signedinteger] | _nt.Just[unsignedinteger] | _nt.Just[integer], /) -> _T_co: ...

    #
    @overload
    def __rrshift__(self, x: int, /) -> Self: ...
    @overload
    def __rrshift__(self, x: _nt.Just[signedinteger] | _nt.Just[unsignedinteger] | _nt.Just[integer], /) -> _T_co: ...

    #
    @overload
    def __rand__(self, x: int, /) -> Self: ...
    @overload
    def __rand__(self, x: _nt.Just[signedinteger] | _nt.Just[unsignedinteger] | _nt.Just[integer], /) -> _T_co: ...

    #
    @overload
    def __rxor__(self, x: int, /) -> Self: ...
    @overload
    def __rxor__(self, x: _nt.Just[signedinteger] | _nt.Just[unsignedinteger] | _nt.Just[integer], /) -> _T_co: ...

    #
    @overload
    def __ror__(self, x: int, /) -> Self: ...
    @overload
    def __ror__(self, x: _nt.Just[signedinteger] | _nt.Just[unsignedinteger] | _nt.Just[integer], /) -> _T_co: ...
...
class int8(_IntROpMixin[signedinteger], signedinteger[_n._8]):
    ...
    @overload
    def __or__(self, x: _nt.Just[unsignedinteger], /) -> signedinteger: ...
...
class uint8(unsignedinteger[_n._8]):
    ...
    def __radd__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __radd__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...
    @overload
    ...
    def __rsub__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rsub__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...
    @overload
    ...
    def __rmul__(self, x: _nt.JustComplex, /) -> complex128: ...
    @overload
    def __rmul__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...
    @overload
    ...
    def __rpow__(self, x: _nt.JustComplex, mod: None = None, /) -> complex128: ...
    @overload
    def __rpow__(self, x: _nt.Just[signedinteger], mod: None = None, /) -> signedinteger: ...
    @overload
    ...
    def __rfloordiv__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rfloordiv__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...
    @overload
    ...
    def __rmod__(self, x: _nt.JustFloat, /) -> float64: ...
    @overload
    def __rmod__(self, x: _nt.Just[signedinteger], /) -> signedinteger: ...
    @overload
    ...
    def __rdivmod__(self, x: _nt.JustFloat, /) -> _2Tuple[float64]: ...
    @overload
    def __rdivmod__(self, x: _nt.Just[signedinteger], /) -> _2Tuple[signedinteger]: ...
    @overload
...
class uint16(unsignedinteger[_n._16]):
    ...
    @overload
    def __ror__(self, x: _nt.Just[unsignedinteger], /) -> unsignedinteger: ...
...
class int64(_IntROpMixin[int64], signedinteger[_n._64]):
    ...
    def __divmod__(self, x: _nt.JustFloat, /) -> _2Tuple[float64]: ...
    @overload
    def __divmod__(self, x: _nt.Just[unsignedinteger], /) -> _2Tuple[Self | float64]: ...
    ...
    @overload
    def __lshift__(self, x: _nt.Just[unsignedinteger], /) -> int64: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    #
    @overload  # type: ignore[override]
    def __rshift__(self, x: _CoInt64, /) -> Self: ...
    @overload
    def __rshift__(self, x: _nt.Just[unsignedinteger], /) -> int64: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    #
    @overload  # type: ignore[override]
    def __and__(self, x: _CoInt64, /) -> Self: ...
    @overload
    def __and__(self, x: _nt.Just[unsignedinteger], /) -> int64: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    #
    @overload  # type: ignore[override]
    def __xor__(self, x: _CoInt64, /) -> Self: ...
    @overload
    def __xor__(self, x: _nt.Just[unsignedinteger], /) -> int64: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    #
    @overload  # type: ignore[override]
    def __or__(self, x: _CoInt64, /) -> Self: ...
    @overload
    def __or__(self, x: _nt.Just[unsignedinteger], /) -> int64: ...  # pyright: ignore[reportIncompatibleMethodOverride]
...
class uint64(unsignedinteger[_n._64]):
    ...
    @overload
    def __radd__(self, x: _nt.Just[unsignedinteger], /) -> Self: ...
...
class complex128(complexfloating[_n._64], complex):
    ...
    @overload
    def __add__(self, x: longdouble, /) -> clongdouble: ...

    # keep in sync with `__add__`
    @overload  # type: ignore[override]
    def __radd__(self, x: _CoComplex128, /) -> Self: ...
    @overload
    def __radd__(self, x: longdouble, /) -> clongdouble: ...

    # keep in sync with `__add__`
    @overload  # type: ignore[override]
    def __sub__(self, x: _CoComplex128, /) -> Self: ...
    @overload
    def __sub__(self, x: longdouble, /) -> clongdouble: ...

    # keep in sync with `__add__`
    @overload  # type: ignore[override]
    def __rsub__(self, x: _CoComplex128, /) -> Self: ...
    @overload
    def __rsub__(self, x: longdouble, /) -> clongdouble: ...

    # keep in sync with `__add__`
    @overload  # type: ignore[override]
    def __mul__(self, x: _CoComplex128, /) -> Self: ...
    @overload
    def __mul__(self, x: longdouble, /) -> clongdouble: ...

    # keep in sync with `__add__`
    @overload  # type: ignore[override]
    def __rmul__(self, x: _CoComplex128, /) -> Self: ...
    @overload
    def __rmul__(self, x: longdouble, /) -> clongdouble: ...

    # keep in sync with `__add__`
    @overload  # type: ignore[override]
    def __pow__(self, x: _CoComplex128, mod: None = None, /) -> Self: ...
    @overload
    def __pow__(self, x: longdouble, mod: None = None, /) -> clongdouble: ...

    # keep in sync with `__add__`
    @overload  # type: ignore[override]
    def __rpow__(self, x: _CoComplex128, mod: None = None, /) -> Self: ...
    @overload
    def __rpow__(self, x: longdouble, mod: None = None, /) -> clongdouble: ...

    # keep in sync with `__add__`
    @overload  # type: ignore[override]
    def __truediv__(self, x: _CoComplex128, /) -> Self: ...
    @overload
    def __truediv__(self, x: longdouble, /) -> clongdouble: ...

    # keep in sync with `__add__`
    @overload  # type: ignore[override]
    def __rtruediv__(self, x: _CoComplex128, /) -> Self: ...
    @overload
    def __rtruediv__(self, x: longdouble, /) -> clongdouble: ...
