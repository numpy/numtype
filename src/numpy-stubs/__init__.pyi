...
class uint8(unsignedinteger[_n._8]):
    ...
    @overload
    def __add__(self, x: _nt.CanArray0D[_Int16m], /) -> int16: ...
    ...
    @overload
    def __radd__(self, x: _nt.CanArray0D[int8], /) -> int16: ...
...
class uint16(unsignedinteger[_n._16]):
    ...
    def __add__(self, x: _nt.Just[integer], /) -> integer: ...
    @overload
    def __add__(self, x: _nt.CanArray0D[_Int32m], /) -> int32: ...
    @overload
    def __add__(self, x: _nt.CanArray0D[int64], /) -> int64: ...
    ...
    @overload
    def __radd__(self, x: _nt.CanArray0D[int8], /) -> int32: ...
