...
class floating(_RealMixin, _RoundMixin, inexact[_BitT, float]):
    ...
    @overload
    @abc.abstractmethod
    def __sub__(self, x: _ToComplex128, /) -> complexfloating: ...
    @overload
    @abc.abstractmethod
    def __rsub__(self, x: _nt.CoFloat64_0d, /) -> floating: ...
    @overload
    @abc.abstractmethod
    def __rsub__(self, x: _ToComplex128, /) -> complexfloating: ...

    # keep in sync with `__sub__`
    @overload
    @abc.abstractmethod
    def __mul__(self, x: _nt.CoFloat64_0d | floating[_n._8], /) -> floating: ...
    @overload
    @abc.abstractmethod
    def __mul__(self, x: _ToComplex128, /) -> complexfloating: ...
    @overload
    @abc.abstractmethod
    def __rmul__(self, x: _nt.CoFloat64_0d, /) -> floating: ...
    @overload
    @abc.abstractmethod
    def __rmul__(self, x: _ToComplex128, /) -> complexfloating: ...

    # keep in sync with `__rsub__
    @overload
    @abc.abstractmethod
    def __pow__(self, x: _nt.CoFloat64_0d | floating[_n._8], mod: None = None, /) -> floating: ...
    @overload
    @abc.abstractmethod
    def __pow__(self, x: _ToComplex128, mod: None = None, /) -> complexfloating: ...
    @overload
    @abc.abstractmethod
    def __rpow__(self, x: _nt.CoFloat64_0d, mod: None = None, /) -> floating: ...
    @overload
    @abc.abstractmethod
    def __rpow__(self, x: _ToComplex128, mod: None = None, /) -> complexfloating: ...
    ...
    @overload
    @abc.abstractmethod
    def __truediv__(self, x: _ToComplex128, /) -> complexfloating: ...
    @overload
    @abc.abstractmethod
    def __rtruediv__(self, x: _nt.CoFloat64_0d, /) -> floating: ...
    @overload
    @abc.abstractmethod
    def __rtruediv__(self, x: _ToComplex128, /) -> complexfloating: ...
...
class complexfloating(inexact[_BitT1, complex], Generic[_BitT1, _BitT2]):
    ...
    # the reported LSP violation is a false positive
    @overload
...
class float64(floating[_n._64], float):  # type: ignore[misc]
    ...
    @overload
    def __sub__(self, x: _ToComplex128, /) -> complex128: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    @overload
    def __rsub__(self, x: _nt.CoFloat64_0d, /) -> Self: ...
    @overload
    def __rsub__(self, x: _ToComplex128, /) -> complex128: ...

    #
    @overload  # type: ignore[override]
    def __mul__(self, x: _nt.CoFloat64_0d, /) -> Self: ...
    @overload
    def __mul__(self, x: _ToComplex128, /) -> complex128: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    @overload
    def __rmul__(self, x: _nt.CoFloat64_0d, /) -> Self: ...
    @overload
    def __rmul__(self, x: _ToComplex128, /) -> complex128: ...

    # keep in sync with `__add__`
    @overload  # type: ignore[override]
    def __pow__(self, x: _nt.CoFloat64_0d, mod: None = None, /) -> Self: ...
    @overload
    def __pow__(self, x: _ToComplex128, mod: None = None, /) -> complex128: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    @overload
    def __rpow__(self, x: _nt.CoFloat64_0d, mod: None = None, /) -> Self: ...
    @overload
    def __rpow__(self, x: _ToComplex128, mod: None = None, /) -> complex128: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    # keep in sync with `__add__`
    @overload  # type: ignore[override]
    def __truediv__(self, x: _nt.CoFloat64_0d, /) -> Self: ...
    @overload
    def __truediv__(self, x: _ToComplex128, /) -> complex128: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    @overload
    def __rtruediv__(self, x: _nt.CoFloat64_0d, /) -> Self: ...
    @overload
    def __rtruediv__(self, x: _ToComplex128, /) -> complex128: ...
...
class complex64(complexfloating[_n._32]):
    ...
    @overload
    def __add__(self, x: _JustNumber, /) -> complexfloating: ...  # pyright: ignore[reportIncompatibleMethodOverride]
