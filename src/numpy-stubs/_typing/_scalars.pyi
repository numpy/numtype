...
_IntLike_co: TypeAlias = int | np.integer | _BoolLike_co
_FloatLike_co: TypeAlias = float | np.floating | _IntLike_co
_ComplexLike_co: TypeAlias = complex | np.complexfloating | _FloatLike_co
_TD64Like_co: TypeAlias = np.timedelta64 | _IntLike_co

_NumberLike_co: TypeAlias = int | float | complex | np.number | np.bool
