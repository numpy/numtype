...
def fftfreq(n: _Int, d: Array[np.longdouble, _ShapeT], device: _Device | None = None) -> Array[np.longdouble, _ShapeT]: ...
...
def fftfreq(n: _Int, d: Array[np.clongdouble, _ShapeT], device: _Device | None = None) -> Array[np.clongdouble, _ShapeT]: ...
...
def fftfreq(n: _Int, d: float | co_float | Array[co_float] = 1.0, device: _Device | None = None) -> Array[np.floating]: ...
...
@overload  # Nd longdouble -> Nd longdouble
def rfftfreq(n: _Int, d: Array[np.longdouble, _ShapeT], device: _Device | None = None) -> Array[np.longdouble, _ShapeT]: ...
@overload  # Nd float{16,32,64} -> Nd float64
def rfftfreq(n: _Int, d: Array[_Floating64Max, _ShapeT], device: _Device | None = None) -> Array[np.float64, _ShapeT]: ...
@overload  # Nd complex longdouble -> Nd complex longdouble
def rfftfreq(n: _Int, d: Array[np.clongdouble, _ShapeT], device: _Device | None = None) -> Array[np.clongdouble, _ShapeT]: ...
@overload  # Nd complex{64,128} -> Nd complex128
def rfftfreq(n: _Int, d: Array[_CFloating64Max, _ShapeT], device: _Device | None = None) -> Array[np.complex128, _ShapeT]: ...
@overload  # ?d +floating -> Nd floating
def rfftfreq(n: _Int, d: float | co_float | Array[co_float] = 1.0, device: _Device | None = None) -> Array[np.floating]: ...
@overload  # ?d +complex -> Nd inexact
