...
@overload
def fftshift(x: _nt.ToBool_1d, axes: _nt.ToShape | None = None) -> _nt.Array1D[np.bool]: ...
@overload
def fftshift(x: _nt.ToBool_1nd, axes: _nt.ToShape | None = None) -> _nt.Array[np.bool]: ...
@overload
def fftshift(
    x: _nt.CanLenArray[_ScalarT, _ShapeT], axes: _nt.ToShape | None = None
) -> _nt.Array[_ScalarT, _ShapeT]: ...
@overload
def fftshift(x: _nt.ToInt_1d, axes: _nt.ToShape | None = None) -> _nt.Array1D[np.intp]: ...
@overload
def fftshift(x: _nt.ToInt_1nd, axes: _nt.ToShape | None = None) -> _nt.Array[np.intp]: ...
@overload
def fftshift(x: _nt.ToFloat64_1d, axes: _nt.ToShape | None = None) -> _nt.Array1D[np.float64]: ...
@overload
def fftshift(x: _nt.ToFloat64_1nd, axes: _nt.ToShape | None = None) -> _nt.Array[np.float64]: ...
@overload
def fftshift(x: _nt.ToComplex128_1d, axes: _nt.ToShape | None = None) -> _nt.Array1D[np.complex128]: ...
@overload
def fftshift(x: _nt.ToComplex128_1nd, axes: _nt.ToShape | None = None) -> _nt.Array[np.complex128]: ...
@overload
def fftshift(x: _nt.ToBytes_1d, axes: _nt.ToShape | None = None) -> _nt.Array1D[np.bytes_]: ...
@overload
def fftshift(x: _nt.ToBytes_1nd, axes: _nt.ToShape | None = None) -> _nt.Array[np.bytes_]: ...
@overload
def fftshift(x: _nt.ToStr_1d, axes: _nt.ToShape | None = None) -> _nt.Array1D[np.str_]: ...
@overload
def fftshift(x: _nt.ToStr_1nd, axes: _nt.ToShape | None = None) -> _nt.Array[np.str_]: ...
@overload
def fftshift(x: _nt.ToGeneric_1nd, axes: _nt.ToShape | None = None) -> _nt.Array[Any]: ...

# keep in sync with `fftshift`
@overload
def ifftshift(x: _nt.ToBool_1d, axes: _nt.ToShape | None = None) -> _nt.Array1D[np.bool]: ...
@overload
def ifftshift(x: _nt.ToBool_1nd, axes: _nt.ToShape | None = None) -> _nt.Array[np.bool]: ...
@overload
def ifftshift(
    x: _nt.CanLenArray[_ScalarT, _ShapeT], axes: _nt.ToShape | None = None
) -> _nt.Array[_ScalarT, _ShapeT]: ...
@overload
def ifftshift(x: _nt.ToInt_1d, axes: _nt.ToShape | None = None) -> _nt.Array1D[np.intp]: ...
@overload
def ifftshift(x: _nt.ToInt_1nd, axes: _nt.ToShape | None = None) -> _nt.Array[np.intp]: ...
@overload
def ifftshift(x: _nt.ToFloat64_1d, axes: _nt.ToShape | None = None) -> _nt.Array1D[np.float64]: ...
@overload
def ifftshift(x: _nt.ToFloat64_1nd, axes: _nt.ToShape | None = None) -> _nt.Array[np.float64]: ...
@overload
def ifftshift(x: _nt.ToComplex128_1d, axes: _nt.ToShape | None = None) -> _nt.Array1D[np.complex128]: ...
@overload
def ifftshift(x: _nt.ToComplex128_1nd, axes: _nt.ToShape | None = None) -> _nt.Array[np.complex128]: ...
@overload
def ifftshift(x: _nt.ToBytes_1d, axes: _nt.ToShape | None = None) -> _nt.Array1D[np.bytes_]: ...
@overload
def ifftshift(x: _nt.ToBytes_1nd, axes: _nt.ToShape | None = None) -> _nt.Array[np.bytes_]: ...
@overload
def ifftshift(x: _nt.ToStr_1d, axes: _nt.ToShape | None = None) -> _nt.Array1D[np.str_]: ...
@overload
def ifftshift(x: _nt.ToStr_1nd, axes: _nt.ToShape | None = None) -> _nt.Array[np.str_]: ...
@overload
def ifftshift(x: _nt.ToGeneric_1nd, axes: _nt.ToShape | None = None) -> _nt.Array[Any]: ...
