...
assert_type(mat * 5, np.matrix[_Shape2D, np.dtype[Any]])
assert_type(5 * mat, np.matrix[_Shape2D, np.dtype[Any]])
mat *= 5
...
assert_type(mat.sum(axis=0), np.matrix[_Shape2D, np.dtype[Any]])
assert_type(mat.mean(axis=0), np.matrix[_Shape2D, np.dtype[Any]])
assert_type(mat.std(axis=0), np.matrix[_Shape2D, np.dtype[Any]])
assert_type(mat.var(axis=0), np.matrix[_Shape2D, np.dtype[Any]])
assert_type(mat.prod(axis=0), np.matrix[_Shape2D, np.dtype[Any]])
...
assert_type(mat.I, np.matrix[_Shape2D, np.dtype[Any]])
assert_type(mat.A, np.ndarray[_Shape2D, np.dtype[np.int64]])
assert_type(mat.A1, np.ndarray[tuple[int], np.dtype[np.int64]])
assert_type(mat.H, np.matrix[_Shape2D, np.dtype[np.int64]])
assert_type(mat.getT(), np.matrix[_Shape2D, np.dtype[np.int64]])
assert_type(mat.getI(), np.matrix[_Shape2D, np.dtype[Any]])
assert_type(mat.getA(), np.ndarray[_Shape2D, np.dtype[np.int64]])
assert_type(mat.getA1(), np.ndarray[tuple[int], np.dtype[np.int64]])
assert_type(mat.getH(), np.matrix[_Shape2D, np.dtype[np.int64]])

assert_type(np.bmat(ar_f8), np.matrix[_Shape2D, np.dtype[np.float64]])
assert_type(np.bmat([[[0, 1, 2]]]), np.matrix[_Shape2D, np.dtype[np.intp]])
assert_type(np.bmat("mat"), np.matrix[_Shape2D, np.dtype[Any]])

assert_type(np.asmatrix(ar_f8, dtype=np.int64), np.matrix[_Shape2D, np.dtype[np.int64]])
