...
assert_type(mat * 5, np.matrix[_Shape2D, np.dtype])
assert_type(5 * mat, np.matrix[_Shape2D, np.dtype])
mat *= 5
...
assert_type(mat.sum(axis=0), np.matrix[_Shape2D, np.dtype])
assert_type(mat.mean(axis=0), np.matrix[_Shape2D, np.dtype])
assert_type(mat.std(axis=0), np.matrix[_Shape2D, np.dtype])
assert_type(mat.var(axis=0), np.matrix[_Shape2D, np.dtype])
assert_type(mat.prod(axis=0), np.matrix[_Shape2D, np.dtype])
...
assert_type(mat.I, np.matrix[_Shape2D, np.dtype])
...
assert_type(mat.getI(), np.matrix[_Shape2D, np.dtype])
...
assert_type(np.bmat("mat"), np.matrix[_Shape2D, np.dtype])
