...
assert_type(np.all(AR_b, axis=0), np.bool | npt.NDArray[np.bool])
assert_type(np.all(AR_f4, axis=0), np.bool | npt.NDArray[np.bool])
assert_type(np.all(AR_b, keepdims=True), np.bool | npt.NDArray[np.bool])
assert_type(np.all(AR_f4, keepdims=True), np.bool | npt.NDArray[np.bool])
...
assert_type(np.any(AR_b, axis=0), np.bool | npt.NDArray[np.bool])
assert_type(np.any(AR_f4, axis=0), np.bool | npt.NDArray[np.bool])
assert_type(np.any(AR_b, keepdims=True), np.bool | npt.NDArray[np.bool])
assert_type(np.any(AR_f4, keepdims=True), np.bool | npt.NDArray[np.bool])
