...
assert_type(np.fromregex(str_path, re.compile(r"test"), dtype=np.str_, encoding="utf8"), npt.NDArray[np.str_])
...
assert_type(np.genfromtxt(bytes_file), npt.NDArray[np.float64])
...
assert_type(np.genfromtxt(str_file, comments="test"), npt.NDArray[np.float64])
assert_type(np.genfromtxt(str_path, delimiter="\n"), npt.NDArray[np.float64])
assert_type(np.genfromtxt(str_path, ndmin=2), npt.NDArray[np.float64])
assert_type(np.genfromtxt(["1", "2", "3"], ndmin=2), npt.NDArray[np.float64])
