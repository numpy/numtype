...
assert_type(b_ % f, np.int8 | np.int_ | np.float64)
...
assert_type(b_.__divmod__(i), tuple[np.int8, np.int8] | tuple[np.int_, np.int_])
assert_type(b_.__divmod__(f), tuple[np.int8, np.int8] | tuple[np.int_, np.int_] | tuple[np.float64, np.float64])
...
assert_type(i % b_, np.int8 | np.int_)
assert_type(f % b_, np.int8 | np.int_ | np.float64)
assert_type(b_ % b_, np.int8)
...
assert_type(divmod(i, b_), tuple[np.int8, np.int8] | tuple[np.int_, np.int_])
assert_type(divmod(f, b_), tuple[np.int8, np.int8] | tuple[np.int_, np.int_] | tuple[np.float64, np.float64])
assert_type(divmod(b_, b_), tuple[np.int8, np.int8])
...
assert_type(divmod(f, i8), tuple[np.int64, np.int64] | tuple[np.float64, np.float64])
