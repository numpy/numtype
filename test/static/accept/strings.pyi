...
StringND: TypeAlias = np.ndarray[tuple[int, ...], np.dtypes.StringDType]
...
assert_type(np.strings.add(AR_T, AR_T), StringND)
...
assert_type(np.strings.center(AR_T, 5), StringND)
...
assert_type(np.strings.expandtabs(AR_T), StringND)
...
assert_type(np.strings.ljust(AR_T, 5), StringND)
assert_type(np.strings.ljust(AR_T, [4, 2, 1], fillchar=["a", "b", "c"]), StringND)
...
assert_type(np.strings.rjust(AR_T, 5), StringND)
assert_type(np.strings.rjust(AR_T, [4, 2, 1], fillchar=["a", "b", "c"]), StringND)

assert_type(np.strings.lstrip(AR_U), npt.NDArray[np.str_])
assert_type(np.strings.lstrip(AR_S, b"_"), npt.NDArray[np.bytes_])
assert_type(np.strings.lstrip(AR_T), StringND)
assert_type(np.strings.lstrip(AR_T, "_"), StringND)

assert_type(np.strings.rstrip(AR_U), npt.NDArray[np.str_])
assert_type(np.strings.rstrip(AR_S, b"_"), npt.NDArray[np.bytes_])
assert_type(np.strings.rstrip(AR_T), StringND)
assert_type(np.strings.rstrip(AR_T, "_"), StringND)

assert_type(np.strings.strip(AR_U), npt.NDArray[np.str_])
assert_type(np.strings.strip(AR_S, b"_"), npt.NDArray[np.bytes_])
assert_type(np.strings.strip(AR_T), StringND)
assert_type(np.strings.strip(AR_T, "_"), StringND)
...
assert_type(np.strings.translate(AR_T, ""), StringND)
