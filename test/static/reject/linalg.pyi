...
np.linalg.matrix_rank(AR_O)  # type: ignore[arg-type]  # pyright: ignore[reportArgumentType]
np.linalg.matrix_power(AR_M, 5)  # type: ignore[arg-type]  # pyright: ignore[reportArgumentType]
...
np.linalg.cond(AR_O)  # type: ignore[arg-type]  # pyright: ignore[reportArgumentType]
np.linalg.cond(AR_f8, p="bob")  # type: ignore[arg-type]  # pyright: ignore[reportArgumentType]

np.linalg.det(AR_O)  # type: ignore[arg-type]  # pyright: ignore[reportArgumentType]
np.linalg.slogdet(AR_O)  # type: ignore[arg-type]  # pyright: ignore[reportArgumentType]

np.linalg.norm(AR_f8, ord="bob")  # type: ignore[call-overload]  # pyright: ignore[reportCallIssue,reportArgumentType]

np.linalg.multi_dot([AR_M])  # type: ignore[list-item]  # pyright: ignore[reportArgumentType]
