...
c32 // iu  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
...
c64l // iu  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
...
iu // c32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
iu // c64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
iu // c64l  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
...
divmod(c32, iu)  # type: ignore[operator]  # pyright: ignore[reportArgumentType, reportCallIssue]
...
divmod(c64l, iu)  # type: ignore[operator]  # pyright: ignore[reportArgumentType, reportCallIssue]
...
divmod(iu, c32)  # type: ignore[operator]  # pyright: ignore[reportArgumentType, reportCallIssue]
divmod(iu, c64)  # type: ignore[operator]  # pyright: ignore[reportArgumentType, reportCallIssue]
divmod(iu, c64l)  # type: ignore[operator]  # pyright: ignore[reportArgumentType, reportCallIssue]
