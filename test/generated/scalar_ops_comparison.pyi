# @generated 2025-03-30T22:13:22Z with tool/testgen.py
...
assert_type(c64 < iufc, np.bool)

assert_type(c128 < b_py, np.bool)
assert_type(c128 < i_py, np.bool)
assert_type(c128 < f_py, np.bool)
assert_type(c128 < c_py, np.bool)
assert_type(c128 < b1, np.bool)
assert_type(c128 < i8, np.bool)
assert_type(c128 < i16, np.bool)
assert_type(c128 < i32, np.bool)
assert_type(c128 < i64, np.bool)
assert_type(c128 < u8, np.bool)
assert_type(c128 < u16, np.bool)
assert_type(c128 < u32, np.bool)
assert_type(c128 < u64, np.bool)
assert_type(c128 < f16, np.bool)
assert_type(c128 < f32, np.bool)
assert_type(c128 < f64, np.bool)
assert_type(c128 < f64l, np.bool)
assert_type(c128 < c64, np.bool)
assert_type(c128 < c128, np.bool)
assert_type(c128 < c128l, np.bool)
assert_type(c128 < i, np.bool)
assert_type(c128 < u, np.bool)
assert_type(c128 < f, np.bool)
assert_type(c128 < c, np.bool)
assert_type(c128 < iu, np.bool)
assert_type(c128 < fc, np.bool)
assert_type(c128 < iufc, np.bool)

assert_type(c128l < b_py, np.bool)
assert_type(c128l < i_py, np.bool)
assert_type(c128l < f_py, np.bool)
assert_type(c128l < c_py, np.bool)
assert_type(c128l < b1, np.bool)
assert_type(c128l < i8, np.bool)
assert_type(c128l < i16, np.bool)
assert_type(c128l < i32, np.bool)
assert_type(c128l < i64, np.bool)
assert_type(c128l < u8, np.bool)
assert_type(c128l < u16, np.bool)
assert_type(c128l < u32, np.bool)
assert_type(c128l < u64, np.bool)
assert_type(c128l < f16, np.bool)
assert_type(c128l < f32, np.bool)
assert_type(c128l < f64, np.bool)
assert_type(c128l < f64l, np.bool)
assert_type(c128l < c64, np.bool)
assert_type(c128l < c128, np.bool)
assert_type(c128l < c128l, np.bool)
assert_type(c128l < i, np.bool)
assert_type(c128l < u, np.bool)
assert_type(c128l < f, np.bool)
assert_type(c128l < c, np.bool)
assert_type(c128l < iu, np.bool)
...
assert_type(fc < iufc, np.bool)

assert_type(iufc < b_py, np.bool)
assert_type(iufc < i_py, np.bool)
assert_type(iufc < f_py, np.bool)
assert_type(iufc < c_py, np.bool)
assert_type(iufc < b1, np.bool)
assert_type(iufc < i8, np.bool)
assert_type(iufc < i16, np.bool)
assert_type(iufc < i32, np.bool)
assert_type(iufc < i64, np.bool)
assert_type(iufc < u8, np.bool)
assert_type(iufc < u16, np.bool)
assert_type(iufc < u32, np.bool)
assert_type(iufc < u64, np.bool)
assert_type(iufc < f16, np.bool)
assert_type(iufc < f32, np.bool)
assert_type(iufc < f64, np.bool)
assert_type(iufc < f64l, np.bool)
assert_type(iufc < c64, np.bool)
assert_type(iufc < c128, np.bool)
assert_type(iufc < c128l, np.bool)
assert_type(iufc < m64, np.bool)
assert_type(iufc < i, np.bool)
assert_type(iufc < u, np.bool)
assert_type(iufc < f, np.bool)
assert_type(iufc < c, np.bool)
assert_type(iufc < iu, np.bool)
assert_type(iufc < fc, np.bool)
assert_type(iufc < iufc, np.bool)
