...
assert_type(c < ui, np.bool)
assert_type(c < fc, np.bool)

assert_type(ui < b_py, np.bool)
assert_type(ui < i_py, np.bool)
assert_type(ui < f_py, np.bool)
assert_type(ui < c_py, np.bool)
assert_type(ui < b1, np.bool)
assert_type(ui < u8, np.bool)
assert_type(ui < u16, np.bool)
assert_type(ui < u32, np.bool)
assert_type(ui < u64, np.bool)
assert_type(ui < i8, np.bool)
assert_type(ui < i16, np.bool)
assert_type(ui < i32, np.bool)
assert_type(ui < i64, np.bool)
assert_type(ui < f16, np.bool)
assert_type(ui < f32, np.bool)
assert_type(ui < f64, np.bool)
assert_type(ui < f64l, np.bool)
assert_type(ui < c32, np.bool)
assert_type(ui < c64, np.bool)
assert_type(ui < c64l, np.bool)
assert_type(ui < m64, np.bool)
assert_type(ui < u, np.bool)
assert_type(ui < i, np.bool)
assert_type(ui < f, np.bool)
assert_type(ui < c, np.bool)
assert_type(ui < ui, np.bool)
assert_type(ui < fc, np.bool)
