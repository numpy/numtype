...
assert_type(c32 + iu, np.complexfloating)
...
assert_type(c64 + iu, np.complex128)
...
assert_type(c64l + iu, np.clongdouble)
...
assert_type(iu + c32, np.complexfloating)
assert_type(iu + c64, np.complex128)
assert_type(iu + c64l, np.clongdouble)
