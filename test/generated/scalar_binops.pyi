# @generated 2025-03-25T17:33:16Z with tool/testgen.py
...
assert_type(b_py + b_py, int)
assert_type(b_py + i_py, int)
assert_type(b_py + f_py, float)
assert_type(b_py + c_py, complex)
assert_type(b_py + b1, np.bool)
assert_type(b_py + u8, np.uint8)
assert_type(b_py + u16, np.uint16)
assert_type(b_py + u32, np.uint32)
assert_type(b_py + u64, np.uint64)
assert_type(b_py + i8, np.int8)
assert_type(b_py + i16, np.int16)
assert_type(b_py + i32, np.int32)
assert_type(b_py + i64, np.int64)
assert_type(b_py + f16, np.float16)
assert_type(b_py + f32, np.float32)
assert_type(b_py + f64, np.float64)
assert_type(b_py + f64l, np.longdouble)
assert_type(b_py + c32, np.complex64)
assert_type(b_py + c64, np.complex128)
assert_type(b_py + c64l, np.clongdouble)
assert_type(b_py + M64, np.datetime64)
assert_type(b_py + m64, np.timedelta64)
assert_type(b_py + f, np.floating)
assert_type(b_py + c, np.complexfloating)

assert_type(i_py + b_py, int)
assert_type(i_py + i_py, int)
assert_type(i_py + f_py, float)
assert_type(i_py + c_py, complex)
assert_type(i_py + b1, np.int_)
assert_type(i_py + u8, np.uint8)
assert_type(i_py + u16, np.uint16)
assert_type(i_py + u32, np.uint32)
assert_type(i_py + u64, np.uint64)
assert_type(i_py + i8, np.int8)
assert_type(i_py + i16, np.int16)
assert_type(i_py + i32, np.int32)
assert_type(i_py + i64, np.int64)
assert_type(i_py + f16, np.float16)
assert_type(i_py + f32, np.float32)
assert_type(i_py + f64, np.float64)
assert_type(i_py + f64l, np.longdouble)
assert_type(i_py + c32, np.complex64)
assert_type(i_py + c64, np.complex128)
assert_type(i_py + c64l, np.clongdouble)
assert_type(i_py + M64, np.datetime64)
assert_type(i_py + m64, np.timedelta64)
assert_type(i_py + f, np.floating)
assert_type(i_py + c, np.complexfloating)

assert_type(f_py + b_py, float)
assert_type(f_py + i_py, float)
assert_type(f_py + f_py, float)
assert_type(f_py + c_py, complex)
assert_type(f_py + b1, np.float64)
assert_type(f_py + u8, np.float64)
assert_type(f_py + u16, np.float64)
assert_type(f_py + u32, np.float64)
assert_type(f_py + u64, np.float64)
assert_type(f_py + i8, np.float64)
assert_type(f_py + i16, np.float64)
assert_type(f_py + i32, np.float64)
assert_type(f_py + i64, np.float64)
assert_type(f_py + f16, np.float16)
assert_type(f_py + f32, np.float32)
assert_type(f_py + f64, np.float64)
assert_type(f_py + f64l, np.longdouble)
assert_type(f_py + c32, np.complex64)
assert_type(f_py + c64, np.complex128)
assert_type(f_py + c64l, np.clongdouble)
assert_type(f_py + f, np.floating)
assert_type(f_py + c, np.complexfloating)

assert_type(c_py + b_py, complex)
assert_type(c_py + i_py, complex)
assert_type(c_py + f_py, complex)
assert_type(c_py + c_py, complex)
assert_type(c_py + b1, np.complex128)
assert_type(c_py + u8, np.complex128)
assert_type(c_py + u16, np.complex128)
assert_type(c_py + u32, np.complex128)
assert_type(c_py + u64, np.complex128)
assert_type(c_py + i8, np.complex128)
assert_type(c_py + i16, np.complex128)
assert_type(c_py + i32, np.complex128)
assert_type(c_py + i64, np.complex128)
assert_type(c_py + f16, np.complex64)
assert_type(c_py + f32, np.complex64)
assert_type(c_py + f64, complex)
assert_type(c_py + f64l, np.clongdouble)
assert_type(c_py + c32, np.complex64)
assert_type(c_py + c64, np.complex128)
assert_type(c_py + c64l, np.clongdouble)
assert_type(c_py + f, np.complex64 | complex | np.clongdouble)
assert_type(c_py + c, np.complexfloating)
...
assert_type(u32 + f, np.float64 | np.longdouble)
assert_type(u32 + c, np.complex128 | np.clongdouble)
...
assert_type(u64 + f, np.float64 | np.longdouble)
assert_type(u64 + c, np.complex128 | np.clongdouble)
...
assert_type(i32 + f, np.float64 | np.longdouble)
assert_type(i32 + c, np.complex128 | np.clongdouble)
...
assert_type(i64 + f, np.float64 | np.longdouble)
assert_type(i64 + c, np.complex128 | np.clongdouble)
...
assert_type(f64 + f, np.float64 | np.longdouble)
assert_type(f64 + c, np.complex128 | np.clongdouble)
...
assert_type(c64 + f, np.complex128 | np.clongdouble)
assert_type(c64 + c, np.complex128 | np.clongdouble)
...
assert_type(f + u32, np.float64 | np.longdouble)
assert_type(f + u64, np.float64 | np.longdouble)
assert_type(f + i8, np.floating)
assert_type(f + i16, np.floating)
assert_type(f + i32, np.float64 | np.longdouble)
assert_type(f + i64, np.float64 | np.longdouble)
assert_type(f + f16, np.floating)
assert_type(f + f32, np.floating)
assert_type(f + f64, np.float64 | np.longdouble)
assert_type(f + f64l, np.longdouble)
assert_type(f + c32, np.complexfloating)
assert_type(f + c64, np.complex128 | np.clongdouble)
...
assert_type(c + u32, np.complex128 | np.clongdouble)
assert_type(c + u64, np.complex128 | np.clongdouble)
assert_type(c + i8, np.complexfloating)
assert_type(c + i16, np.complexfloating)
assert_type(c + i32, np.complex128 | np.clongdouble)
assert_type(c + i64, np.complex128 | np.clongdouble)
assert_type(c + f16, np.complexfloating)
assert_type(c + f32, np.complexfloating)
assert_type(c + f64, np.complex128 | np.clongdouble)
assert_type(c + f64l, np.clongdouble)
assert_type(c + c32, np.complexfloating)
assert_type(c + c64, np.complex128 | np.clongdouble)
...
assert_type(b_py - f_py, float)
assert_type(b_py - c_py, complex)
b_py - b1  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
assert_type(b_py - u8, np.uint8)
assert_type(b_py - u16, np.uint16)
assert_type(b_py - u32, np.uint32)
assert_type(b_py - u64, np.uint64)
...
assert_type(f_py * c64, np.complex128)
assert_type(f_py * c64l, np.clongdouble)
assert_type(f_py * m64, np.timedelta64)
assert_type(f_py * f, np.floating)
assert_type(f_py * c, np.complexfloating)
...
assert_type(b_py / b_py, float)
assert_type(b_py / i_py, float)
assert_type(b_py / f_py, float)
assert_type(b_py / c_py, complex)
assert_type(b_py / b1, np.float64)
assert_type(b_py / u8, np.float64)
assert_type(b_py / u16, np.float64)
assert_type(b_py / u32, np.float64)
assert_type(b_py / u64, np.float64)
assert_type(b_py / i8, np.float64)
assert_type(b_py / i16, np.float64)
assert_type(b_py / i32, np.float64)
assert_type(b_py / i64, np.float64)
assert_type(b_py / f16, np.float16)
assert_type(b_py / f32, np.float32)
assert_type(b_py / f64, np.float64)
assert_type(b_py / f64l, np.longdouble)
...
assert_type(i_py / b_py, float)
assert_type(i_py / i_py, float)
assert_type(i_py / f_py, float)
assert_type(i_py / c_py, complex)
assert_type(i_py / b1, np.float64)
assert_type(i_py / u8, np.float64)
assert_type(i_py / u16, np.float64)
assert_type(i_py / u32, np.float64)
assert_type(i_py / u64, np.float64)
assert_type(i_py / i8, np.float64)
assert_type(i_py / i16, np.float64)
assert_type(i_py / i32, np.float64)
assert_type(i_py / i64, np.float64)
assert_type(i_py / f16, np.float16)
assert_type(i_py / f32, np.float32)
assert_type(i_py / f64, np.float64)
assert_type(i_py / f64l, np.longdouble)
...
assert_type(b_py // i_py, int)
assert_type(b_py // f_py, float)
b_py // c_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
assert_type(b_py // b1, np.int8)
assert_type(b_py // u8, np.uint8)
assert_type(b_py // u16, np.uint16)
assert_type(b_py // u32, np.uint32)
...
assert_type(b_py // f64, np.float64)
assert_type(b_py // f64l, np.longdouble)
b_py // c32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
b_py // c64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
b_py // c64l  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
assert_type(b_py // f, np.floating)
b_py // c  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]

assert_type(i_py // b_py, int)
assert_type(i_py // i_py, int)
assert_type(i_py // f_py, float)
i_py // c_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
assert_type(i_py // b1, np.int_)
assert_type(i_py // u8, np.uint8)
assert_type(i_py // u16, np.uint16)
assert_type(i_py // u32, np.uint32)
...
assert_type(i_py // f64, np.float64)
assert_type(i_py // f64l, np.longdouble)
i_py // c32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
i_py // c64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
i_py // c64l  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
assert_type(i_py // f, np.floating)
i_py // c  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]

assert_type(f_py // b_py, float)
assert_type(f_py // i_py, float)
assert_type(f_py // f_py, float)
f_py // c_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
assert_type(f_py // b1, np.float64)
assert_type(f_py // u8, np.float64)
assert_type(f_py // u16, np.float64)
assert_type(f_py // u32, np.float64)
...
assert_type(f_py // f64, np.float64)
assert_type(f_py // f64l, np.longdouble)
f_py // c32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py // c64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py // c64l  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
assert_type(f_py // f, np.floating)
f_py // c  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]

c_py // b_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // i_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // f_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // c_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // b1  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // u8  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // u16  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // u32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // u64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // i8  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // i16  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // i32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // i64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // f16  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // f32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // f64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // f64l  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // c32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // c64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // c64l  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // f  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py // c  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
...
assert_type(b_py << b_py, int)
assert_type(b_py << i_py, int)
b_py << f_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
b_py << c_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
assert_type(b_py << b1, np.int8)
assert_type(b_py << u8, np.uint8)
assert_type(b_py << u16, np.uint16)
...
assert_type(b_py << i32, np.int32)
assert_type(b_py << i64, np.int64)
b_py << f16  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
b_py << f32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
b_py << f64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
b_py << f64l  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
b_py << c32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
b_py << c64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
b_py << c64l  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
b_py << f  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
b_py << c  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]

assert_type(i_py << b_py, int)
assert_type(i_py << i_py, int)
i_py << f_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
i_py << c_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
assert_type(i_py << b1, np.int_)
assert_type(i_py << u8, np.uint8)
assert_type(i_py << u16, np.uint16)
...
assert_type(i_py << i32, np.int32)
assert_type(i_py << i64, np.int64)
i_py << f16  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
i_py << f32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
i_py << f64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
i_py << f64l  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
i_py << c32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
i_py << c64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
i_py << c64l  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
i_py << f  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
i_py << c  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]

f_py << b_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << i_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << f_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << c_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << b1  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << u8  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << u16  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << u32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << u64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << i8  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << i16  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << i32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << i64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << f16  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << f32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << f64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << f64l  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << c32  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << c64  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << c64l  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << f  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
f_py << c  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
...
b_py < c_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
assert_type(b_py < b1, np.bool)
assert_type(b_py < u8, np.bool)
assert_type(b_py < u16, np.bool)
assert_type(b_py < u32, np.bool)
assert_type(b_py < u64, np.bool)
assert_type(b_py < i8, np.bool)
assert_type(b_py < i16, np.bool)
assert_type(b_py < i32, np.bool)
assert_type(b_py < i64, np.bool)
assert_type(b_py < f16, np.bool)
assert_type(b_py < f32, np.bool)
assert_type(b_py < f64, np.bool)
assert_type(b_py < f64l, np.bool)
assert_type(b_py < c32, np.bool)
assert_type(b_py < c64, np.bool)
assert_type(b_py < c64l, np.bool)
assert_type(b_py < m64, np.bool)
assert_type(b_py < f, np.bool)
assert_type(b_py < c, np.bool)

i_py < c_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
assert_type(i_py < b1, np.bool)
assert_type(i_py < u8, np.bool)
assert_type(i_py < u16, np.bool)
assert_type(i_py < u32, np.bool)
assert_type(i_py < u64, np.bool)
assert_type(i_py < i8, np.bool)
assert_type(i_py < i16, np.bool)
assert_type(i_py < i32, np.bool)
assert_type(i_py < i64, np.bool)
assert_type(i_py < f16, np.bool)
assert_type(i_py < f32, np.bool)
assert_type(i_py < f64, np.bool)
assert_type(i_py < f64l, np.bool)
assert_type(i_py < c32, np.bool)
assert_type(i_py < c64, np.bool)
assert_type(i_py < c64l, np.bool)
assert_type(i_py < m64, np.bool)
assert_type(i_py < f, np.bool)
assert_type(i_py < c, np.bool)

f_py < c_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
assert_type(f_py < b1, np.bool)
assert_type(f_py < u8, np.bool)
assert_type(f_py < u16, np.bool)
assert_type(f_py < u32, np.bool)
assert_type(f_py < u64, np.bool)
assert_type(f_py < i8, np.bool)
assert_type(f_py < i16, np.bool)
assert_type(f_py < i32, np.bool)
assert_type(f_py < i64, np.bool)
assert_type(f_py < f16, np.bool)
assert_type(f_py < f32, np.bool)
assert_type(f_py < f64, np.bool)
assert_type(f_py < f64l, np.bool)
assert_type(f_py < c32, np.bool)
assert_type(f_py < c64, np.bool)
assert_type(f_py < c64l, np.bool)
assert_type(f_py < f, np.bool)
assert_type(f_py < c, np.bool)

c_py < b_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py < i_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py < f_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
c_py < c_py  # type: ignore[operator]  # pyright: ignore[reportOperatorIssue]
assert_type(c_py < b1, np.bool)
assert_type(c_py < u8, np.bool)
assert_type(c_py < u16, np.bool)
assert_type(c_py < u32, np.bool)
assert_type(c_py < u64, np.bool)
assert_type(c_py < i8, np.bool)
assert_type(c_py < i16, np.bool)
assert_type(c_py < i32, np.bool)
assert_type(c_py < i64, np.bool)
assert_type(c_py < f16, np.bool)
assert_type(c_py < f32, np.bool)
assert_type(c_py < f64, np.bool)
assert_type(c_py < f64l, np.bool)
assert_type(c_py < c32, np.bool)
assert_type(c_py < c64, np.bool)
assert_type(c_py < c64l, np.bool)
assert_type(c_py < f, np.bool)
assert_type(c_py < c, np.bool)
